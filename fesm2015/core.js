...
function getRootContext$2(component) {
    const rootContext = getRootView$1(component)[CONTEXT];
...
class ComponentFactory$1 extends ComponentFactory {
    ...
    create(injector, projectableNodes, rootSelectorOrNode, ngModule) {
        ...
        const componentRef = new ComponentRef$1(this.componentType, component, rootView, injector, hostNode);
...
function getOrCreateInjectable(nodeInjector, token, flags = 0 /* Default */) {
    ...
    const moduleInjector = nodeInjector.view[INJECTOR$1];
...
class ViewContainerRef$1 extends ViewContainerRef {
    ...
    insert(viewRef, index) {
        ...
        const container$$1 = this._getHostNode().dynamicLContainerNode;
...
class Render3DebugRendererFactory2 extends DebugRendererFactory2 {
    createRenderer(element$$1, renderData) {
        const renderer = super.createRenderer(element$$1, renderData);
