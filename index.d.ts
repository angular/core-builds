...
declare class InternalViewRef<T> implements EmbeddedViewRef<T>, ChangeDetectorRefInterface {
    /**
...
export { InternalViewRef as ɵInternalViewRef }
export { InternalViewRef as ɵViewRef }
