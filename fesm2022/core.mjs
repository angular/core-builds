...
import { OutputEmitterRef } from './resource-Co16cvOz.mjs';
export { computed, effect, linkedSignal, resource, untracked, ResourceImpl as ɵResourceImpl, getOutputDestroyRef as ɵgetOutputDestroyRef } from './resource-Co16cvOz.mjs';
