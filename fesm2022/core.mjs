...
import { OutputEmitterRef } from './resource-BET9j_cn.mjs';
export { ResourceStatus, computed, effect, linkedSignal, resource, untracked, ResourceImpl as ɵResourceImpl, getOutputDestroyRef as ɵgetOutputDestroyRef } from './resource-BET9j_cn.mjs';
