...
import { getActiveConsumer, setActiveConsumer as setActiveConsumer$1, SIGNAL, createSignal, consumerDestroy, BASE_EFFECT_NODE, isInNotificationPhase, runEffect } from './_effect-chunk.mjs';
 ...
 * @publicApi
 */
const VERSION = /* @__PURE__ */ new Version('21.0.0-next.8+sha-c241038');
...
function emitInjectorToCreateInstanceEvent(token) {
    !ngDevMode && throwError('Injector profiler should never be called in production mode');
    injectorProfiler({
        type: 5 /* InjectorProfilerEventType.InjectorToCreateInstanceEvent */,
        context: getInjectorProfilerContext(),
        token: token,
    });
}
...
function emitAfterRenderEffectPhaseCreatedEvent(effectPhase) {
    !ngDevMode && throwError('Injector profiler should never be called in production mode');
    injectorProfiler({
        type: 4 /* InjectorProfilerEventType.AfterRenderEffectPhaseCreated */,
        context: getInjectorProfilerContext(),
        effectPhase,
    });
}
