...
function SECURITY_SCHEMA() {
  if (!_SECURITY_SCHEMA) {
    ...
    registerContext(SecurityContext.RESOURCE_URL, SVG_NAMESPACE, [['script', ['src', 'href', 'xlink:href']]]);
...
function createRootTView(rootSelectorOrNode, componentDef, componentBindings, directives) {
  const tAttributes = rootSelectorOrNode ? ['ng-version', '22.1.0-next.0+sha-7c60a98'] : extractAttrsAndClassesFromSelector(componentDef.selectors[0]);
