...
export { NG_INJECTABLE_DEF as ɵangular_packages_core_core_bg } from './src/render3/fields';
export { bindingUpdated as ɵangular_packages_core_core_ba } from './src/render3/instructions';
export { PlayerFactoryBuildFn as ɵangular_packages_core_core_be } from './src/render3/interfaces/player';
export { LViewData as ɵangular_packages_core_core_bi } from './src/render3/interfaces/view';
...
export { BoundPlayerFactory as ɵangular_packages_core_core_bf } from './src/render3/styling/player_factory';
export { loadInternal as ɵangular_packages_core_core_bj } from './src/render3/util';
...
export { getClosureSafeProperty as ɵangular_packages_core_core_bh } from './src/util/property';
