...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.0+sha-4fa1dca'));
 ...
 */
new checker.Version('20.1.0-next.0+sha-4fa1dca');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-4fa1dca` usually means that core is at head so it supports
