...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.7+sha-2c1f348'));
 ...
 */
new checker.Version('19.2.7+sha-2c1f348');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.7+sha-2c1f348` usually means that core is at head so it supports
