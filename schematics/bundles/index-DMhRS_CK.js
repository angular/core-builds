...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.6+sha-c0e4ff1'));
 ...
 */
new checker.Version('19.2.6+sha-c0e4ff1');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.6+sha-c0e4ff1` usually means that core is at head so it supports
