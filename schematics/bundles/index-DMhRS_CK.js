...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.6+sha-070c09f'));
 ...
 */
new checker.Version('19.2.6+sha-070c09f');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.6+sha-070c09f` usually means that core is at head so it supports
