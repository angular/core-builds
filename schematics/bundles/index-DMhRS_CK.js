...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.6+sha-37ab681'));
 ...
 */
new checker.Version('19.2.6+sha-37ab681');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.6+sha-37ab681` usually means that core is at head so it supports
