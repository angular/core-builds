...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.7+sha-763e3ca'));
 ...
 */
new checker.Version('19.2.7+sha-763e3ca');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.7+sha-763e3ca` usually means that core is at head so it supports
