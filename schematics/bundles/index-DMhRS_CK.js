...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.6+sha-c80f24d'));
 ...
 */
new checker.Version('19.2.6+sha-c80f24d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.6+sha-c80f24d` usually means that core is at head so it supports
