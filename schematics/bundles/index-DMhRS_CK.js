...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.7+sha-5555e9f'));
 ...
 */
new checker.Version('19.2.7+sha-5555e9f');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.7+sha-5555e9f` usually means that core is at head so it supports
