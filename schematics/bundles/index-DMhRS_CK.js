...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.6+sha-5cd8052'));
 ...
 */
new checker.Version('19.2.6+sha-5cd8052');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.6+sha-5cd8052` usually means that core is at head so it supports
