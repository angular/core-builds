...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.2+sha-f1568ef'));
 ...
 */
new compiler.Version('20.0.0-rc.2+sha-f1568ef');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.2+sha-f1568ef` usually means that core is at head so it supports
