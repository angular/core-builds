...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.2+sha-968bbe9'));
 ...
 */
new compiler.Version('20.0.0-rc.2+sha-968bbe9');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.2+sha-968bbe9` usually means that core is at head so it supports
