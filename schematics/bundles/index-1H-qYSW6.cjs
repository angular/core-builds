...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.1+sha-c9b7a0b'));
 ...
 */
new compiler.Version('20.0.0-rc.1+sha-c9b7a0b');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.1+sha-c9b7a0b` usually means that core is at head so it supports
