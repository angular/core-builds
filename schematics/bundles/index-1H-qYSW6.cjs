...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.1+sha-d97892a'));
 ...
 */
new compiler.Version('20.0.0-rc.1+sha-d97892a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.1+sha-d97892a` usually means that core is at head so it supports
