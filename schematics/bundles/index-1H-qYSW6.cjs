...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.2+sha-5bdd291'));
 ...
 */
new compiler.Version('20.0.0-rc.2+sha-5bdd291');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.2+sha-5bdd291` usually means that core is at head so it supports
