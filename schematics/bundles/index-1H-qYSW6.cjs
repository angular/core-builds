...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.2+sha-09f79e0'));
 ...
 */
new compiler.Version('20.0.0-rc.2+sha-09f79e0');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.2+sha-09f79e0` usually means that core is at head so it supports
