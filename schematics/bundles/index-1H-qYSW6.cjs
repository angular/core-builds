...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.2+sha-e7cb313'));
 ...
 */
new compiler.Version('20.0.0-rc.2+sha-e7cb313');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.2+sha-e7cb313` usually means that core is at head so it supports
