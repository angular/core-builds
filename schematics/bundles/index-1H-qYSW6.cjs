...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.2+sha-6b7c8d1'));
 ...
 */
new compiler.Version('20.0.0-rc.2+sha-6b7c8d1');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.2+sha-6b7c8d1` usually means that core is at head so it supports
