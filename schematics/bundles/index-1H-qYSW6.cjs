...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.2+sha-1a3313a'));
 ...
 */
new compiler.Version('20.0.0-rc.2+sha-1a3313a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.2+sha-1a3313a` usually means that core is at head so it supports
