...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.2+sha-f400e9c'));
 ...
 */
new compiler.Version('20.0.0-rc.2+sha-f400e9c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.2+sha-f400e9c` usually means that core is at head so it supports
