...
var index = require('./index-BVNCudfT.cjs');
require('path');
require('node:path');
...
var parse_html = require('./parse_html-kyC18JsH.cjs');
var ng_component_template = require('./ng_component_template-BY00X6v4.cjs');
