...
var index = require('./index-DdemdtQD.cjs');
require('path');
require('node:path');
var project_paths = require('./project_paths-CJ7k28Vq.cjs');
var apply_import_manager = require('./apply_import_manager-CzH0CqGh.cjs');
var imports = require('./imports-26VeX8i-.cjs');
var parse_html = require('./parse_html-BmdBt08t.cjs');
var ng_component_template = require('./ng_component_template-Dr_6d-9i.cjs');
