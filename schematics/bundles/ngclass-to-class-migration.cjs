...
var index = require('./index-Dvmg4yJ3.cjs');
require('path');
require('node:path');
...
var parse_html = require('./parse_html-BB62OeSy.cjs');
var ng_component_template = require('./ng_component_template-C2ED4Io6.cjs');
