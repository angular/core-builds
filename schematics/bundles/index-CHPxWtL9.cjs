...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-rc.0+sha-2943591'));
 ...
 */
new checker.Version('20.1.0-rc.0+sha-2943591');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-rc.0+sha-2943591` usually means that core is at head so it supports
