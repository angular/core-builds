...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.2.3+sha-c664af8'));
 ...
 */
new project_tsconfig_paths.Version('20.2.3+sha-c664af8');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.3+sha-c664af8` usually means that core is at head so it supports
