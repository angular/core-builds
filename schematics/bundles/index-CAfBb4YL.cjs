...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.2.2+sha-479a919'));
 ...
 */
new project_tsconfig_paths.Version('20.2.2+sha-479a919');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.2+sha-479a919` usually means that core is at head so it supports
