...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.2.3+sha-3b42314'));
 ...
 */
new project_tsconfig_paths.Version('20.2.3+sha-3b42314');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.3+sha-3b42314` usually means that core is at head so it supports
