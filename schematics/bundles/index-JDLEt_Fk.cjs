...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.1+sha-71955dc'));
 ...
 */
new project_tsconfig_paths.Version('20.3.1+sha-71955dc');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.1+sha-71955dc` usually means that core is at head so it supports
