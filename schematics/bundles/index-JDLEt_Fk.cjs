...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.1+sha-0ebf1af'));
 ...
 */
new project_tsconfig_paths.Version('20.3.1+sha-0ebf1af');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.1+sha-0ebf1af` usually means that core is at head so it supports
