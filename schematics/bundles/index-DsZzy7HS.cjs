...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.2.0-next.3+sha-cbd300d'));
 ...
 */
new project_tsconfig_paths.Version('20.2.0-next.3+sha-cbd300d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.3+sha-cbd300d` usually means that core is at head so it supports
