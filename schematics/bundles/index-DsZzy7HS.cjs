...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.2.0-next.3+sha-8255e0c'));
 ...
 */
new project_tsconfig_paths.Version('20.2.0-next.3+sha-8255e0c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.3+sha-8255e0c` usually means that core is at head so it supports
