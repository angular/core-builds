...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.2.0-next.3+sha-3e6e1c1'));
 ...
 */
new project_tsconfig_paths.Version('20.2.0-next.3+sha-3e6e1c1');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.3+sha-3e6e1c1` usually means that core is at head so it supports
