...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.1+sha-4e5d6de'));
 ...
 */
new compiler.Version('20.0.0-rc.1+sha-4e5d6de');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.1+sha-4e5d6de` usually means that core is at head so it supports
