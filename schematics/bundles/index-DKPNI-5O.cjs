...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.1+sha-b90160d'));
 ...
 */
new compiler.Version('20.0.0-rc.1+sha-b90160d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.1+sha-b90160d` usually means that core is at head so it supports
