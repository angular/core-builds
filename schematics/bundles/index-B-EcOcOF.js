...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.11+sha-74e39ea'));
 ...
 */
new checker.Version('19.2.11+sha-74e39ea');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.11+sha-74e39ea` usually means that core is at head so it supports
