...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.11+sha-85e0baf'));
 ...
 */
new checker.Version('19.2.11+sha-85e0baf');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.11+sha-85e0baf` usually means that core is at head so it supports
