...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.11+sha-fd29dab'));
 ...
 */
new checker.Version('19.2.11+sha-fd29dab');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.11+sha-fd29dab` usually means that core is at head so it supports
