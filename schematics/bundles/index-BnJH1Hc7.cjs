...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.14+sha-6f6db99'));
 ...
 */
new checker.Version('19.2.14+sha-6f6db99');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.14+sha-6f6db99` usually means that core is at head so it supports
