...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.14+sha-70d0639'));
 ...
 */
new checker.Version('19.2.14+sha-70d0639');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.14+sha-70d0639` usually means that core is at head so it supports
