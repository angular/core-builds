...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.13+sha-6fea9c8'));
 ...
 */
new checker.Version('19.2.13+sha-6fea9c8');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.13+sha-6fea9c8` usually means that core is at head so it supports
