...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.14+sha-9317b1c'));
 ...
 */
new checker.Version('19.2.14+sha-9317b1c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.14+sha-9317b1c` usually means that core is at head so it supports
