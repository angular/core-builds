...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.15+sha-b2c7979'));
 ...
 */
new checker.Version('19.2.15+sha-b2c7979');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.15+sha-b2c7979` usually means that core is at head so it supports
