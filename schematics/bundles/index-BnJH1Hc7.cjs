...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.13+sha-9e1cd49'));
 ...
 */
new checker.Version('19.2.13+sha-9e1cd49');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.13+sha-9e1cd49` usually means that core is at head so it supports
