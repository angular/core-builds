...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.1.4+sha-0777222'));
 ...
 */
new project_tsconfig_paths.Version('20.1.4+sha-0777222');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.4+sha-0777222` usually means that core is at head so it supports
