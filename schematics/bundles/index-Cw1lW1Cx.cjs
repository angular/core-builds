...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.1.4+sha-3a8fa72'));
 ...
 */
new project_tsconfig_paths.Version('20.1.4+sha-3a8fa72');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.4+sha-3a8fa72` usually means that core is at head so it supports
