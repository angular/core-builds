...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.2.0-rc.1+sha-9655ea7'));
 ...
 */
new project_tsconfig_paths.Version('20.2.0-rc.1+sha-9655ea7');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-rc.1+sha-9655ea7` usually means that core is at head so it supports
