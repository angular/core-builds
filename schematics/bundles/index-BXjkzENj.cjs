...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.11+sha-2e7623c'));
 ...
 */
new project_tsconfig_paths.Version('20.3.11+sha-2e7623c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.11+sha-2e7623c` usually means that core is at head so it supports
