...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.11+sha-70da36f'));
 ...
 */
new project_tsconfig_paths.Version('20.3.11+sha-70da36f');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.11+sha-70da36f` usually means that core is at head so it supports
