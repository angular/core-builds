...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('21.0.0-next.7+sha-e3fa24d'));
 ...
 */
new project_tsconfig_paths.Version('21.0.0-next.7+sha-e3fa24d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `21.0.0-next.7+sha-e3fa24d` usually means that core is at head so it supports
