...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.12+sha-24c999a'));
 ...
 */
new project_tsconfig_paths.Version('20.3.12+sha-24c999a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.12+sha-24c999a` usually means that core is at head so it supports
