...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.12+sha-e0a6dad'));
 ...
 */
new project_tsconfig_paths.Version('20.3.12+sha-e0a6dad');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.12+sha-e0a6dad` usually means that core is at head so it supports
