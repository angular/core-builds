...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.9+sha-744cd5c'));
 ...
 */
new project_tsconfig_paths.Version('20.3.9+sha-744cd5c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.9+sha-744cd5c` usually means that core is at head so it supports
