...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.9+sha-88952b5'));
 ...
 */
new project_tsconfig_paths.Version('20.3.9+sha-88952b5');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.9+sha-88952b5` usually means that core is at head so it supports
