...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.9+sha-a57c03d'));
 ...
 */
new project_tsconfig_paths.Version('20.3.9+sha-a57c03d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.9+sha-a57c03d` usually means that core is at head so it supports
