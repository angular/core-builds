...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.15+sha-c2c2b4a'));
 ...
 */
new project_tsconfig_paths.Version('20.3.15+sha-c2c2b4a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.15+sha-c2c2b4a` usually means that core is at head so it supports
