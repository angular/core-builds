...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.1+sha-0db3613'));
 ...
 */
new checker.Version('20.1.1+sha-0db3613');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.1+sha-0db3613` usually means that core is at head so it supports
