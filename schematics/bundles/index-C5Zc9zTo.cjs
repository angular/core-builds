...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.1+sha-1930e99'));
 ...
 */
new checker.Version('20.1.1+sha-1930e99');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.1+sha-1930e99` usually means that core is at head so it supports
