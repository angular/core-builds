...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.1+sha-44784f1'));
 ...
 */
new checker.Version('20.1.1+sha-44784f1');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.1+sha-44784f1` usually means that core is at head so it supports
