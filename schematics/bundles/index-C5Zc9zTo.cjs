...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.1+sha-4b9385f'));
 ...
 */
new checker.Version('20.1.1+sha-4b9385f');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.1+sha-4b9385f` usually means that core is at head so it supports
