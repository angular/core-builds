...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0+sha-9506cdf'));
 ...
 */
new checker.Version('20.1.0+sha-9506cdf');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0+sha-9506cdf` usually means that core is at head so it supports
