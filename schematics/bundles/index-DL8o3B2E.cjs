...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-rc.0+sha-2f45910'));
 ...
 */
new checker.Version('20.1.0-rc.0+sha-2f45910');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-rc.0+sha-2f45910` usually means that core is at head so it supports
