...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.0+sha-ce8156a'));
 ...
 */
new checker.Version('20.2.0-next.0+sha-ce8156a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.0+sha-ce8156a` usually means that core is at head so it supports
