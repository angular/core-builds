...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.6+sha-f22c72b'));
 ...
 */
new compiler.Version('20.0.0-next.6+sha-f22c72b');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.6+sha-f22c72b` usually means that core is at head so it supports
