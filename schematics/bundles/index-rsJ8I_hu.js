...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.7+sha-104ad0a'));
 ...
 */
new compiler.Version('20.0.0-next.7+sha-104ad0a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.7+sha-104ad0a` usually means that core is at head so it supports
