...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.6+sha-65adb30'));
 ...
 */
new compiler.Version('20.0.0-next.6+sha-65adb30');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.6+sha-65adb30` usually means that core is at head so it supports
