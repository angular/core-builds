...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.6+sha-b2c8fb3'));
 ...
 */
new compiler.Version('20.0.0-next.6+sha-b2c8fb3');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.6+sha-b2c8fb3` usually means that core is at head so it supports
