...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.7+sha-c7e9cb9'));
 ...
 */
new compiler.Version('20.0.0-next.7+sha-c7e9cb9');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.7+sha-c7e9cb9` usually means that core is at head so it supports
