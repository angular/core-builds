...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.7+sha-f838726'));
 ...
 */
new compiler.Version('20.0.0-next.7+sha-f838726');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.7+sha-f838726` usually means that core is at head so it supports
