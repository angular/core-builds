...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.7+sha-2f3f8d6'));
 ...
 */
new compiler.Version('20.0.0-next.7+sha-2f3f8d6');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.7+sha-2f3f8d6` usually means that core is at head so it supports
