...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.6+sha-cbbea70'));
 ...
 */
new compiler.Version('20.0.0-next.6+sha-cbbea70');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.6+sha-cbbea70` usually means that core is at head so it supports
