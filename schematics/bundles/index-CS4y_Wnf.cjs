...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.11+sha-bb31f6f'));
 ...
 */
new checker.Version('19.2.11+sha-bb31f6f');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.11+sha-bb31f6f` usually means that core is at head so it supports
