...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.11+sha-0a25aba'));
 ...
 */
new checker.Version('19.2.11+sha-0a25aba');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.11+sha-0a25aba` usually means that core is at head so it supports
