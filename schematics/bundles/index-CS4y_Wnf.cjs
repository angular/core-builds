...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.11+sha-9ce79be'));
 ...
 */
new checker.Version('19.2.11+sha-9ce79be');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.11+sha-9ce79be` usually means that core is at head so it supports
