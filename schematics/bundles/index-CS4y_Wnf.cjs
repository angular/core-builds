...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.11+sha-7d0db3d'));
 ...
 */
new checker.Version('19.2.11+sha-7d0db3d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.11+sha-7d0db3d` usually means that core is at head so it supports
