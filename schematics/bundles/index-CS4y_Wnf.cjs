...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.11+sha-1360e4b'));
 ...
 */
new checker.Version('19.2.11+sha-1360e4b');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.11+sha-1360e4b` usually means that core is at head so it supports
