...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.11+sha-7198905'));
 ...
 */
new checker.Version('19.2.11+sha-7198905');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.11+sha-7198905` usually means that core is at head so it supports
