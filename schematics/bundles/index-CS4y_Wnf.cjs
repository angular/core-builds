...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.11+sha-c0c69a5'));
 ...
 */
new checker.Version('19.2.11+sha-c0c69a5');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.11+sha-c0c69a5` usually means that core is at head so it supports
