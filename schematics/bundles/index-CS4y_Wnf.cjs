...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.11+sha-dbd66ec'));
 ...
 */
new checker.Version('19.2.11+sha-dbd66ec');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.11+sha-dbd66ec` usually means that core is at head so it supports
