...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.6+sha-086857c'));
 ...
 */
new project_tsconfig_paths.Version('20.3.6+sha-086857c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.6+sha-086857c` usually means that core is at head so it supports
