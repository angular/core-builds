...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.5+sha-69dabdb'));
 ...
 */
new project_tsconfig_paths.Version('20.3.5+sha-69dabdb');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.5+sha-69dabdb` usually means that core is at head so it supports
