...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.5+sha-6a7c27e'));
 ...
 */
new project_tsconfig_paths.Version('20.3.5+sha-6a7c27e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.5+sha-6a7c27e` usually means that core is at head so it supports
