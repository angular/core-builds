...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.5+sha-e6c0223'));
 ...
 */
new project_tsconfig_paths.Version('20.3.5+sha-e6c0223');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.5+sha-e6c0223` usually means that core is at head so it supports
