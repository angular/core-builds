...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.5+sha-d8e941b'));
 ...
 */
new compiler.Version('20.0.0-next.5+sha-d8e941b');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.5+sha-d8e941b` usually means that core is at head so it supports
