...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.5+sha-0ae1889'));
 ...
 */
new compiler.Version('20.0.0-next.5+sha-0ae1889');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.5+sha-0ae1889` usually means that core is at head so it supports
