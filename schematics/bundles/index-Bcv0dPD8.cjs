...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.2.1+sha-1c27fa9'));
 ...
 */
new project_tsconfig_paths.Version('20.2.1+sha-1c27fa9');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.1+sha-1c27fa9` usually means that core is at head so it supports
