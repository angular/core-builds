...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.2.1+sha-a26d94d'));
 ...
 */
new project_tsconfig_paths.Version('20.2.1+sha-a26d94d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.1+sha-a26d94d` usually means that core is at head so it supports
