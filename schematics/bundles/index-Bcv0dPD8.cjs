...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.2.1+sha-e1481d8'));
 ...
 */
new project_tsconfig_paths.Version('20.2.1+sha-e1481d8');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.1+sha-e1481d8` usually means that core is at head so it supports
