...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.2.1+sha-9a27c5b'));
 ...
 */
new project_tsconfig_paths.Version('20.2.1+sha-9a27c5b');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.1+sha-9a27c5b` usually means that core is at head so it supports
