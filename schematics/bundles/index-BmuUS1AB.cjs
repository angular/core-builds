...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.0+sha-1cff7ca'));
 ...
 */
new checker.Version('20.2.0-next.0+sha-1cff7ca');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.0+sha-1cff7ca` usually means that core is at head so it supports
