...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0+sha-6549418'));
 ...
 */
new checker.Version('20.1.0+sha-6549418');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0+sha-6549418` usually means that core is at head so it supports
