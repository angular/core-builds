...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-rc.0+sha-c4de0c0'));
 ...
 */
new checker.Version('20.1.0-rc.0+sha-c4de0c0');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-rc.0+sha-c4de0c0` usually means that core is at head so it supports
