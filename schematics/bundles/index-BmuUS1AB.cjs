...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.0+sha-be811fe'));
 ...
 */
new checker.Version('20.2.0-next.0+sha-be811fe');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.0+sha-be811fe` usually means that core is at head so it supports
