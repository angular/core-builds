...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0+sha-a81f0fa'));
 ...
 */
new checker.Version('20.1.0+sha-a81f0fa');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0+sha-a81f0fa` usually means that core is at head so it supports
