...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0+sha-4f1e88e'));
 ...
 */
new checker.Version('20.1.0+sha-4f1e88e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0+sha-4f1e88e` usually means that core is at head so it supports
