...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0+sha-bf1b51c'));
 ...
 */
new checker.Version('20.1.0+sha-bf1b51c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0+sha-bf1b51c` usually means that core is at head so it supports
