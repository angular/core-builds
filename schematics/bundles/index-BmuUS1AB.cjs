...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-rc.0+sha-dda655f'));
 ...
 */
new checker.Version('20.1.0-rc.0+sha-dda655f');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-rc.0+sha-dda655f` usually means that core is at head so it supports
