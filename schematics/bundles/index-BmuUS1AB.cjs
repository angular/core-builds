...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0+sha-aea0a70'));
 ...
 */
new checker.Version('20.1.0+sha-aea0a70');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0+sha-aea0a70` usually means that core is at head so it supports
