...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0+sha-f202160'));
 ...
 */
new checker.Version('20.1.0+sha-f202160');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0+sha-f202160` usually means that core is at head so it supports
