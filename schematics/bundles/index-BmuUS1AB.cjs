...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-rc.0+sha-fed402f'));
 ...
 */
new checker.Version('20.1.0-rc.0+sha-fed402f');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-rc.0+sha-fed402f` usually means that core is at head so it supports
