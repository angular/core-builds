...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-rc.0+sha-1a8297b'));
 ...
 */
new checker.Version('20.1.0-rc.0+sha-1a8297b');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-rc.0+sha-1a8297b` usually means that core is at head so it supports
