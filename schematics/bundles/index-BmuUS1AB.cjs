...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.0+sha-75a5d08'));
 ...
 */
new checker.Version('20.2.0-next.0+sha-75a5d08');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.0+sha-75a5d08` usually means that core is at head so it supports
