...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0+sha-02dce8e'));
 ...
 */
new checker.Version('20.1.0+sha-02dce8e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0+sha-02dce8e` usually means that core is at head so it supports
