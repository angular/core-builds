...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0+sha-66a85ab'));
 ...
 */
new checker.Version('20.1.0+sha-66a85ab');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0+sha-66a85ab` usually means that core is at head so it supports
