...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0+sha-0ce086e'));
 ...
 */
new checker.Version('20.1.0+sha-0ce086e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0+sha-0ce086e` usually means that core is at head so it supports
