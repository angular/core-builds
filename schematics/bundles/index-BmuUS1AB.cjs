...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0+sha-b4ae55a'));
 ...
 */
new checker.Version('20.1.0+sha-b4ae55a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0+sha-b4ae55a` usually means that core is at head so it supports
