...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.0+sha-365ca13'));
 ...
 */
new checker.Version('20.2.0-next.0+sha-365ca13');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.0+sha-365ca13` usually means that core is at head so it supports
