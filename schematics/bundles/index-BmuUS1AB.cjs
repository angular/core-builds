...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.0+sha-96014b5'));
 ...
 */
new checker.Version('20.2.0-next.0+sha-96014b5');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.0+sha-96014b5` usually means that core is at head so it supports
