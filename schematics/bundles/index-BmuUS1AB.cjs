...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0+sha-db11cdd'));
 ...
 */
new checker.Version('20.1.0+sha-db11cdd');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0+sha-db11cdd` usually means that core is at head so it supports
