...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.2+sha-20c1f99'));
 ...
 */
new checker.Version('20.1.0-next.2+sha-20c1f99');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.2+sha-20c1f99` usually means that core is at head so it supports
