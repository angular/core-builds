...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.2+sha-4f0126e'));
 ...
 */
new checker.Version('20.1.0-next.2+sha-4f0126e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.2+sha-4f0126e` usually means that core is at head so it supports
