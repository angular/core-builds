...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.2+sha-b489f9f'));
 ...
 */
new checker.Version('20.1.0-next.2+sha-b489f9f');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.2+sha-b489f9f` usually means that core is at head so it supports
