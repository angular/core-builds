...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.6+sha-ce958e0'));
 ...
 */
new checker.Version('20.0.6+sha-ce958e0');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.6+sha-ce958e0` usually means that core is at head so it supports
