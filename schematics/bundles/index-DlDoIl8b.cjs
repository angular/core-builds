...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.7+sha-b2076fa'));
 ...
 */
new checker.Version('20.0.7+sha-b2076fa');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.7+sha-b2076fa` usually means that core is at head so it supports
