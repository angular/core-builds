...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.4+sha-9cbe5b6'));
 ...
 */
new project_tsconfig_paths.Version('20.3.4+sha-9cbe5b6');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.4+sha-9cbe5b6` usually means that core is at head so it supports
