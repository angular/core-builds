...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.0-next.2+sha-34f0453'));
 ...
 */
new checker.Version('20.0.0-next.2+sha-34f0453');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.2+sha-34f0453` usually means that core is at head so it supports
