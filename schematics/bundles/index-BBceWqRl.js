...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.0-next.2+sha-7e65b9f'));
 ...
 */
new checker.Version('20.0.0-next.2+sha-7e65b9f');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.2+sha-7e65b9f` usually means that core is at head so it supports
