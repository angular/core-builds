...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.3+sha-c5c9b0b'));
 ...
 */
new checker.Version('20.1.0-next.3+sha-c5c9b0b');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.3+sha-c5c9b0b` usually means that core is at head so it supports
