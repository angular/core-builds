...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.3+sha-df1a61f'));
 ...
 */
new checker.Version('20.1.0-next.3+sha-df1a61f');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.3+sha-df1a61f` usually means that core is at head so it supports
