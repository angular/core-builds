...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.3+sha-13875d0'));
 ...
 */
new checker.Version('20.1.0-next.3+sha-13875d0');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.3+sha-13875d0` usually means that core is at head so it supports
