...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.3+sha-9afc00f'));
 ...
 */
new checker.Version('20.1.0-next.3+sha-9afc00f');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.3+sha-9afc00f` usually means that core is at head so it supports
