...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.3+sha-b2afa11'));
 ...
 */
new checker.Version('20.1.0-next.3+sha-b2afa11');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.3+sha-b2afa11` usually means that core is at head so it supports
