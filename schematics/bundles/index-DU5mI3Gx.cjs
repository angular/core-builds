...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.3+sha-e1856da'));
 ...
 */
new checker.Version('20.1.0-next.3+sha-e1856da');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.3+sha-e1856da` usually means that core is at head so it supports
