...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.3+sha-cd30c4d'));
 ...
 */
new checker.Version('20.1.0-next.3+sha-cd30c4d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.3+sha-cd30c4d` usually means that core is at head so it supports
