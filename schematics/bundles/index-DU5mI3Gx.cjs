...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.3+sha-6ec2900'));
 ...
 */
new checker.Version('20.1.0-next.3+sha-6ec2900');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.3+sha-6ec2900` usually means that core is at head so it supports
