...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.3+sha-08e2d9d'));
 ...
 */
new checker.Version('20.1.0-next.3+sha-08e2d9d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.3+sha-08e2d9d` usually means that core is at head so it supports
