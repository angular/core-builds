...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.3+sha-f1deaba'));
 ...
 */
new checker.Version('20.1.0-next.3+sha-f1deaba');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.3+sha-f1deaba` usually means that core is at head so it supports
