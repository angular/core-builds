...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.3+sha-f10e1bc'));
 ...
 */
new checker.Version('20.1.0-next.3+sha-f10e1bc');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.3+sha-f10e1bc` usually means that core is at head so it supports
