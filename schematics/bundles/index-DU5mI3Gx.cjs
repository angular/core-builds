...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.3+sha-493f25b'));
 ...
 */
new checker.Version('20.1.0-next.3+sha-493f25b');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.3+sha-493f25b` usually means that core is at head so it supports
