...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.1+sha-30e0812'));
 ...
 */
new compiler.Version('20.0.0-rc.1+sha-30e0812');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.1+sha-30e0812` usually means that core is at head so it supports
