...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.1+sha-7a44727'));
 ...
 */
new compiler.Version('20.0.0-rc.1+sha-7a44727');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.1+sha-7a44727` usually means that core is at head so it supports
