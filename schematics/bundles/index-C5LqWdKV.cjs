...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.4+sha-35ce544'));
 ...
 */
new checker.Version('20.0.4+sha-35ce544');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.4+sha-35ce544` usually means that core is at head so it supports
