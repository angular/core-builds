...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.4+sha-2ae2076'));
 ...
 */
new checker.Version('20.0.4+sha-2ae2076');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.4+sha-2ae2076` usually means that core is at head so it supports
