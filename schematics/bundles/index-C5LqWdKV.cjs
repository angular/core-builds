...
var checker = require('./checker-CpYy3ghc.cjs');
...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.4+sha-f8a6537'));
 ...
 */
new checker.Version('20.0.4+sha-f8a6537');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.4+sha-f8a6537` usually means that core is at head so it supports
