...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.4+sha-9c41449'));
 ...
 */
new checker.Version('20.0.4+sha-9c41449');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.4+sha-9c41449` usually means that core is at head so it supports
