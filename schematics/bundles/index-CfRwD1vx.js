...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.0-next.2+sha-c27511e'));
 ...
 */
new checker.Version('20.0.0-next.2+sha-c27511e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.2+sha-c27511e` usually means that core is at head so it supports
