...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.0-next.2+sha-450c1fc'));
 ...
 */
new checker.Version('20.0.0-next.2+sha-450c1fc');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.2+sha-450c1fc` usually means that core is at head so it supports
