...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.0-next.2+sha-2ca72fa'));
 ...
 */
new checker.Version('20.0.0-next.2+sha-2ca72fa');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.2+sha-2ca72fa` usually means that core is at head so it supports
