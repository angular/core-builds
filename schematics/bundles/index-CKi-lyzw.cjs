...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.1.0-next.0+sha-1148b7e'));
 ...
 */
new compiler.Version('20.1.0-next.0+sha-1148b7e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-1148b7e` usually means that core is at head so it supports
