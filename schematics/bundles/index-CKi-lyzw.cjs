...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.1.0-next.0+sha-2e7032e'));
 ...
 */
new compiler.Version('20.1.0-next.0+sha-2e7032e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-2e7032e` usually means that core is at head so it supports
