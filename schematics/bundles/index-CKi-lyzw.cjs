...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.1.0-next.0+sha-c7420df'));
 ...
 */
new compiler.Version('20.1.0-next.0+sha-c7420df');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-c7420df` usually means that core is at head so it supports
