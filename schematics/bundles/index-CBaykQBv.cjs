...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('21.0.0-next.3+sha-fde699b'));
 ...
 */
new project_tsconfig_paths.Version('21.0.0-next.3+sha-fde699b');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `21.0.0-next.3+sha-fde699b` usually means that core is at head so it supports
