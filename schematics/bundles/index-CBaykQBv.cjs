...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('21.0.0-next.3+sha-39337cf'));
 ...
 */
new project_tsconfig_paths.Version('21.0.0-next.3+sha-39337cf');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `21.0.0-next.3+sha-39337cf` usually means that core is at head so it supports
