...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.18+sha-303d4cd'));
 ...
 */
new project_tsconfig_paths.Version('20.3.18+sha-303d4cd');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.18+sha-303d4cd` usually means that core is at head so it supports
