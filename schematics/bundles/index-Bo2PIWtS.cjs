...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-rc.0+sha-30218af'));
 ...
 */
new checker.Version('20.1.0-rc.0+sha-30218af');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-rc.0+sha-30218af` usually means that core is at head so it supports
