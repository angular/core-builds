...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.0+sha-c6a720b'));
 ...
 */
new checker.Version('20.2.0-next.0+sha-c6a720b');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.0+sha-c6a720b` usually means that core is at head so it supports
