...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.2.0-next.5+sha-0d12eac'));
 ...
 */
new project_tsconfig_paths.Version('20.2.0-next.5+sha-0d12eac');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.5+sha-0d12eac` usually means that core is at head so it supports
