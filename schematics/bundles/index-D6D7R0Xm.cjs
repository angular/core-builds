...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.5+sha-0866077'));
 ...
 */
new checker.Version('20.0.5+sha-0866077');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.5+sha-0866077` usually means that core is at head so it supports
