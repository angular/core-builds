...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.4+sha-767e1dd'));
 ...
 */
new checker.Version('20.0.4+sha-767e1dd');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.4+sha-767e1dd` usually means that core is at head so it supports
