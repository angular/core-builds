...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.5+sha-19eaf71'));
 ...
 */
new checker.Version('20.0.5+sha-19eaf71');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.5+sha-19eaf71` usually means that core is at head so it supports
