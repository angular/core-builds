...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.5+sha-308c82d'));
 ...
 */
new checker.Version('20.0.5+sha-308c82d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.5+sha-308c82d` usually means that core is at head so it supports
