...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.5+sha-5edbb54'));
 ...
 */
new checker.Version('20.0.5+sha-5edbb54');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.5+sha-5edbb54` usually means that core is at head so it supports
