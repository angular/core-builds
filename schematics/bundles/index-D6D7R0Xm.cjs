...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.4+sha-a42169a'));
 ...
 */
new checker.Version('20.0.4+sha-a42169a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.4+sha-a42169a` usually means that core is at head so it supports
