...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.5+sha-029043c'));
 ...
 */
new checker.Version('20.0.5+sha-029043c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.5+sha-029043c` usually means that core is at head so it supports
