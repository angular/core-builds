...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.4+sha-4f1a5ab'));
 ...
 */
new checker.Version('20.0.4+sha-4f1a5ab');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.4+sha-4f1a5ab` usually means that core is at head so it supports
