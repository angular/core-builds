...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.4+sha-7a520ff'));
 ...
 */
new checker.Version('20.0.4+sha-7a520ff');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.4+sha-7a520ff` usually means that core is at head so it supports
