...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.5+sha-a7a6a5b'));
 ...
 */
new checker.Version('20.0.5+sha-a7a6a5b');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.5+sha-a7a6a5b` usually means that core is at head so it supports
