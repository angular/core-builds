...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.5+sha-82cdd5c'));
 ...
 */
new checker.Version('20.0.5+sha-82cdd5c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.5+sha-82cdd5c` usually means that core is at head so it supports
