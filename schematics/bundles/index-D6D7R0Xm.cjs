...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.5+sha-41230e6'));
 ...
 */
new checker.Version('20.0.5+sha-41230e6');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.5+sha-41230e6` usually means that core is at head so it supports
