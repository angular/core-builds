...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.5+sha-ac7fe2c'));
 ...
 */
new checker.Version('20.0.5+sha-ac7fe2c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.5+sha-ac7fe2c` usually means that core is at head so it supports
