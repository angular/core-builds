...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.5+sha-a3c246a'));
 ...
 */
new checker.Version('20.0.5+sha-a3c246a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.5+sha-a3c246a` usually means that core is at head so it supports
