...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.5+sha-c6f0f54'));
 ...
 */
new checker.Version('20.0.5+sha-c6f0f54');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.5+sha-c6f0f54` usually means that core is at head so it supports
