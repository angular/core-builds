...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.4+sha-9d20d6f'));
 ...
 */
new checker.Version('20.0.4+sha-9d20d6f');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.4+sha-9d20d6f` usually means that core is at head so it supports
