...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.5+sha-c39b80f'));
 ...
 */
new checker.Version('20.0.5+sha-c39b80f');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.5+sha-c39b80f` usually means that core is at head so it supports
