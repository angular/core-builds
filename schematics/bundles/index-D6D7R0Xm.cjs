...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.5+sha-31e3eb2'));
 ...
 */
new checker.Version('20.0.5+sha-31e3eb2');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.5+sha-31e3eb2` usually means that core is at head so it supports
