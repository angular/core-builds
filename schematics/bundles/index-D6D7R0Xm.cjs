...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.5+sha-e3103fe'));
 ...
 */
new checker.Version('20.0.5+sha-e3103fe');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.5+sha-e3103fe` usually means that core is at head so it supports
