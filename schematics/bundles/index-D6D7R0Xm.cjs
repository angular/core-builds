...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.5+sha-8d58150'));
 ...
 */
new checker.Version('20.0.5+sha-8d58150');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.5+sha-8d58150` usually means that core is at head so it supports
