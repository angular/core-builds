...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.0.0-rc.0+sha-da1cd6f'));
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.0.0-rc.0+sha-da1cd6f` usually means that core is at head so it supports
