...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.9+sha-05feabd'));
 ...
 */
new compiler.Version('20.0.0-next.9+sha-05feabd');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.9+sha-05feabd` usually means that core is at head so it supports
