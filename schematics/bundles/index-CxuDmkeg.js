...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.9+sha-c276981'));
 ...
 */
new compiler.Version('20.0.0-next.9+sha-c276981');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.9+sha-c276981` usually means that core is at head so it supports
