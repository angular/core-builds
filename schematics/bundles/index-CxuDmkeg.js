...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.0+sha-2f7e4eb'));
 ...
 */
new compiler.Version('20.0.0-rc.0+sha-2f7e4eb');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.0+sha-2f7e4eb` usually means that core is at head so it supports
