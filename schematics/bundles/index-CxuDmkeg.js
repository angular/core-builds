...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.9+sha-6cd5d8e'));
 ...
 */
new compiler.Version('20.0.0-next.9+sha-6cd5d8e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.9+sha-6cd5d8e` usually means that core is at head so it supports
