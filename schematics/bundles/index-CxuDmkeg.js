...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.0+sha-69bfece'));
 ...
 */
new compiler.Version('20.0.0-rc.0+sha-69bfece');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.0+sha-69bfece` usually means that core is at head so it supports
