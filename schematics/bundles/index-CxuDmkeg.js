...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.9+sha-b8f80ab'));
 ...
 */
new compiler.Version('20.0.0-next.9+sha-b8f80ab');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.9+sha-b8f80ab` usually means that core is at head so it supports
