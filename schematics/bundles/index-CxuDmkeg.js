...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.1.0-next.0+sha-6bc9d45'));
 ...
 */
new compiler.Version('20.1.0-next.0+sha-6bc9d45');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-6bc9d45` usually means that core is at head so it supports
