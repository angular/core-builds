...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.0+sha-83c98ad'));
 ...
 */
new compiler.Version('20.0.0-rc.0+sha-83c98ad');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.0+sha-83c98ad` usually means that core is at head so it supports
