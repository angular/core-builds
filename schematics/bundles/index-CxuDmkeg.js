...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.9+sha-ff943e3'));
 ...
 */
new compiler.Version('20.0.0-next.9+sha-ff943e3');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.9+sha-ff943e3` usually means that core is at head so it supports
