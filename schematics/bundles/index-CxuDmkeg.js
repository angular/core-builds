...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.0+sha-1dece6c'));
 ...
 */
new compiler.Version('20.0.0-rc.0+sha-1dece6c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.0+sha-1dece6c` usually means that core is at head so it supports
