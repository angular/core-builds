...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.0+sha-bad2870'));
 ...
 */
new compiler.Version('20.0.0-rc.0+sha-bad2870');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.0+sha-bad2870` usually means that core is at head so it supports
