...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.0+sha-345d3d8'));
 ...
 */
new compiler.Version('20.0.0-rc.0+sha-345d3d8');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.0+sha-345d3d8` usually means that core is at head so it supports
