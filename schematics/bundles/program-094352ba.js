...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.1.0-next.3+sha-c181903'));
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.1.0-next.3+sha-c181903` usually means that core is at head so it supports
