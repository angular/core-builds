...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.8+sha-d8204bf'));
 ...
 */
new compiler.Version('20.0.0-next.8+sha-d8204bf');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.8+sha-d8204bf` usually means that core is at head so it supports
