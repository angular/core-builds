...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.8+sha-ccc5cc0'));
 ...
 */
new compiler.Version('20.0.0-next.8+sha-ccc5cc0');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.8+sha-ccc5cc0` usually means that core is at head so it supports
