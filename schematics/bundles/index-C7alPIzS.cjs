...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.3+sha-55e575a'));
 ...
 */
new checker.Version('20.1.3+sha-55e575a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.3+sha-55e575a` usually means that core is at head so it supports
