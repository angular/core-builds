...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.3+sha-a2e3bfc'));
 ...
 */
new checker.Version('20.1.3+sha-a2e3bfc');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.3+sha-a2e3bfc` usually means that core is at head so it supports
