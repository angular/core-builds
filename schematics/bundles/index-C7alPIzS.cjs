...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.3+sha-280f1f5'));
 ...
 */
new checker.Version('20.1.3+sha-280f1f5');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.3+sha-280f1f5` usually means that core is at head so it supports
