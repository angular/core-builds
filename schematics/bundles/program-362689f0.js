...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.0-next.0+sha-65e54ae'));
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.0+sha-65e54ae` usually means that core is at head so it supports
