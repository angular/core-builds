...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.1+sha-de7d8be'));
 ...
 */
new compiler.Version('20.0.0-rc.1+sha-de7d8be');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.1+sha-de7d8be` usually means that core is at head so it supports
