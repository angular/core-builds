...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.1+sha-41ded3d'));
 ...
 */
new compiler.Version('20.0.0-rc.1+sha-41ded3d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.1+sha-41ded3d` usually means that core is at head so it supports
