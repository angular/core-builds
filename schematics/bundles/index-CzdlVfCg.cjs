...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.1+sha-fcd4355'));
 ...
 */
new compiler.Version('20.0.0-rc.1+sha-fcd4355');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.1+sha-fcd4355` usually means that core is at head so it supports
