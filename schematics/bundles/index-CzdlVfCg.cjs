...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.1+sha-810b3ef'));
 ...
 */
new compiler.Version('20.0.0-rc.1+sha-810b3ef');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.1+sha-810b3ef` usually means that core is at head so it supports
