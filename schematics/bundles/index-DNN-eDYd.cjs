...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('21.1.0-next.0+sha-b478e91'));
 ...
 */
new project_tsconfig_paths.Version('21.1.0-next.0+sha-b478e91');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `21.1.0-next.0+sha-b478e91` usually means that core is at head so it supports
