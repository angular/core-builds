...
var checker = require('./checker-WzomkuMa.cjs');
...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.11+sha-1071802'));
 ...
 */
new checker.Version('19.2.11+sha-1071802');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.11+sha-1071802` usually means that core is at head so it supports
