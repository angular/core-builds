...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0+sha-acf8b74'));
 ...
 */
new checker.Version('20.1.0+sha-acf8b74');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0+sha-acf8b74` usually means that core is at head so it supports
