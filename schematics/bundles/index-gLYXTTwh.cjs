...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0+sha-72605a4'));
 ...
 */
new checker.Version('20.1.0+sha-72605a4');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0+sha-72605a4` usually means that core is at head so it supports
