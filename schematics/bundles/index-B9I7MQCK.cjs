...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.1.7+sha-bc3798d'));
 ...
 */
new project_tsconfig_paths.Version('20.1.7+sha-bc3798d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.7+sha-bc3798d` usually means that core is at head so it supports
