...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.1.7+sha-373670c'));
 ...
 */
new project_tsconfig_paths.Version('20.1.7+sha-373670c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.7+sha-373670c` usually means that core is at head so it supports
