...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('21.0.0-next.0+sha-086ae5e'));
 ...
 */
new project_tsconfig_paths.Version('21.0.0-next.0+sha-086ae5e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `21.0.0-next.0+sha-086ae5e` usually means that core is at head so it supports
