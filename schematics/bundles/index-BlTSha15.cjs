...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('21.0.0-next.0+sha-3d7b31c'));
 ...
 */
new project_tsconfig_paths.Version('21.0.0-next.0+sha-3d7b31c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `21.0.0-next.0+sha-3d7b31c` usually means that core is at head so it supports
