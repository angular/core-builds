...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.29+sha-9339a7a'));
 ...
 */
new project_tsconfig_paths.Version('20.3.29+sha-9339a7a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.29+sha-9339a7a` usually means that core is at head so it supports
