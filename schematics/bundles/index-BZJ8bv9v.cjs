...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.4+sha-e8de1b4'));
 ...
 */
new project_tsconfig_paths.Version('20.3.4+sha-e8de1b4');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.4+sha-e8de1b4` usually means that core is at head so it supports
