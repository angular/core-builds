...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.2+sha-a453b1d'));
 ...
 */
new project_tsconfig_paths.Version('20.3.2+sha-a453b1d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.2+sha-a453b1d` usually means that core is at head so it supports
