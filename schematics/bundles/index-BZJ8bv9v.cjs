...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.3+sha-9be76ad'));
 ...
 */
new project_tsconfig_paths.Version('20.3.3+sha-9be76ad');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.3+sha-9be76ad` usually means that core is at head so it supports
