...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.3+sha-e2820d1'));
 ...
 */
new project_tsconfig_paths.Version('20.3.3+sha-e2820d1');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.3+sha-e2820d1` usually means that core is at head so it supports
