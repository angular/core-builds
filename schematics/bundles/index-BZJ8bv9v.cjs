...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.3+sha-c314ccb'));
 ...
 */
new project_tsconfig_paths.Version('20.3.3+sha-c314ccb');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.3+sha-c314ccb` usually means that core is at head so it supports
