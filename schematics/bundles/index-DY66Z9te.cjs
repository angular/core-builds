...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.2+sha-07df4e1'));
 ...
 */
new checker.Version('20.1.0-next.2+sha-07df4e1');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.2+sha-07df4e1` usually means that core is at head so it supports
