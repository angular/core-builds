...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.2+sha-7600bec'));
 ...
 */
new checker.Version('20.1.0-next.2+sha-7600bec');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.2+sha-7600bec` usually means that core is at head so it supports
