...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.13+sha-61c731a'));
 ...
 */
new checker.Version('19.2.13+sha-61c731a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.13+sha-61c731a` usually means that core is at head so it supports
