...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.1+sha-a484a11'));
 ...
 */
new checker.Version('20.2.0-next.1+sha-a484a11');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.1+sha-a484a11` usually means that core is at head so it supports
