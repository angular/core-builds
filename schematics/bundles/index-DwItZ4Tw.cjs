...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.2.0+sha-a6130e0'));
 ...
 */
new project_tsconfig_paths.Version('20.2.0+sha-a6130e0');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0+sha-a6130e0` usually means that core is at head so it supports
