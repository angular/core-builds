...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.2.0+sha-9bdb4fe'));
 ...
 */
new project_tsconfig_paths.Version('20.2.0+sha-9bdb4fe');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0+sha-9bdb4fe` usually means that core is at head so it supports
