...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.0-next.2+sha-c147a0d'));
 ...
 */
new checker.Version('20.0.0-next.2+sha-c147a0d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.2+sha-c147a0d` usually means that core is at head so it supports
