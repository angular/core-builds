...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.2.0-rc.1+sha-87523e9'));
 ...
 */
new project_tsconfig_paths.Version('20.2.0-rc.1+sha-87523e9');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-rc.1+sha-87523e9` usually means that core is at head so it supports
