...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.0-next.4+sha-98bf4d5'));
 ...
 */
new checker.Version('20.0.0-next.4+sha-98bf4d5');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.4+sha-98bf4d5` usually means that core is at head so it supports
