...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('21.0.0-next.0+sha-657061e'));
 ...
 */
new project_tsconfig_paths.Version('21.0.0-next.0+sha-657061e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `21.0.0-next.0+sha-657061e` usually means that core is at head so it supports
