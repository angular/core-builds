...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.2.0-rc.0+sha-0065ebb'));
 ...
 */
new project_tsconfig_paths.Version('20.2.0-rc.0+sha-0065ebb');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-rc.0+sha-0065ebb` usually means that core is at head so it supports
