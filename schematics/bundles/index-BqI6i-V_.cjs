...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.0-next.0+sha-d7a5ead'));
 ...
 */
new project_tsconfig_paths.Version('20.3.0-next.0+sha-d7a5ead');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.0-next.0+sha-d7a5ead` usually means that core is at head so it supports
