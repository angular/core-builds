...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.5+sha-1899358'));
 ...
 */
new compiler.Version('20.0.0-next.5+sha-1899358');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.5+sha-1899358` usually means that core is at head so it supports
