...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.5+sha-1765ebf'));
 ...
 */
new compiler.Version('20.0.0-next.5+sha-1765ebf');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.5+sha-1765ebf` usually means that core is at head so it supports
