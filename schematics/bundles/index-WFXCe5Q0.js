...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.5+sha-a22b13f'));
 ...
 */
new compiler.Version('20.0.0-next.5+sha-a22b13f');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.5+sha-a22b13f` usually means that core is at head so it supports
