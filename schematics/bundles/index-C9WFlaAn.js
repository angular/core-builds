...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.1.0-next.0+sha-d3f667a'));
 ...
 */
new compiler.Version('20.1.0-next.0+sha-d3f667a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-d3f667a` usually means that core is at head so it supports
