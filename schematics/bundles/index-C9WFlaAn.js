...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.1.0-next.0+sha-08bf41e'));
 ...
 */
new compiler.Version('20.1.0-next.0+sha-08bf41e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-08bf41e` usually means that core is at head so it supports
