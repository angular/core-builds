...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.5+sha-880ebf4'));
 ...
 */
new checker.Version('19.2.5+sha-880ebf4');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.5+sha-880ebf4` usually means that core is at head so it supports
