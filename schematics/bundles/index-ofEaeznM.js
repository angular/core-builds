...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.5+sha-d99935a'));
 ...
 */
new checker.Version('19.2.5+sha-d99935a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.5+sha-d99935a` usually means that core is at head so it supports
