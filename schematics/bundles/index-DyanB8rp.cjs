...
require('os');
var project_tsconfig_paths = require('./project_tsconfig_paths-CsnrfxxO.cjs');
var index = require('./index-BgPzkt_a.cjs');
require('path');
require('node:path');
var project_paths = require('./project_paths-DvK4rgjD.cjs');
