...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.0+sha-78c417a'));
 ...
 */
new checker.Version('20.1.0-next.0+sha-78c417a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-78c417a` usually means that core is at head so it supports
