...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.0+sha-967c8fe'));
 ...
 */
new checker.Version('20.1.0-next.0+sha-967c8fe');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-967c8fe` usually means that core is at head so it supports
