...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.0+sha-ab5b7df'));
 ...
 */
new checker.Version('20.1.0-next.0+sha-ab5b7df');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-ab5b7df` usually means that core is at head so it supports
