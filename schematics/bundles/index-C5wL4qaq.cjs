...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.0+sha-e81ea0c'));
 ...
 */
new checker.Version('20.1.0-next.0+sha-e81ea0c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-e81ea0c` usually means that core is at head so it supports
