...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.0+sha-4f89f6e'));
 ...
 */
new checker.Version('20.1.0-next.0+sha-4f89f6e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-4f89f6e` usually means that core is at head so it supports
