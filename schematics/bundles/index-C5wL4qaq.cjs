...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.0+sha-9354efc'));
 ...
 */
new checker.Version('20.1.0-next.0+sha-9354efc');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-9354efc` usually means that core is at head so it supports
