...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.0+sha-8ab0028'));
 ...
 */
new checker.Version('20.1.0-next.0+sha-8ab0028');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-8ab0028` usually means that core is at head so it supports
