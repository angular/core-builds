...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.0+sha-e557313'));
 ...
 */
new checker.Version('20.1.0-next.0+sha-e557313');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-e557313` usually means that core is at head so it supports
