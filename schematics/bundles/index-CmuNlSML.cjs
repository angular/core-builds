...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-rc.0+sha-41955cf'));
 ...
 */
new checker.Version('20.1.0-rc.0+sha-41955cf');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-rc.0+sha-41955cf` usually means that core is at head so it supports
