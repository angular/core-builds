...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.0+sha-728ad2e'));
 ...
 */
new checker.Version('20.2.0-next.0+sha-728ad2e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.0+sha-728ad2e` usually means that core is at head so it supports
