...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.0+sha-4ac0147'));
 ...
 */
new checker.Version('20.2.0-next.0+sha-4ac0147');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.0+sha-4ac0147` usually means that core is at head so it supports
