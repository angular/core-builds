...
require('os');
var project_tsconfig_paths = require('./project_tsconfig_paths-DMBlMkrO.cjs');
var index = require('./index-CvTgjL1E.cjs');
require('path');
require('node:path');
var project_paths = require('./project_paths-dfPzffyY.cjs');
