...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.1+sha-f04a78a'));
 ...
 */
new project_tsconfig_paths.Version('20.3.1+sha-f04a78a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.1+sha-f04a78a` usually means that core is at head so it supports
