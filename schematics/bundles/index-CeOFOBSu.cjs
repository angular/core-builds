...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.2+sha-9d8c48d'));
 ...
 */
new checker.Version('20.2.0-next.2+sha-9d8c48d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.2+sha-9d8c48d` usually means that core is at head so it supports
