...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.2+sha-c66e9fe'));
 ...
 */
new checker.Version('20.2.0-next.2+sha-c66e9fe');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.2+sha-c66e9fe` usually means that core is at head so it supports
