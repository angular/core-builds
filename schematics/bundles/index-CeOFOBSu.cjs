...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.2+sha-24e6f4d'));
 ...
 */
new checker.Version('20.2.0-next.2+sha-24e6f4d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.2+sha-24e6f4d` usually means that core is at head so it supports
