...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.2+sha-b11e050'));
 ...
 */
new checker.Version('20.2.0-next.2+sha-b11e050');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.2+sha-b11e050` usually means that core is at head so it supports
