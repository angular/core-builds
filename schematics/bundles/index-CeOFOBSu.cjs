...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.2+sha-632eba5'));
 ...
 */
new checker.Version('20.2.0-next.2+sha-632eba5');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.2+sha-632eba5` usually means that core is at head so it supports
