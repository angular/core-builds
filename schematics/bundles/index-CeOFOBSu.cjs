...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.2+sha-dc49c2c'));
 ...
 */
new checker.Version('20.2.0-next.2+sha-dc49c2c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.2+sha-dc49c2c` usually means that core is at head so it supports
