...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.2+sha-c19d0ae'));
 ...
 */
new checker.Version('20.2.0-next.2+sha-c19d0ae');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.2+sha-c19d0ae` usually means that core is at head so it supports
