...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.2+sha-3a1a6cc'));
 ...
 */
new checker.Version('20.2.0-next.2+sha-3a1a6cc');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.2+sha-3a1a6cc` usually means that core is at head so it supports
