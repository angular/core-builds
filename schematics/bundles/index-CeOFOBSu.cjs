...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.2+sha-3b759db'));
 ...
 */
new checker.Version('20.2.0-next.2+sha-3b759db');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.2+sha-3b759db` usually means that core is at head so it supports
