...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.2+sha-63a6b5a'));
 ...
 */
new checker.Version('20.2.0-next.2+sha-63a6b5a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.2+sha-63a6b5a` usually means that core is at head so it supports
