...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.15+sha-4755bbd'));
 ...
 */
new project_tsconfig_paths.Version('20.3.15+sha-4755bbd');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.15+sha-4755bbd` usually means that core is at head so it supports
