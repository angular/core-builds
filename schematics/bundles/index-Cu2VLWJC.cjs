...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.14+sha-d1ca8ae'));
 ...
 */
new project_tsconfig_paths.Version('20.3.14+sha-d1ca8ae');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.14+sha-d1ca8ae` usually means that core is at head so it supports
