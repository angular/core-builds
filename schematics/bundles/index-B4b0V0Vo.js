...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.6+sha-d39e09d'));
 ...
 */
new checker.Version('19.2.6+sha-d39e09d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.6+sha-d39e09d` usually means that core is at head so it supports
