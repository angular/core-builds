...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.6+sha-b210d3c'));
 ...
 */
new checker.Version('19.2.6+sha-b210d3c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.6+sha-b210d3c` usually means that core is at head so it supports
