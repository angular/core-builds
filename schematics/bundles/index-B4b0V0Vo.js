...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.6+sha-b144126'));
 ...
 */
new checker.Version('19.2.6+sha-b144126');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.6+sha-b144126` usually means that core is at head so it supports
