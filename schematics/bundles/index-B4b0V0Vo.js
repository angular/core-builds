...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.6+sha-54f9269'));
 ...
 */
new checker.Version('19.2.6+sha-54f9269');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.6+sha-54f9269` usually means that core is at head so it supports
