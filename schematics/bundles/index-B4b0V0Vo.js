...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.6+sha-77c6041'));
 ...
 */
new checker.Version('19.2.6+sha-77c6041');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.6+sha-77c6041` usually means that core is at head so it supports
