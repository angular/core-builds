...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.0.0-next.9+sha-6530c5e'));
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.0.0-next.9+sha-6530c5e` usually means that core is at head so it supports
