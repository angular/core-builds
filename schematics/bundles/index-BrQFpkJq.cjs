...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.2.0-rc.0+sha-a92dea5'));
 ...
 */
new project_tsconfig_paths.Version('20.2.0-rc.0+sha-a92dea5');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-rc.0+sha-a92dea5` usually means that core is at head so it supports
