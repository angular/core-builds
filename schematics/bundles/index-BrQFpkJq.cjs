...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.2.0-next.6+sha-6a11846'));
 ...
 */
new project_tsconfig_paths.Version('20.2.0-next.6+sha-6a11846');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.6+sha-6a11846` usually means that core is at head so it supports
