...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.2.0-next.6+sha-3b214d2'));
 ...
 */
new project_tsconfig_paths.Version('20.2.0-next.6+sha-3b214d2');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.6+sha-3b214d2` usually means that core is at head so it supports
