...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.2.0-rc.0+sha-5180161'));
 ...
 */
new project_tsconfig_paths.Version('20.2.0-rc.0+sha-5180161');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-rc.0+sha-5180161` usually means that core is at head so it supports
