...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.3+sha-e7ff105'));
 ...
 */
new checker.Version('20.1.0-next.3+sha-e7ff105');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.3+sha-e7ff105` usually means that core is at head so it supports
