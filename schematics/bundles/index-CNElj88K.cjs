...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.3+sha-b25fb8a'));
 ...
 */
new checker.Version('20.1.0-next.3+sha-b25fb8a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.3+sha-b25fb8a` usually means that core is at head so it supports
