...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.3+sha-a4300a7'));
 ...
 */
new checker.Version('20.1.0-next.3+sha-a4300a7');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.3+sha-a4300a7` usually means that core is at head so it supports
