...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('21.0.0-next.7+sha-d73d9ac'));
 ...
 */
new project_tsconfig_paths.Version('21.0.0-next.7+sha-d73d9ac');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `21.0.0-next.7+sha-d73d9ac` usually means that core is at head so it supports
