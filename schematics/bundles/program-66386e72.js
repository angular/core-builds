...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.0-next.1+sha-951155e'));
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.0-next.1+sha-951155e` usually means that core is at head so it supports
