...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.1.0-next.2+sha-46f00f9'));
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.1.0-next.2+sha-46f00f9` usually means that core is at head so it supports
