...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.4+sha-8b5ba62'));
 ...
 */
new compiler.Version('20.0.0-next.4+sha-8b5ba62');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.4+sha-8b5ba62` usually means that core is at head so it supports
