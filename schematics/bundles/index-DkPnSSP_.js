...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.4+sha-a4bad8d'));
 ...
 */
new compiler.Version('20.0.0-next.4+sha-a4bad8d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.4+sha-a4bad8d` usually means that core is at head so it supports
