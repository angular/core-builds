...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.4+sha-4f5216e'));
 ...
 */
new compiler.Version('20.0.0-next.4+sha-4f5216e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.4+sha-4f5216e` usually means that core is at head so it supports
