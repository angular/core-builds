...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.4+sha-1fed7dc'));
 ...
 */
new compiler.Version('20.0.0-next.4+sha-1fed7dc');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.4+sha-1fed7dc` usually means that core is at head so it supports
