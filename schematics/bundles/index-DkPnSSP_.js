...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.4+sha-c5d841a'));
 ...
 */
new compiler.Version('20.0.0-next.4+sha-c5d841a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.4+sha-c5d841a` usually means that core is at head so it supports
