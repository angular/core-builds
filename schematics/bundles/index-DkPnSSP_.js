...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.4+sha-51c303a'));
 ...
 */
new compiler.Version('20.0.0-next.4+sha-51c303a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.4+sha-51c303a` usually means that core is at head so it supports
