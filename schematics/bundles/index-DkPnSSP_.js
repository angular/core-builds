...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.4+sha-b55f4de'));
 ...
 */
new compiler.Version('20.0.0-next.4+sha-b55f4de');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.4+sha-b55f4de` usually means that core is at head so it supports
