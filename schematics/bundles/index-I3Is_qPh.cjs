...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('21.0.0-next.0+sha-b7f2a8b'));
 ...
 */
new project_tsconfig_paths.Version('21.0.0-next.0+sha-b7f2a8b');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `21.0.0-next.0+sha-b7f2a8b` usually means that core is at head so it supports
