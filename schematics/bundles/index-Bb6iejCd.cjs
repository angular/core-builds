...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('21.0.0-next.5+sha-0e8e7ba'));
 ...
 */
new project_tsconfig_paths.Version('21.0.0-next.5+sha-0e8e7ba');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `21.0.0-next.5+sha-0e8e7ba` usually means that core is at head so it supports
