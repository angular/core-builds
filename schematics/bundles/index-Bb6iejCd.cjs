...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('21.0.0-next.5+sha-cd23761'));
 ...
 */
new project_tsconfig_paths.Version('21.0.0-next.5+sha-cd23761');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `21.0.0-next.5+sha-cd23761` usually means that core is at head so it supports
