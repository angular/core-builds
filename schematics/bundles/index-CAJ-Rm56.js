...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.7+sha-b557618'));
 ...
 */
new checker.Version('19.2.7+sha-b557618');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.7+sha-b557618` usually means that core is at head so it supports
