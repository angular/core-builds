...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.9+sha-a2eaea0'));
 ...
 */
new checker.Version('19.2.9+sha-a2eaea0');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.9+sha-a2eaea0` usually means that core is at head so it supports
