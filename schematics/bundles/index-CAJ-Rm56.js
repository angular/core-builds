...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.8+sha-aca1f45'));
 ...
 */
new checker.Version('19.2.8+sha-aca1f45');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.8+sha-aca1f45` usually means that core is at head so it supports
