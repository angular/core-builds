...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.8+sha-6b76bca'));
 ...
 */
new checker.Version('19.2.8+sha-6b76bca');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.8+sha-6b76bca` usually means that core is at head so it supports
