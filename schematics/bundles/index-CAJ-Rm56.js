...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.8+sha-5b0ec4a'));
 ...
 */
new checker.Version('19.2.8+sha-5b0ec4a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.8+sha-5b0ec4a` usually means that core is at head so it supports
