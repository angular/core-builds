...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.8+sha-9c4591c'));
 ...
 */
new checker.Version('19.2.8+sha-9c4591c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.8+sha-9c4591c` usually means that core is at head so it supports
