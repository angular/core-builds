...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.8+sha-0203e0b'));
 ...
 */
new checker.Version('19.2.8+sha-0203e0b');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.8+sha-0203e0b` usually means that core is at head so it supports
