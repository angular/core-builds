...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.8+sha-94b2a8c'));
 ...
 */
new checker.Version('19.2.8+sha-94b2a8c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.8+sha-94b2a8c` usually means that core is at head so it supports
