...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.0+sha-3a9a70d'));
 ...
 */
new checker.Version('20.1.0-next.0+sha-3a9a70d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-3a9a70d` usually means that core is at head so it supports
