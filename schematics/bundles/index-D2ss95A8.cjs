...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.1.0-next.0+sha-ad8931c'));
 ...
 */
new compiler.Version('20.1.0-next.0+sha-ad8931c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-ad8931c` usually means that core is at head so it supports
