...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.10+sha-6cd2df0'));
 ...
 */
new checker.Version('19.2.10+sha-6cd2df0');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.10+sha-6cd2df0` usually means that core is at head so it supports
