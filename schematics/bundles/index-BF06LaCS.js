...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.9+sha-ba5a3c0'));
 ...
 */
new checker.Version('19.2.9+sha-ba5a3c0');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.9+sha-ba5a3c0` usually means that core is at head so it supports
