...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.10+sha-e9c9cfd'));
 ...
 */
new checker.Version('19.2.10+sha-e9c9cfd');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.10+sha-e9c9cfd` usually means that core is at head so it supports
