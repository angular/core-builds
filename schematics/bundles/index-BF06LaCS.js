...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.10+sha-42f203e'));
 ...
 */
new checker.Version('19.2.10+sha-42f203e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.10+sha-42f203e` usually means that core is at head so it supports
