...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.10+sha-899cb4a'));
 ...
 */
new checker.Version('19.2.10+sha-899cb4a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.10+sha-899cb4a` usually means that core is at head so it supports
