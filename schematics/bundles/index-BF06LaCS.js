...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.9+sha-e11ded1'));
 ...
 */
new checker.Version('19.2.9+sha-e11ded1');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.9+sha-e11ded1` usually means that core is at head so it supports
