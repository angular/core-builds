...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.10+sha-dfd068d'));
 ...
 */
new checker.Version('19.2.10+sha-dfd068d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.10+sha-dfd068d` usually means that core is at head so it supports
