...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.10+sha-655954a'));
 ...
 */
new checker.Version('19.2.10+sha-655954a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.10+sha-655954a` usually means that core is at head so it supports
