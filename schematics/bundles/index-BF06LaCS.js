...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.10+sha-c92c34d'));
 ...
 */
new checker.Version('19.2.10+sha-c92c34d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.10+sha-c92c34d` usually means that core is at head so it supports
