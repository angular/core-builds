...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.10+sha-a4e3c12'));
 ...
 */
new checker.Version('19.2.10+sha-a4e3c12');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.10+sha-a4e3c12` usually means that core is at head so it supports
