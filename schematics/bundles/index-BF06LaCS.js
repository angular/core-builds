...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.9+sha-238441a'));
 ...
 */
new checker.Version('19.2.9+sha-238441a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.9+sha-238441a` usually means that core is at head so it supports
