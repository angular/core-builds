...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.10+sha-7820f4e'));
 ...
 */
new checker.Version('19.2.10+sha-7820f4e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.10+sha-7820f4e` usually means that core is at head so it supports
