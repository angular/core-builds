...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.9+sha-a4512ae'));
 ...
 */
new checker.Version('19.2.9+sha-a4512ae');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.9+sha-a4512ae` usually means that core is at head so it supports
