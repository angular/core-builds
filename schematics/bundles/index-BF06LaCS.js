...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.10+sha-223ca9f'));
 ...
 */
new checker.Version('19.2.10+sha-223ca9f');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.10+sha-223ca9f` usually means that core is at head so it supports
