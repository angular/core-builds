...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.10+sha-f2d6e59'));
 ...
 */
new checker.Version('19.2.10+sha-f2d6e59');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.10+sha-f2d6e59` usually means that core is at head so it supports
