...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.10+sha-7be6e5d'));
 ...
 */
new checker.Version('19.2.10+sha-7be6e5d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.10+sha-7be6e5d` usually means that core is at head so it supports
