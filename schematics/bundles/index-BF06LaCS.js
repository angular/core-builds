...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.9+sha-267bc0e'));
 ...
 */
new checker.Version('19.2.9+sha-267bc0e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.9+sha-267bc0e` usually means that core is at head so it supports
