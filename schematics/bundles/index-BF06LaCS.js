...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.10+sha-5ea32b5'));
 ...
 */
new checker.Version('19.2.10+sha-5ea32b5');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.10+sha-5ea32b5` usually means that core is at head so it supports
