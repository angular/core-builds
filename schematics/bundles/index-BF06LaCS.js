...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.9+sha-c6148bd'));
 ...
 */
new checker.Version('19.2.9+sha-c6148bd');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.9+sha-c6148bd` usually means that core is at head so it supports
