...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.10+sha-75e267d'));
 ...
 */
new checker.Version('19.2.10+sha-75e267d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.10+sha-75e267d` usually means that core is at head so it supports
