...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.10+sha-3b9440b'));
 ...
 */
new checker.Version('19.2.10+sha-3b9440b');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.10+sha-3b9440b` usually means that core is at head so it supports
