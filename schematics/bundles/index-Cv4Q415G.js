...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.5+sha-8744c9a'));
 ...
 */
new compiler.Version('20.0.0-next.5+sha-8744c9a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.5+sha-8744c9a` usually means that core is at head so it supports
