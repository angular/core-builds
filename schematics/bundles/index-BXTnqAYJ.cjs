...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.26+sha-4d62760'));
 ...
 */
new project_tsconfig_paths.Version('20.3.26+sha-4d62760');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.26+sha-4d62760` usually means that core is at head so it supports
