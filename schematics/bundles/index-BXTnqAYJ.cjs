...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.25+sha-baa093b'));
 ...
 */
new project_tsconfig_paths.Version('20.3.25+sha-baa093b');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.25+sha-baa093b` usually means that core is at head so it supports
