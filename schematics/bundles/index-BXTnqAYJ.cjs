...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.24+sha-d55c94a'));
 ...
 */
new project_tsconfig_paths.Version('20.3.24+sha-d55c94a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.24+sha-d55c94a` usually means that core is at head so it supports
