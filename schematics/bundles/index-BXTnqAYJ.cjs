...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.24+sha-9f443bc'));
 ...
 */
new project_tsconfig_paths.Version('20.3.24+sha-9f443bc');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.24+sha-9f443bc` usually means that core is at head so it supports
