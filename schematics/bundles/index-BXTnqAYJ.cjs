...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.25+sha-8eb7aea'));
 ...
 */
new project_tsconfig_paths.Version('20.3.25+sha-8eb7aea');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.25+sha-8eb7aea` usually means that core is at head so it supports
