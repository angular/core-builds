...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.23+sha-a1eeeb8'));
 ...
 */
new project_tsconfig_paths.Version('20.3.23+sha-a1eeeb8');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.23+sha-a1eeeb8` usually means that core is at head so it supports
