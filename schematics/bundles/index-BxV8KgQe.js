...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.7+sha-6c2fbad'));
 ...
 */
new compiler.Version('20.0.0-next.7+sha-6c2fbad');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.7+sha-6c2fbad` usually means that core is at head so it supports
