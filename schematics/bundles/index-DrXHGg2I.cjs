...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.1.0-next.0+sha-c77e198'));
 ...
 */
new compiler.Version('20.1.0-next.0+sha-c77e198');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-c77e198` usually means that core is at head so it supports
