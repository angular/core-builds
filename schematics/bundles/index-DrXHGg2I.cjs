...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.1.0-next.0+sha-9a9511a'));
 ...
 */
new compiler.Version('20.1.0-next.0+sha-9a9511a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-9a9511a` usually means that core is at head so it supports
