...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.1.0-next.0+sha-d19669c'));
 ...
 */
new compiler.Version('20.1.0-next.0+sha-d19669c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-d19669c` usually means that core is at head so it supports
