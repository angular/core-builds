...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.1.0-next.0+sha-77d2a7c'));
 ...
 */
new compiler.Version('20.1.0-next.0+sha-77d2a7c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-77d2a7c` usually means that core is at head so it supports
