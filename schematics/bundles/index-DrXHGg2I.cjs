...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.1.0-next.0+sha-62be7fa'));
 ...
 */
new compiler.Version('20.1.0-next.0+sha-62be7fa');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-62be7fa` usually means that core is at head so it supports
