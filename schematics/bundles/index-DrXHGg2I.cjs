...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.1.0-next.0+sha-2a290ab'));
 ...
 */
new compiler.Version('20.1.0-next.0+sha-2a290ab');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-2a290ab` usually means that core is at head so it supports
