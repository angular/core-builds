...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.1.0-next.0+sha-9b514b7'));
 ...
 */
new compiler.Version('20.1.0-next.0+sha-9b514b7');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-9b514b7` usually means that core is at head so it supports
