...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.1.0-next.0+sha-2f0ecfc'));
 ...
 */
new compiler.Version('20.1.0-next.0+sha-2f0ecfc');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-2f0ecfc` usually means that core is at head so it supports
