...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.6+sha-5fca07c'));
 ...
 */
new checker.Version('20.0.6+sha-5fca07c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.6+sha-5fca07c` usually means that core is at head so it supports
