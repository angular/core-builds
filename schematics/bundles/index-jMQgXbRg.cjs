...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.6+sha-e0e78fe'));
 ...
 */
new checker.Version('20.0.6+sha-e0e78fe');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.6+sha-e0e78fe` usually means that core is at head so it supports
