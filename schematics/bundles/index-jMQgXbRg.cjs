...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.6+sha-ade8ddd'));
 ...
 */
new checker.Version('20.0.6+sha-ade8ddd');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.6+sha-ade8ddd` usually means that core is at head so it supports
