...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.6+sha-5766ba6'));
 ...
 */
new checker.Version('20.0.6+sha-5766ba6');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.6+sha-5766ba6` usually means that core is at head so it supports
