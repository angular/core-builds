...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.6+sha-a7ce3cc'));
 ...
 */
new checker.Version('20.0.6+sha-a7ce3cc');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.6+sha-a7ce3cc` usually means that core is at head so it supports
