...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.6+sha-aa04a4a'));
 ...
 */
new checker.Version('20.0.6+sha-aa04a4a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.6+sha-aa04a4a` usually means that core is at head so it supports
