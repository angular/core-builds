...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.6+sha-5901a23'));
 ...
 */
new checker.Version('20.0.6+sha-5901a23');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.6+sha-5901a23` usually means that core is at head so it supports
