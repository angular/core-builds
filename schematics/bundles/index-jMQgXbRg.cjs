...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.5+sha-bf881cc'));
 ...
 */
new checker.Version('20.0.5+sha-bf881cc');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.5+sha-bf881cc` usually means that core is at head so it supports
