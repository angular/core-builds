...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.6+sha-434508f'));
 ...
 */
new checker.Version('20.0.6+sha-434508f');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.6+sha-434508f` usually means that core is at head so it supports
