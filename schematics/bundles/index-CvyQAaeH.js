...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.4+sha-6acce7c'));
 ...
 */
new compiler.Version('20.0.0-next.4+sha-6acce7c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.4+sha-6acce7c` usually means that core is at head so it supports
