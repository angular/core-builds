...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.4+sha-4f86f3f'));
 ...
 */
new compiler.Version('20.0.0-next.4+sha-4f86f3f');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.4+sha-4f86f3f` usually means that core is at head so it supports
