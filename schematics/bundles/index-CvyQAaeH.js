...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.4+sha-84ba1ad'));
 ...
 */
new compiler.Version('20.0.0-next.4+sha-84ba1ad');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.4+sha-84ba1ad` usually means that core is at head so it supports
