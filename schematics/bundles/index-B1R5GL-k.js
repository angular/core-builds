...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.8+sha-9a07707'));
 ...
 */
new compiler.Version('20.0.0-next.8+sha-9a07707');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.8+sha-9a07707` usually means that core is at head so it supports
