...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.0+sha-4a23f6e'));
 ...
 */
new project_tsconfig_paths.Version('20.3.0+sha-4a23f6e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.0+sha-4a23f6e` usually means that core is at head so it supports
