...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.0+sha-8cd2d8b'));
 ...
 */
new project_tsconfig_paths.Version('20.3.0+sha-8cd2d8b');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.0+sha-8cd2d8b` usually means that core is at head so it supports
