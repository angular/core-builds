...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.0+sha-c80d9ba'));
 ...
 */
new project_tsconfig_paths.Version('20.3.0+sha-c80d9ba');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.0+sha-c80d9ba` usually means that core is at head so it supports
