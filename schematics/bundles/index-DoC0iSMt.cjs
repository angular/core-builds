...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.0+sha-c67dbda'));
 ...
 */
new checker.Version('20.1.0-next.0+sha-c67dbda');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-c67dbda` usually means that core is at head so it supports
