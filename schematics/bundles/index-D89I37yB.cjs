...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.1+sha-e74266b'));
 ...
 */
new compiler.Version('20.0.0-rc.1+sha-e74266b');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.1+sha-e74266b` usually means that core is at head so it supports
