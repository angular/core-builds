...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.1+sha-47f4a8e'));
 ...
 */
new compiler.Version('20.0.0-rc.1+sha-47f4a8e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.1+sha-47f4a8e` usually means that core is at head so it supports
