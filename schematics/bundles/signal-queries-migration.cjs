...
require('os');
var index$1 = require('./index-B0Y9T7t-.cjs');
require('path');
require('node:path');
var project_paths = require('./project_paths-DD8D80ol.cjs');
var apply_import_manager = require('./apply_import_manager-K89F15h7.cjs');
var migrate_ts_type_references = require('./migrate_ts_type_references-ButP04QZ.cjs');
var assert = require('assert');
var index = require('./index-Dq-v6Syz.cjs');
