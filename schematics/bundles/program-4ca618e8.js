...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.0.0-next.10+sha-9544930'));
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.0.0-next.10+sha-9544930` usually means that core is at head so it supports
