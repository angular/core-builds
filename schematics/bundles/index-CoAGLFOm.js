...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.6+sha-2021f64'));
 ...
 */
new compiler.Version('20.0.0-next.6+sha-2021f64');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.6+sha-2021f64` usually means that core is at head so it supports
