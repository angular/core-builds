...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.6+sha-7b8c2fa'));
 ...
 */
new compiler.Version('20.0.0-next.6+sha-7b8c2fa');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.6+sha-7b8c2fa` usually means that core is at head so it supports
