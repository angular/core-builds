...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.6+sha-cda922d'));
 ...
 */
new compiler.Version('20.0.0-next.6+sha-cda922d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.6+sha-cda922d` usually means that core is at head so it supports
