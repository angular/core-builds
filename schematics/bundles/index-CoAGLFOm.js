...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.6+sha-1522e6c'));
 ...
 */
new compiler.Version('20.0.0-next.6+sha-1522e6c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.6+sha-1522e6c` usually means that core is at head so it supports
