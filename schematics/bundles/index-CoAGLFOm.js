...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.6+sha-11d441f'));
 ...
 */
new compiler.Version('20.0.0-next.6+sha-11d441f');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.6+sha-11d441f` usually means that core is at head so it supports
