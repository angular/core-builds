...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.4+sha-11b006e'));
 ...
 */
new project_tsconfig_paths.Version('20.3.4+sha-11b006e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.4+sha-11b006e` usually means that core is at head so it supports
