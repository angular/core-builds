...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.1.0-next.0+sha-b77042a'));
 ...
 */
new compiler.Version('20.1.0-next.0+sha-b77042a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-b77042a` usually means that core is at head so it supports
