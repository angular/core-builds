...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.2+sha-8cf95ce'));
 ...
 */
new project_tsconfig_paths.Version('20.3.2+sha-8cf95ce');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.2+sha-8cf95ce` usually means that core is at head so it supports
