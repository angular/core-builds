...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.1.0-next.0+sha-a07413a'));
 ...
 */
new compiler.Version('20.1.0-next.0+sha-a07413a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-a07413a` usually means that core is at head so it supports
