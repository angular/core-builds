...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.11+sha-6f6e91d'));
 ...
 */
new checker.Version('19.2.11+sha-6f6e91d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.11+sha-6f6e91d` usually means that core is at head so it supports
