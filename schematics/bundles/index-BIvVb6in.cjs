...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.12+sha-5f1bd07'));
 ...
 */
new checker.Version('19.2.12+sha-5f1bd07');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.12+sha-5f1bd07` usually means that core is at head so it supports
