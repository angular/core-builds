...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.12+sha-d4d4be8'));
 ...
 */
new checker.Version('19.2.12+sha-d4d4be8');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.12+sha-d4d4be8` usually means that core is at head so it supports
