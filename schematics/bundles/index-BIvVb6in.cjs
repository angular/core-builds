...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.12+sha-a6d5479'));
 ...
 */
new checker.Version('19.2.12+sha-a6d5479');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.12+sha-a6d5479` usually means that core is at head so it supports
