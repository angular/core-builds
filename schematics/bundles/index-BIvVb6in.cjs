...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.12+sha-2f5912e'));
 ...
 */
new checker.Version('19.2.12+sha-2f5912e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.12+sha-2f5912e` usually means that core is at head so it supports
