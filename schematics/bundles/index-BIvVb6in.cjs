...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.11+sha-b6d7b4b'));
 ...
 */
new checker.Version('19.2.11+sha-b6d7b4b');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.11+sha-b6d7b4b` usually means that core is at head so it supports
