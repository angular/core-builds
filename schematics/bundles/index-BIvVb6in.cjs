...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.11+sha-fc2483e'));
 ...
 */
new checker.Version('19.2.11+sha-fc2483e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.11+sha-fc2483e` usually means that core is at head so it supports
