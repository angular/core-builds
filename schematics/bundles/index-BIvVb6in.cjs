...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.12+sha-b15bddf'));
 ...
 */
new checker.Version('19.2.12+sha-b15bddf');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.12+sha-b15bddf` usually means that core is at head so it supports
