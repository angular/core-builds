...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.0+sha-b9141da'));
 ...
 */
new checker.Version('20.1.0-next.0+sha-b9141da');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-b9141da` usually means that core is at head so it supports
