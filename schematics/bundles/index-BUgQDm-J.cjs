...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.1+sha-2e0c98b'));
 ...
 */
new checker.Version('20.1.0-next.1+sha-2e0c98b');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.1+sha-2e0c98b` usually means that core is at head so it supports
