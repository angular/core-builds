...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.2+sha-a7e4b3e'));
 ...
 */
new checker.Version('20.1.0-next.2+sha-a7e4b3e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.2+sha-a7e4b3e` usually means that core is at head so it supports
