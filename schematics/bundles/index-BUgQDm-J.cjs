...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.0+sha-9cf12b0'));
 ...
 */
new checker.Version('20.1.0-next.0+sha-9cf12b0');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-9cf12b0` usually means that core is at head so it supports
