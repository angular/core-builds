...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.1+sha-2e3925a'));
 ...
 */
new checker.Version('20.1.0-next.1+sha-2e3925a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.1+sha-2e3925a` usually means that core is at head so it supports
