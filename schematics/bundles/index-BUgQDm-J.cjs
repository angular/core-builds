...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.1+sha-132fd3c'));
 ...
 */
new checker.Version('20.1.0-next.1+sha-132fd3c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.1+sha-132fd3c` usually means that core is at head so it supports
