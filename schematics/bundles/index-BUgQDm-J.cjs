...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.1+sha-8424b3b'));
 ...
 */
new checker.Version('20.1.0-next.1+sha-8424b3b');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.1+sha-8424b3b` usually means that core is at head so it supports
