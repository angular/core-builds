...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.0+sha-0bd7c7d'));
 ...
 */
new checker.Version('20.1.0-next.0+sha-0bd7c7d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-0bd7c7d` usually means that core is at head so it supports
