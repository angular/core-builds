...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.1+sha-5f6e336'));
 ...
 */
new checker.Version('20.1.0-next.1+sha-5f6e336');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.1+sha-5f6e336` usually means that core is at head so it supports
