...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.1+sha-4d9e50e'));
 ...
 */
new checker.Version('20.1.0-next.1+sha-4d9e50e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.1+sha-4d9e50e` usually means that core is at head so it supports
