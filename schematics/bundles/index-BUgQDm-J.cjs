...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.0+sha-9a81a0f'));
 ...
 */
new checker.Version('20.1.0-next.0+sha-9a81a0f');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-9a81a0f` usually means that core is at head so it supports
