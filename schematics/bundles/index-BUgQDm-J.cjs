...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.1+sha-be2747e'));
 ...
 */
new checker.Version('20.1.0-next.1+sha-be2747e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.1+sha-be2747e` usually means that core is at head so it supports
