...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.2+sha-085e29f'));
 ...
 */
new checker.Version('20.1.0-next.2+sha-085e29f');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.2+sha-085e29f` usually means that core is at head so it supports
