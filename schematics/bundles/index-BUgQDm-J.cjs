...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.0+sha-4f0221e'));
 ...
 */
new checker.Version('20.1.0-next.0+sha-4f0221e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-4f0221e` usually means that core is at head so it supports
