...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.0.0-rc.2+sha-df210a4'));
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.0.0-rc.2+sha-df210a4` usually means that core is at head so it supports
