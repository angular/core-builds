...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.1.0-next.0+sha-55c3cd3'));
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.1.0-next.0+sha-55c3cd3` usually means that core is at head so it supports
