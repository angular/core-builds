...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.8+sha-b7d3f3d'));
 ...
 */
new compiler.Version('20.0.0-next.8+sha-b7d3f3d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.8+sha-b7d3f3d` usually means that core is at head so it supports
