...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.0+sha-ed9a1d4'));
 ...
 */
new compiler.Version('20.0.0-rc.0+sha-ed9a1d4');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.0+sha-ed9a1d4` usually means that core is at head so it supports
