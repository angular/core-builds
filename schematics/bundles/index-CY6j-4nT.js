...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.0+sha-c1b9d3e'));
 ...
 */
new compiler.Version('20.0.0-rc.0+sha-c1b9d3e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.0+sha-c1b9d3e` usually means that core is at head so it supports
