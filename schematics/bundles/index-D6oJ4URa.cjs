...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.2.2+sha-cd748aa'));
 ...
 */
new project_tsconfig_paths.Version('20.2.2+sha-cd748aa');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.2+sha-cd748aa` usually means that core is at head so it supports
