...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.2.2+sha-421edfe'));
 ...
 */
new project_tsconfig_paths.Version('20.2.2+sha-421edfe');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.2+sha-421edfe` usually means that core is at head so it supports
