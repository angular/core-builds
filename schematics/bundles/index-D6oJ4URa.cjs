...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.2.1+sha-23d1ace'));
 ...
 */
new project_tsconfig_paths.Version('20.2.1+sha-23d1ace');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.1+sha-23d1ace` usually means that core is at head so it supports
