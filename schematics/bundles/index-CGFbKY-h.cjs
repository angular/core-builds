...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.1+sha-7eb9fcd'));
 ...
 */
new checker.Version('20.2.0-next.1+sha-7eb9fcd');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.1+sha-7eb9fcd` usually means that core is at head so it supports
