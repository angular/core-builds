...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.1+sha-d0cf8fc'));
 ...
 */
new checker.Version('20.2.0-next.1+sha-d0cf8fc');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.1+sha-d0cf8fc` usually means that core is at head so it supports
