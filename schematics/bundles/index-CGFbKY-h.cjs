...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.1+sha-23d5877'));
 ...
 */
new checker.Version('20.2.0-next.1+sha-23d5877');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.1+sha-23d5877` usually means that core is at head so it supports
