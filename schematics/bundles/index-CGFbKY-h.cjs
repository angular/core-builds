...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.1+sha-a6b2d7d'));
 ...
 */
new checker.Version('20.2.0-next.1+sha-a6b2d7d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.1+sha-a6b2d7d` usually means that core is at head so it supports
