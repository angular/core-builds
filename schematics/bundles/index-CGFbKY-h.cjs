...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.1+sha-6780d16'));
 ...
 */
new checker.Version('20.2.0-next.1+sha-6780d16');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.1+sha-6780d16` usually means that core is at head so it supports
