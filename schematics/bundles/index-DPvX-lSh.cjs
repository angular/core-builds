...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0+sha-55306bd'));
 ...
 */
new compiler.Version('20.0.0+sha-55306bd');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0+sha-55306bd` usually means that core is at head so it supports
