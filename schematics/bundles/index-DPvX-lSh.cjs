...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0+sha-bf7816e'));
 ...
 */
new compiler.Version('20.0.0+sha-bf7816e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0+sha-bf7816e` usually means that core is at head so it supports
