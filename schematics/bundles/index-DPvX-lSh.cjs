...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0+sha-0f13d90'));
 ...
 */
new compiler.Version('20.0.0+sha-0f13d90');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0+sha-0f13d90` usually means that core is at head so it supports
