...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0+sha-f7d33ee'));
 ...
 */
new compiler.Version('20.0.0+sha-f7d33ee');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0+sha-f7d33ee` usually means that core is at head so it supports
