...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.2+sha-925a41c'));
 ...
 */
new compiler.Version('20.0.0-rc.2+sha-925a41c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.2+sha-925a41c` usually means that core is at head so it supports
