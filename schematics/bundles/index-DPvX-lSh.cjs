...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.2+sha-2f1f6ee'));
 ...
 */
new compiler.Version('20.0.0-rc.2+sha-2f1f6ee');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.2+sha-2f1f6ee` usually means that core is at head so it supports
