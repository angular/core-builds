...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0+sha-1035240'));
 ...
 */
new compiler.Version('20.0.0+sha-1035240');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0+sha-1035240` usually means that core is at head so it supports
