...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0+sha-bc72d7a'));
 ...
 */
new compiler.Version('20.0.0+sha-bc72d7a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0+sha-bc72d7a` usually means that core is at head so it supports
