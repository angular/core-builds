...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0+sha-e538862'));
 ...
 */
new compiler.Version('20.0.0+sha-e538862');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0+sha-e538862` usually means that core is at head so it supports
