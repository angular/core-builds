...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.3+sha-0502cf2'));
 ...
 */
new compiler.Version('20.0.0-rc.3+sha-0502cf2');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.3+sha-0502cf2` usually means that core is at head so it supports
