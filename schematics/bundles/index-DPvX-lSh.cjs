...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0+sha-6113fae'));
 ...
 */
new compiler.Version('20.0.0+sha-6113fae');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0+sha-6113fae` usually means that core is at head so it supports
