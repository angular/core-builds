...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.2+sha-cc5a393'));
 ...
 */
new compiler.Version('20.0.0-rc.2+sha-cc5a393');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.2+sha-cc5a393` usually means that core is at head so it supports
