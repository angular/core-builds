...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0+sha-a0d599e'));
 ...
 */
new compiler.Version('20.0.0+sha-a0d599e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0+sha-a0d599e` usually means that core is at head so it supports
