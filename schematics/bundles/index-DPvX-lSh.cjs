...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0+sha-2c8de90'));
 ...
 */
new compiler.Version('20.0.0+sha-2c8de90');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0+sha-2c8de90` usually means that core is at head so it supports
