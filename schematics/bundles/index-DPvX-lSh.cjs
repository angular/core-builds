...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0+sha-aed8a77'));
 ...
 */
new compiler.Version('20.0.0+sha-aed8a77');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0+sha-aed8a77` usually means that core is at head so it supports
