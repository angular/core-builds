...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0+sha-40e2b5b'));
 ...
 */
new compiler.Version('20.0.0+sha-40e2b5b');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0+sha-40e2b5b` usually means that core is at head so it supports
