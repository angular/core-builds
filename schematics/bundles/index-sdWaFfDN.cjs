...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.1.0-next.0+sha-6bf6dbc'));
 ...
 */
new compiler.Version('20.1.0-next.0+sha-6bf6dbc');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-6bf6dbc` usually means that core is at head so it supports
