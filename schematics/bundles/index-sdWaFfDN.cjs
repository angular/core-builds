...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.1.0-next.0+sha-fa5d7ff'));
 ...
 */
new compiler.Version('20.1.0-next.0+sha-fa5d7ff');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-fa5d7ff` usually means that core is at head so it supports
