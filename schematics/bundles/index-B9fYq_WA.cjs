...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.0+sha-b62cadb'));
 ...
 */
new project_tsconfig_paths.Version('20.3.0+sha-b62cadb');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.0+sha-b62cadb` usually means that core is at head so it supports
