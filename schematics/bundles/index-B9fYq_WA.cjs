...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.0+sha-5f5828f'));
 ...
 */
new project_tsconfig_paths.Version('20.3.0+sha-5f5828f');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.0+sha-5f5828f` usually means that core is at head so it supports
