...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.0+sha-50b3e9f'));
 ...
 */
new project_tsconfig_paths.Version('20.3.0+sha-50b3e9f');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.0+sha-50b3e9f` usually means that core is at head so it supports
