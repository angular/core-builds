...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.1+sha-32ce149'));
 ...
 */
new checker.Version('20.0.1+sha-32ce149');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.1+sha-32ce149` usually means that core is at head so it supports
