...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.3+sha-7636048'));
 ...
 */
new checker.Version('20.0.3+sha-7636048');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.3+sha-7636048` usually means that core is at head so it supports
