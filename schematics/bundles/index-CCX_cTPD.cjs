...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.0+sha-9e850c8'));
 ...
 */
new checker.Version('20.0.0+sha-9e850c8');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0+sha-9e850c8` usually means that core is at head so it supports
