...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.3+sha-b40613f'));
 ...
 */
new checker.Version('20.0.3+sha-b40613f');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.3+sha-b40613f` usually means that core is at head so it supports
