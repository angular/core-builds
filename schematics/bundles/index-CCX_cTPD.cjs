...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.3+sha-deaa292'));
 ...
 */
new checker.Version('20.0.3+sha-deaa292');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.3+sha-deaa292` usually means that core is at head so it supports
