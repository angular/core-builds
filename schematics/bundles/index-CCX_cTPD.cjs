...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.3+sha-f201df9'));
 ...
 */
new checker.Version('20.0.3+sha-f201df9');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.3+sha-f201df9` usually means that core is at head so it supports
