...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.2+sha-ca478a2'));
 ...
 */
new checker.Version('20.0.2+sha-ca478a2');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.2+sha-ca478a2` usually means that core is at head so it supports
