...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.3+sha-4aa262b'));
 ...
 */
new checker.Version('20.0.3+sha-4aa262b');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.3+sha-4aa262b` usually means that core is at head so it supports
