...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.2+sha-9d6db41'));
 ...
 */
new checker.Version('20.0.2+sha-9d6db41');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.2+sha-9d6db41` usually means that core is at head so it supports
