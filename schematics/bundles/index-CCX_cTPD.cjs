...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.1+sha-bb6ec10'));
 ...
 */
new checker.Version('20.0.1+sha-bb6ec10');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.1+sha-bb6ec10` usually means that core is at head so it supports
