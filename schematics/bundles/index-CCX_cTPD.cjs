...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.3+sha-fb56d51'));
 ...
 */
new checker.Version('20.0.3+sha-fb56d51');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.3+sha-fb56d51` usually means that core is at head so it supports
