...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.1+sha-71017f2'));
 ...
 */
new checker.Version('20.0.1+sha-71017f2');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.1+sha-71017f2` usually means that core is at head so it supports
