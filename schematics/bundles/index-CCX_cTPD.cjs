...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.3+sha-f69ec36'));
 ...
 */
new checker.Version('20.0.3+sha-f69ec36');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.3+sha-f69ec36` usually means that core is at head so it supports
