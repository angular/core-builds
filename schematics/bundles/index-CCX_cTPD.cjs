...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.2+sha-a76f64b'));
 ...
 */
new checker.Version('20.0.2+sha-a76f64b');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.2+sha-a76f64b` usually means that core is at head so it supports
