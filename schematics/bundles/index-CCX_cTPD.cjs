...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.3+sha-e343cdf'));
 ...
 */
new checker.Version('20.0.3+sha-e343cdf');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.3+sha-e343cdf` usually means that core is at head so it supports
