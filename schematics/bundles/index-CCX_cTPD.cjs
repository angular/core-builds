...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.2+sha-eef6faf'));
 ...
 */
new checker.Version('20.0.2+sha-eef6faf');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.2+sha-eef6faf` usually means that core is at head so it supports
