...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.1+sha-9ae8027'));
 ...
 */
new checker.Version('20.0.1+sha-9ae8027');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.1+sha-9ae8027` usually means that core is at head so it supports
