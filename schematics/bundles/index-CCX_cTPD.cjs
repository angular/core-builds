...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.1+sha-fdcb14d'));
 ...
 */
new checker.Version('20.0.1+sha-fdcb14d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.1+sha-fdcb14d` usually means that core is at head so it supports
