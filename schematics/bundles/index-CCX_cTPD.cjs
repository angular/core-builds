...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.2+sha-229c6b4'));
 ...
 */
new checker.Version('20.0.2+sha-229c6b4');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.2+sha-229c6b4` usually means that core is at head so it supports
