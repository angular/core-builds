...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.3+sha-734c13a'));
 ...
 */
new checker.Version('20.0.3+sha-734c13a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.3+sha-734c13a` usually means that core is at head so it supports
