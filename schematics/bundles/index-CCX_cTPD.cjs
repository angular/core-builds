...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.3+sha-67f657e'));
 ...
 */
new checker.Version('20.0.3+sha-67f657e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.3+sha-67f657e` usually means that core is at head so it supports
