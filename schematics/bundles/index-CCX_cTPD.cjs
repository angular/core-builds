...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.2+sha-554b81e'));
 ...
 */
new checker.Version('20.0.2+sha-554b81e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.2+sha-554b81e` usually means that core is at head so it supports
