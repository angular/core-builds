...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.1+sha-a6a193f'));
 ...
 */
new checker.Version('20.0.1+sha-a6a193f');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.1+sha-a6a193f` usually means that core is at head so it supports
