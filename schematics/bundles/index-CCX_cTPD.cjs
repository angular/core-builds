...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.0+sha-3c64468'));
 ...
 */
new checker.Version('20.0.0+sha-3c64468');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0+sha-3c64468` usually means that core is at head so it supports
