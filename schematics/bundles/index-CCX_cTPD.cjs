...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.3+sha-2e1e9aa'));
 ...
 */
new checker.Version('20.0.3+sha-2e1e9aa');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.3+sha-2e1e9aa` usually means that core is at head so it supports
