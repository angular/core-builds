...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.0+sha-9a24a2b'));
 ...
 */
new checker.Version('20.0.0+sha-9a24a2b');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0+sha-9a24a2b` usually means that core is at head so it supports
