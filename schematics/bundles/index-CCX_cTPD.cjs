...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.0+sha-3710b12'));
 ...
 */
new checker.Version('20.0.0+sha-3710b12');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0+sha-3710b12` usually means that core is at head so it supports
