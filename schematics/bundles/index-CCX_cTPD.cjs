...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.1+sha-49e273a'));
 ...
 */
new checker.Version('20.0.1+sha-49e273a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.1+sha-49e273a` usually means that core is at head so it supports
