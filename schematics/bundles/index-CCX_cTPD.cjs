...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.2+sha-ff27f21'));
 ...
 */
new checker.Version('20.0.2+sha-ff27f21');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.2+sha-ff27f21` usually means that core is at head so it supports
