...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.1+sha-1e8158b'));
 ...
 */
new checker.Version('20.0.1+sha-1e8158b');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.1+sha-1e8158b` usually means that core is at head so it supports
