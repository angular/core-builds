...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.1+sha-f6841ea'));
 ...
 */
new checker.Version('20.0.1+sha-f6841ea');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.1+sha-f6841ea` usually means that core is at head so it supports
