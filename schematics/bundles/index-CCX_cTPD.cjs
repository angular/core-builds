...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.1+sha-6ae07ad'));
 ...
 */
new checker.Version('20.0.1+sha-6ae07ad');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.1+sha-6ae07ad` usually means that core is at head so it supports
