...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.3+sha-04e0d4f'));
 ...
 */
new checker.Version('20.0.3+sha-04e0d4f');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.3+sha-04e0d4f` usually means that core is at head so it supports
