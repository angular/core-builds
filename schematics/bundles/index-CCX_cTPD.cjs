...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.0+sha-bdf882c'));
 ...
 */
new checker.Version('20.0.0+sha-bdf882c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0+sha-bdf882c` usually means that core is at head so it supports
