...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.3+sha-30e4cfd'));
 ...
 */
new checker.Version('20.0.3+sha-30e4cfd');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.3+sha-30e4cfd` usually means that core is at head so it supports
