...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.3+sha-6412d4e'));
 ...
 */
new checker.Version('20.0.3+sha-6412d4e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.3+sha-6412d4e` usually means that core is at head so it supports
