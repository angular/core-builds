...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.2+sha-135c594'));
 ...
 */
new checker.Version('20.0.2+sha-135c594');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.2+sha-135c594` usually means that core is at head so it supports
