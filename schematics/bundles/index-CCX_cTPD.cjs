...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.4+sha-6a4fdba'));
 ...
 */
new checker.Version('20.0.4+sha-6a4fdba');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.4+sha-6a4fdba` usually means that core is at head so it supports
