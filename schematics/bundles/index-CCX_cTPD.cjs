...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.0+sha-b5d21b0'));
 ...
 */
new checker.Version('20.0.0+sha-b5d21b0');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0+sha-b5d21b0` usually means that core is at head so it supports
