...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.0+sha-5c31e7e'));
 ...
 */
new checker.Version('20.0.0+sha-5c31e7e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0+sha-5c31e7e` usually means that core is at head so it supports
