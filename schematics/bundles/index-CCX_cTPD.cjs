...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.3+sha-a6c5742'));
 ...
 */
new checker.Version('20.0.3+sha-a6c5742');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.3+sha-a6c5742` usually means that core is at head so it supports
