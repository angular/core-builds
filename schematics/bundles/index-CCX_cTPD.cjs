...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.3+sha-43ef2ea'));
 ...
 */
new checker.Version('20.0.3+sha-43ef2ea');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.3+sha-43ef2ea` usually means that core is at head so it supports
