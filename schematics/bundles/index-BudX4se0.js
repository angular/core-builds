...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.1.0-next.0+sha-83c22ec'));
 ...
 */
new compiler.Version('20.1.0-next.0+sha-83c22ec');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-83c22ec` usually means that core is at head so it supports
