...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.1.0-next.0+sha-5f1c08d'));
 ...
 */
new compiler.Version('20.1.0-next.0+sha-5f1c08d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-5f1c08d` usually means that core is at head so it supports
