...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.1.0-next.0+sha-adffb2e-with-local-changes'));
 ...
 */
new compiler.Version('20.1.0-next.0+sha-adffb2e-with-local-changes');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-adffb2e-with-local-changes` usually means that core is at head so it supports
