...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.1+sha-2e6c2ff'));
 ...
 */
new checker.Version('20.2.0-next.1+sha-2e6c2ff');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.1+sha-2e6c2ff` usually means that core is at head so it supports
