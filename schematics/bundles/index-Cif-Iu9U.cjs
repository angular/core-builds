...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.2.0-next.4+sha-d24d574'));
 ...
 */
new project_tsconfig_paths.Version('20.2.0-next.4+sha-d24d574');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.4+sha-d24d574` usually means that core is at head so it supports
