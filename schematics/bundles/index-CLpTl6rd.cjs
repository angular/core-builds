...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.2.4+sha-c7b84f5'));
 ...
 */
new project_tsconfig_paths.Version('20.2.4+sha-c7b84f5');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.4+sha-c7b84f5` usually means that core is at head so it supports
