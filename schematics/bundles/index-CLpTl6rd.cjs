...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.2.4+sha-35a1d5d'));
 ...
 */
new project_tsconfig_paths.Version('20.2.4+sha-35a1d5d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.4+sha-35a1d5d` usually means that core is at head so it supports
