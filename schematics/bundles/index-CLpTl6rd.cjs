...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.0-next.0+sha-d0f0c08'));
 ...
 */
new project_tsconfig_paths.Version('20.3.0-next.0+sha-d0f0c08');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.0-next.0+sha-d0f0c08` usually means that core is at head so it supports
