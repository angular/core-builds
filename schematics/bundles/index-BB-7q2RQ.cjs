...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.1+sha-92e03e1'));
 ...
 */
new checker.Version('20.2.0-next.1+sha-92e03e1');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.1+sha-92e03e1` usually means that core is at head so it supports
