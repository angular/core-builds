...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.7+sha-adac95c'));
 ...
 */
new checker.Version('19.2.7+sha-adac95c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.7+sha-adac95c` usually means that core is at head so it supports
