...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.7+sha-ea4a211'));
 ...
 */
new checker.Version('19.2.7+sha-ea4a211');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.7+sha-ea4a211` usually means that core is at head so it supports
