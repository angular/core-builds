...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.7+sha-9d08525'));
 ...
 */
new checker.Version('19.2.7+sha-9d08525');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.7+sha-9d08525` usually means that core is at head so it supports
