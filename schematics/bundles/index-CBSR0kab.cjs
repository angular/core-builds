...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.10+sha-8922cae'));
 ...
 */
new project_tsconfig_paths.Version('20.3.10+sha-8922cae');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.10+sha-8922cae` usually means that core is at head so it supports
