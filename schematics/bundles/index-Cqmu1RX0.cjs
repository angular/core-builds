...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.6+sha-e3f1c52'));
 ...
 */
new project_tsconfig_paths.Version('20.3.6+sha-e3f1c52');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.6+sha-e3f1c52` usually means that core is at head so it supports
