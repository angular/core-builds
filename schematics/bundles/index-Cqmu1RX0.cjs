...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.7+sha-adae565'));
 ...
 */
new project_tsconfig_paths.Version('20.3.7+sha-adae565');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.7+sha-adae565` usually means that core is at head so it supports
