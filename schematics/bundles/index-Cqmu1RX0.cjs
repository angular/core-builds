...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.6+sha-e568ddb'));
 ...
 */
new project_tsconfig_paths.Version('20.3.6+sha-e568ddb');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.6+sha-e568ddb` usually means that core is at head so it supports
