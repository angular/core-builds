...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.8+sha-77bc6ee'));
 ...
 */
new project_tsconfig_paths.Version('20.3.8+sha-77bc6ee');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.8+sha-77bc6ee` usually means that core is at head so it supports
