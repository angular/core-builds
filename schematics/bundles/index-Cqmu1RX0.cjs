...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.7+sha-9123e3d'));
 ...
 */
new project_tsconfig_paths.Version('20.3.7+sha-9123e3d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.7+sha-9123e3d` usually means that core is at head so it supports
