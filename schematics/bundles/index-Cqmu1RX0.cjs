...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.9+sha-a3b08ea'));
 ...
 */
new project_tsconfig_paths.Version('20.3.9+sha-a3b08ea');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.9+sha-a3b08ea` usually means that core is at head so it supports
