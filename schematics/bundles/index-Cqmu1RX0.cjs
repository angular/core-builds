...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.6+sha-acadefb'));
 ...
 */
new project_tsconfig_paths.Version('20.3.6+sha-acadefb');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.6+sha-acadefb` usually means that core is at head so it supports
