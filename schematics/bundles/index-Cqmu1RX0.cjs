...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.9+sha-a832b1c'));
 ...
 */
new project_tsconfig_paths.Version('20.3.9+sha-a832b1c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.9+sha-a832b1c` usually means that core is at head so it supports
