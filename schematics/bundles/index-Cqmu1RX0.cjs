...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.6+sha-4c89a26'));
 ...
 */
new project_tsconfig_paths.Version('20.3.6+sha-4c89a26');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.6+sha-4c89a26` usually means that core is at head so it supports
