...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.9+sha-debc41f'));
 ...
 */
new project_tsconfig_paths.Version('20.3.9+sha-debc41f');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.9+sha-debc41f` usually means that core is at head so it supports
