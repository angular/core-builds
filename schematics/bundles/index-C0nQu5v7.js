...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.1.0-next.0+sha-b4c383b'));
 ...
 */
new compiler.Version('20.1.0-next.0+sha-b4c383b');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-b4c383b` usually means that core is at head so it supports
