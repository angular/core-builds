...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.1.0-next.0+sha-dd25f3d'));
 ...
 */
new compiler.Version('20.1.0-next.0+sha-dd25f3d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-dd25f3d` usually means that core is at head so it supports
