...
require('os');
var project_tsconfig_paths = require('./project_tsconfig_paths-C7FaBtUi.cjs');
var index = require('./index-Cif-Iu9U.cjs');
require('path');
require('node:path');
var project_paths = require('./project_paths-CrK8-xST.cjs');
