...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.0+sha-e8c5603'));
 ...
 */
new checker.Version('20.2.0-next.0+sha-e8c5603');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.0+sha-e8c5603` usually means that core is at head so it supports
