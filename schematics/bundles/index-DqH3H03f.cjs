...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('21.0.0-next.2+sha-8ab078a'));
 ...
 */
new project_tsconfig_paths.Version('21.0.0-next.2+sha-8ab078a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `21.0.0-next.2+sha-8ab078a` usually means that core is at head so it supports
