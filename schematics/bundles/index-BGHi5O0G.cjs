...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.2+sha-c1a922a'));
 ...
 */
new project_tsconfig_paths.Version('20.3.2+sha-c1a922a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.2+sha-c1a922a` usually means that core is at head so it supports
