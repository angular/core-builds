...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.2+sha-d900dba'));
 ...
 */
new project_tsconfig_paths.Version('20.3.2+sha-d900dba');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.2+sha-d900dba` usually means that core is at head so it supports
