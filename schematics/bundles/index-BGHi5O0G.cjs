...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.2+sha-e6c0d7e'));
 ...
 */
new project_tsconfig_paths.Version('20.3.2+sha-e6c0d7e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.2+sha-e6c0d7e` usually means that core is at head so it supports
