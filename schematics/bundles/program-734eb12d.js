...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.0.0-next.6+sha-4e890cc'));
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.0.0-next.6+sha-4e890cc` usually means that core is at head so it supports
