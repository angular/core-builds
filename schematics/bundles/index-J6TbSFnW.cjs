...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.1.6+sha-bb5a69c'));
 ...
 */
new project_tsconfig_paths.Version('20.1.6+sha-bb5a69c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.6+sha-bb5a69c` usually means that core is at head so it supports
