...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.1.6+sha-d9e3790'));
 ...
 */
new project_tsconfig_paths.Version('20.1.6+sha-d9e3790');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.6+sha-d9e3790` usually means that core is at head so it supports
