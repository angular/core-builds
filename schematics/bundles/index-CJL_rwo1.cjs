...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.1.6+sha-5e9893d'));
 ...
 */
new project_tsconfig_paths.Version('20.1.6+sha-5e9893d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.6+sha-5e9893d` usually means that core is at head so it supports
