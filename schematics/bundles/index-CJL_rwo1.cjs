...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.1.6+sha-2c12f2a'));
 ...
 */
new project_tsconfig_paths.Version('20.1.6+sha-2c12f2a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.6+sha-2c12f2a` usually means that core is at head so it supports
