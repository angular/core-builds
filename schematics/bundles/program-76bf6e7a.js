...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.0-next.0+sha-6f6d9f1'));
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.0+sha-6f6d9f1` usually means that core is at head so it supports
