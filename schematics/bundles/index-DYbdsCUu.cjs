...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.1+sha-a4a4f7f'));
 ...
 */
new checker.Version('20.2.0-next.1+sha-a4a4f7f');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.1+sha-a4a4f7f` usually means that core is at head so it supports
