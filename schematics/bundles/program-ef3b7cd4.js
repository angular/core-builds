...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.0.0-next.9+sha-9224f9b'));
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.0.0-next.9+sha-9224f9b` usually means that core is at head so it supports
