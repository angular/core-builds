...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.0-next.0+sha-04c2447'));
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.0-next.0+sha-04c2447` usually means that core is at head so it supports
