...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.0-next.3+sha-6d3849f'));
 ...
 */
new checker.Version('20.0.0-next.3+sha-6d3849f');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.3+sha-6d3849f` usually means that core is at head so it supports
