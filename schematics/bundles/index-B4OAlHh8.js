...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.0-next.3+sha-13d1c8a'));
 ...
 */
new checker.Version('20.0.0-next.3+sha-13d1c8a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.3+sha-13d1c8a` usually means that core is at head so it supports
