...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.2.3+sha-f4a2d0a'));
 ...
 */
new project_tsconfig_paths.Version('20.2.3+sha-f4a2d0a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.3+sha-f4a2d0a` usually means that core is at head so it supports
