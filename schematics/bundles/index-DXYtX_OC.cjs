...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.2.4+sha-08d363e'));
 ...
 */
new project_tsconfig_paths.Version('20.2.4+sha-08d363e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.4+sha-08d363e` usually means that core is at head so it supports
