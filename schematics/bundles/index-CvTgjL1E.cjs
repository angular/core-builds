...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.1+sha-d0c7ea8'));
 ...
 */
new project_tsconfig_paths.Version('20.3.1+sha-d0c7ea8');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.1+sha-d0c7ea8` usually means that core is at head so it supports
