...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.11+sha-c78e75d'));
 ...
 */
new checker.Version('19.2.11+sha-c78e75d');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.11+sha-c78e75d` usually means that core is at head so it supports
