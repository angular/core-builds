...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.11+sha-21e5f07'));
 ...
 */
new checker.Version('19.2.11+sha-21e5f07');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.11+sha-21e5f07` usually means that core is at head so it supports
