...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.21+sha-3d135ce'));
 ...
 */
new project_tsconfig_paths.Version('20.3.21+sha-3d135ce');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.21+sha-3d135ce` usually means that core is at head so it supports
