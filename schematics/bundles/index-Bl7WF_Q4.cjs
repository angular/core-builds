...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.1.0-next.0+sha-a70f03a'));
 ...
 */
new compiler.Version('20.1.0-next.0+sha-a70f03a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.0+sha-a70f03a` usually means that core is at head so it supports
