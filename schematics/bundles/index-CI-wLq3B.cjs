...
var checker = require('./checker-DSY0zMZi.cjs');
...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.6+sha-2c18043'));
 ...
 */
new checker.Version('20.0.6+sha-2c18043');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.6+sha-2c18043` usually means that core is at head so it supports
