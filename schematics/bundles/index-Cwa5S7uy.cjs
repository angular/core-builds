...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.3+sha-5aaf726'));
 ...
 */
new checker.Version('20.1.3+sha-5aaf726');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.3+sha-5aaf726` usually means that core is at head so it supports
