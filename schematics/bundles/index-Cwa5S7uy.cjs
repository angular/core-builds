...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.3+sha-aa46ad2'));
 ...
 */
new checker.Version('20.1.3+sha-aa46ad2');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.3+sha-aa46ad2` usually means that core is at head so it supports
