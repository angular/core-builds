...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.3+sha-0b9f53a'));
 ...
 */
new checker.Version('20.1.3+sha-0b9f53a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.3+sha-0b9f53a` usually means that core is at head so it supports
