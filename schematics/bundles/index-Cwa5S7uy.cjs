...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.3+sha-2b16824'));
 ...
 */
new checker.Version('20.1.3+sha-2b16824');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.3+sha-2b16824` usually means that core is at head so it supports
