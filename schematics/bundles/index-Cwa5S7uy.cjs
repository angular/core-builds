...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.3+sha-c9fb4e3'));
 ...
 */
new checker.Version('20.1.3+sha-c9fb4e3');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.3+sha-c9fb4e3` usually means that core is at head so it supports
