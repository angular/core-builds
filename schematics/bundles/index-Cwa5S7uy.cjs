...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.3+sha-cd256ef'));
 ...
 */
new checker.Version('20.1.3+sha-cd256ef');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.3+sha-cd256ef` usually means that core is at head so it supports
