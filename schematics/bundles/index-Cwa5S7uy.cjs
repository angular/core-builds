...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.3+sha-187cb9c'));
 ...
 */
new checker.Version('20.1.3+sha-187cb9c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.3+sha-187cb9c` usually means that core is at head so it supports
