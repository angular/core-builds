...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.3+sha-dce0609'));
 ...
 */
new checker.Version('20.1.3+sha-dce0609');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.3+sha-dce0609` usually means that core is at head so it supports
