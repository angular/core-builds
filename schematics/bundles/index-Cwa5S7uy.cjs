...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.3+sha-ea1afec'));
 ...
 */
new checker.Version('20.1.3+sha-ea1afec');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.3+sha-ea1afec` usually means that core is at head so it supports
