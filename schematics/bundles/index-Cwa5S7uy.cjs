...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.3+sha-82862de'));
 ...
 */
new checker.Version('20.1.3+sha-82862de');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.3+sha-82862de` usually means that core is at head so it supports
