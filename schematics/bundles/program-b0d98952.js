...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.2.0-next.0+sha-ec8c288'));
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.2.0-next.0+sha-ec8c288` usually means that core is at head so it supports
