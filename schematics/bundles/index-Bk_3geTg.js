...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.8+sha-8d82a39'));
 ...
 */
new compiler.Version('20.0.0-next.8+sha-8d82a39');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.8+sha-8d82a39` usually means that core is at head so it supports
