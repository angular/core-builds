...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.8+sha-829379e'));
 ...
 */
new compiler.Version('20.0.0-next.8+sha-829379e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.8+sha-829379e` usually means that core is at head so it supports
