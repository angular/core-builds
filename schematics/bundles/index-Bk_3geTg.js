...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.9+sha-f4d60ff'));
 ...
 */
new compiler.Version('20.0.0-next.9+sha-f4d60ff');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.9+sha-f4d60ff` usually means that core is at head so it supports
