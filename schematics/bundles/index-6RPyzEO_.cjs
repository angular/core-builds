...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.1.8+sha-9267c2f'));
 ...
 */
new project_tsconfig_paths.Version('20.1.8+sha-9267c2f');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.8+sha-9267c2f` usually means that core is at head so it supports
