...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.0-next.3+sha-f901a4c'));
 ...
 */
new checker.Version('20.0.0-next.3+sha-f901a4c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.3+sha-f901a4c` usually means that core is at head so it supports
