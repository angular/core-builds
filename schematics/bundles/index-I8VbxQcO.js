...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.0-next.3+sha-911ad40'));
 ...
 */
new checker.Version('20.0.0-next.3+sha-911ad40');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.3+sha-911ad40` usually means that core is at head so it supports
