...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.1+sha-2a15d78'));
 ...
 */
new project_tsconfig_paths.Version('20.3.1+sha-2a15d78');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.1+sha-2a15d78` usually means that core is at head so it supports
