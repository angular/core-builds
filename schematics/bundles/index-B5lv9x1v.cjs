...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.1+sha-dbb8dbc'));
 ...
 */
new project_tsconfig_paths.Version('20.3.1+sha-dbb8dbc');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.1+sha-dbb8dbc` usually means that core is at head so it supports
