...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.1+sha-923c81c'));
 ...
 */
new project_tsconfig_paths.Version('20.3.1+sha-923c81c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.1+sha-923c81c` usually means that core is at head so it supports
