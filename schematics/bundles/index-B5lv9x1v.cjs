...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.1+sha-8858e3c'));
 ...
 */
new project_tsconfig_paths.Version('20.3.1+sha-8858e3c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.1+sha-8858e3c` usually means that core is at head so it supports
