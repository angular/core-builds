...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.1+sha-bc2cab7'));
 ...
 */
new compiler.Version('20.0.0-rc.1+sha-bc2cab7');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.1+sha-bc2cab7` usually means that core is at head so it supports
