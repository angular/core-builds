...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.1+sha-c0fb34b'));
 ...
 */
new compiler.Version('20.0.0-rc.1+sha-c0fb34b');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.1+sha-c0fb34b` usually means that core is at head so it supports
