...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.1+sha-f0e961c'));
 ...
 */
new compiler.Version('20.0.0-rc.1+sha-f0e961c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.1+sha-f0e961c` usually means that core is at head so it supports
