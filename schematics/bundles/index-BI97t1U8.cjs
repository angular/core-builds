...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('21.0.0-next.4+sha-5cb1bbb'));
 ...
 */
new project_tsconfig_paths.Version('21.0.0-next.4+sha-5cb1bbb');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `21.0.0-next.4+sha-5cb1bbb` usually means that core is at head so it supports
