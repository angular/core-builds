...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-next.5+sha-0b69b61'));
 ...
 */
new compiler.Version('20.0.0-next.5+sha-0b69b61');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.5+sha-0b69b61` usually means that core is at head so it supports
