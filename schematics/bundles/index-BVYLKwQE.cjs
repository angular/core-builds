...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-rc.0+sha-f5a1020'));
 ...
 */
new checker.Version('20.1.0-rc.0+sha-f5a1020');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-rc.0+sha-f5a1020` usually means that core is at head so it supports
