...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.0+sha-e39bf3c'));
 ...
 */
new checker.Version('20.2.0-next.0+sha-e39bf3c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.0+sha-e39bf3c` usually means that core is at head so it supports
