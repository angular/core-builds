...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.0+sha-b49f2db'));
 ...
 */
new checker.Version('20.2.0-next.0+sha-b49f2db');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.0+sha-b49f2db` usually means that core is at head so it supports
