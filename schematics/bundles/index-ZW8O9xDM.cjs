...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('21.0.0-next.2+sha-1e614ec'));
 ...
 */
new project_tsconfig_paths.Version('21.0.0-next.2+sha-1e614ec');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `21.0.0-next.2+sha-1e614ec` usually means that core is at head so it supports
