...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('21.0.0-next.2+sha-9ffc83e'));
 ...
 */
new project_tsconfig_paths.Version('21.0.0-next.2+sha-9ffc83e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `21.0.0-next.2+sha-9ffc83e` usually means that core is at head so it supports
