...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.19+sha-25e4e07'));
 ...
 */
new project_tsconfig_paths.Version('20.3.19+sha-25e4e07');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.19+sha-25e4e07` usually means that core is at head so it supports
