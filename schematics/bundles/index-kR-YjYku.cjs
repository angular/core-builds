...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.20+sha-4aee744'));
 ...
 */
new project_tsconfig_paths.Version('20.3.20+sha-4aee744');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.20+sha-4aee744` usually means that core is at head so it supports
