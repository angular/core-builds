...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.0-next.4+sha-ff98ccb'));
 ...
 */
new checker.Version('20.0.0-next.4+sha-ff98ccb');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.4+sha-ff98ccb` usually means that core is at head so it supports
