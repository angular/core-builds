...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.0-next.4+sha-0fedf2c'));
 ...
 */
new checker.Version('20.0.0-next.4+sha-0fedf2c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.4+sha-0fedf2c` usually means that core is at head so it supports
