...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.0-next.4+sha-1226eaa'));
 ...
 */
new checker.Version('20.0.0-next.4+sha-1226eaa');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.4+sha-1226eaa` usually means that core is at head so it supports
