...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.2+sha-ed5062a'));
 ...
 */
new checker.Version('20.1.0-next.2+sha-ed5062a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.2+sha-ed5062a` usually means that core is at head so it supports
