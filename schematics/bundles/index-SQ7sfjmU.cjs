...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.2+sha-3ecfa9c'));
 ...
 */
new checker.Version('20.1.0-next.2+sha-3ecfa9c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.2+sha-3ecfa9c` usually means that core is at head so it supports
