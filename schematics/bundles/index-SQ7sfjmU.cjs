...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-next.2+sha-f8a90c9'));
 ...
 */
new checker.Version('20.1.0-next.2+sha-f8a90c9');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-next.2+sha-f8a90c9` usually means that core is at head so it supports
