...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('21.0.0-next.3+sha-d9483fa'));
 ...
 */
new project_tsconfig_paths.Version('21.0.0-next.3+sha-d9483fa');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `21.0.0-next.3+sha-d9483fa` usually means that core is at head so it supports
