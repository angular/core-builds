...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.2+sha-ba8a5d8'));
 ...
 */
new checker.Version('20.1.2+sha-ba8a5d8');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.2+sha-ba8a5d8` usually means that core is at head so it supports
