...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.2+sha-155dbee'));
 ...
 */
new checker.Version('20.1.2+sha-155dbee');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.2+sha-155dbee` usually means that core is at head so it supports
