...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.2+sha-91bdd17'));
 ...
 */
new checker.Version('20.1.2+sha-91bdd17');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.2+sha-91bdd17` usually means that core is at head so it supports
