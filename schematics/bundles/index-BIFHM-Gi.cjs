...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.2+sha-c36de9e'));
 ...
 */
new checker.Version('20.1.2+sha-c36de9e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.2+sha-c36de9e` usually means that core is at head so it supports
