...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.2+sha-db8f7ce'));
 ...
 */
new checker.Version('20.1.2+sha-db8f7ce');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.2+sha-db8f7ce` usually means that core is at head so it supports
