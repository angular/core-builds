...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.2+sha-409287a'));
 ...
 */
new checker.Version('20.1.2+sha-409287a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.2+sha-409287a` usually means that core is at head so it supports
