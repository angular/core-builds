...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.2+sha-74e4778'));
 ...
 */
new checker.Version('20.1.2+sha-74e4778');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.2+sha-74e4778` usually means that core is at head so it supports
