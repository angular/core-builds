...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.2+sha-1e9bfe5'));
 ...
 */
new checker.Version('20.1.2+sha-1e9bfe5');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.2+sha-1e9bfe5` usually means that core is at head so it supports
