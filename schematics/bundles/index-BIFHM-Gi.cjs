...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.2+sha-b388f1e'));
 ...
 */
new checker.Version('20.1.2+sha-b388f1e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.2+sha-b388f1e` usually means that core is at head so it supports
