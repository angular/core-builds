...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.1+sha-e7e2dea'));
 ...
 */
new checker.Version('20.1.1+sha-e7e2dea');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.1+sha-e7e2dea` usually means that core is at head so it supports
