...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.2+sha-cf48b13'));
 ...
 */
new checker.Version('20.1.2+sha-cf48b13');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.2+sha-cf48b13` usually means that core is at head so it supports
