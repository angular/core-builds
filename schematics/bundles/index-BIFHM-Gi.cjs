...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.2+sha-70d0c10'));
 ...
 */
new checker.Version('20.1.2+sha-70d0c10');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.2+sha-70d0c10` usually means that core is at head so it supports
