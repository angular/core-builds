...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.2+sha-bca8a3c'));
 ...
 */
new checker.Version('20.1.2+sha-bca8a3c');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.2+sha-bca8a3c` usually means that core is at head so it supports
