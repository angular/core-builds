...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.2+sha-45d3eef'));
 ...
 */
new checker.Version('20.1.2+sha-45d3eef');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.2+sha-45d3eef` usually means that core is at head so it supports
