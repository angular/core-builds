...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.2+sha-aee5260'));
 ...
 */
new checker.Version('20.1.2+sha-aee5260');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.2+sha-aee5260` usually means that core is at head so it supports
