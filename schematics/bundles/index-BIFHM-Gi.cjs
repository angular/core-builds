...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.2+sha-b7c745b'));
 ...
 */
new checker.Version('20.1.2+sha-b7c745b');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.2+sha-b7c745b` usually means that core is at head so it supports
