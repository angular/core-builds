...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.2+sha-6398baa'));
 ...
 */
new checker.Version('20.1.2+sha-6398baa');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.2+sha-6398baa` usually means that core is at head so it supports
