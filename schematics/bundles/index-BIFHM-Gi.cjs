...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.1+sha-8ad10fd'));
 ...
 */
new checker.Version('20.1.1+sha-8ad10fd');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.1+sha-8ad10fd` usually means that core is at head so it supports
