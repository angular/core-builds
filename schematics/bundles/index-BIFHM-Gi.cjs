...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.2+sha-a1a78b2'));
 ...
 */
new checker.Version('20.1.2+sha-a1a78b2');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.2+sha-a1a78b2` usually means that core is at head so it supports
