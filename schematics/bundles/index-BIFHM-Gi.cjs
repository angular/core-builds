...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.2+sha-2fd1f7b'));
 ...
 */
new checker.Version('20.1.2+sha-2fd1f7b');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.2+sha-2fd1f7b` usually means that core is at head so it supports
