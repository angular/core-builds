...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.3+sha-78a6b68'));
 ...
 */
new checker.Version('20.2.0-next.3+sha-78a6b68');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.3+sha-78a6b68` usually means that core is at head so it supports
