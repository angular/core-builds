...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.2+sha-320de4e'));
 ...
 */
new checker.Version('20.2.0-next.2+sha-320de4e');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.2+sha-320de4e` usually means that core is at head so it supports
