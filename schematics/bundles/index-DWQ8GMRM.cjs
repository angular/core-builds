...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.2+sha-6ad01e6'));
 ...
 */
new checker.Version('20.2.0-next.2+sha-6ad01e6');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.2+sha-6ad01e6` usually means that core is at head so it supports
