...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.2+sha-5f7cc12'));
 ...
 */
new checker.Version('20.2.0-next.2+sha-5f7cc12');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.2+sha-5f7cc12` usually means that core is at head so it supports
