...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.2+sha-d08f9ce'));
 ...
 */
new checker.Version('20.2.0-next.2+sha-d08f9ce');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.2+sha-d08f9ce` usually means that core is at head so it supports
