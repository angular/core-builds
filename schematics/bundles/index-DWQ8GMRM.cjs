...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.2+sha-9d05a8a'));
 ...
 */
new checker.Version('20.2.0-next.2+sha-9d05a8a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.2+sha-9d05a8a` usually means that core is at head so it supports
