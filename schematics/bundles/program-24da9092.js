...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.3.0-next.0+sha-c513e5d'));
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.3.0-next.0+sha-c513e5d` usually means that core is at head so it supports
