...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.3.0-next.0+sha-35e25f6'));
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.3.0-next.0+sha-35e25f6` usually means that core is at head so it supports
