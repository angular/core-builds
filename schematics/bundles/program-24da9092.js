...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.3.0-next.0+sha-e601bdc'));
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.3.0-next.0+sha-e601bdc` usually means that core is at head so it supports
