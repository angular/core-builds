...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('21.1.0-next.0+sha-d7e5aea'));
 ...
 */
new project_tsconfig_paths.Version('21.1.0-next.0+sha-d7e5aea');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `21.1.0-next.0+sha-d7e5aea` usually means that core is at head so it supports
