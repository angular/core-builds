...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('21.1.0-next.0+sha-0d38cbf'));
 ...
 */
new project_tsconfig_paths.Version('21.1.0-next.0+sha-0d38cbf');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `21.1.0-next.0+sha-0d38cbf` usually means that core is at head so it supports
