...
require('os');
var project_tsconfig_paths = require('./project_tsconfig_paths-BEYhFeds.cjs');
var index = require('./index-BqI6i-V_.cjs');
require('path');
require('node:path');
var project_paths = require('./project_paths-CHhdM33G.cjs');
