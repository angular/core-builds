...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', compiler.literal('20.0.0-rc.0+sha-7cb903f'));
 ...
 */
new compiler.Version('20.0.0-rc.0+sha-7cb903f');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-rc.0+sha-7cb903f` usually means that core is at head so it supports
