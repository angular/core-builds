...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.2.0-rc.1+sha-416878b'));
 ...
 */
new project_tsconfig_paths.Version('20.2.0-rc.1+sha-416878b');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-rc.1+sha-416878b` usually means that core is at head so it supports
