...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.0.0-next.8+sha-5cbe02a'));
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.0.0-next.8+sha-5cbe02a` usually means that core is at head so it supports
