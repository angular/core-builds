...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.2.0-next.0+sha-567597a'));
 ...
 */
new checker.Version('20.2.0-next.0+sha-567597a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.0-next.0+sha-567597a` usually means that core is at head so it supports
