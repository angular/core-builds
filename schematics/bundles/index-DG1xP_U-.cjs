...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-rc.0+sha-d1d131a'));
 ...
 */
new checker.Version('20.1.0-rc.0+sha-d1d131a');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-rc.0+sha-d1d131a` usually means that core is at head so it supports
