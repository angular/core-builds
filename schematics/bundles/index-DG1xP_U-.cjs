...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.1.0-rc.0+sha-42a3dbb'));
 ...
 */
new checker.Version('20.1.0-rc.0+sha-42a3dbb');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.0-rc.0+sha-42a3dbb` usually means that core is at head so it supports
