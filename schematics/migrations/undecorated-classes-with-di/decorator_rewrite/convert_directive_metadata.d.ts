 ...
 */
export declare function convertDirectiveMetadataToExpression(compilerModule: typeof import('@angular/compiler'), metadata: any, resolveSymbolImport: (symbol: StaticSymbol) => string | null, createImport: (moduleName: string, name: string) => ts.Expression, convertProperty?: (key: string, value: any) => ts.Expression | null): ts.Expression;
