...
(function (factory) {
    ...
    class UndecoratedClassesTransform {
        ...
        _constructDecoratorFromMetadata(directiveMetadata, targetSourceFile) {
            try {
                const decoratorExpr = (0, convert_directive_metadata_1.convertDirectiveMetadataToExpression)(directiveMetadata.metadata, staticSymbol => this.compilerHost
