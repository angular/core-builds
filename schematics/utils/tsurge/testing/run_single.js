 ...
 */
import { TsurgeFunnelMigration } from '../migration';
 ...
 */
export async function runTsurgeMigration(migration, files, compilerOptions = {}) {
    ...
    mockFs.writeFile(absoluteFrom('/tsconfig.json'), JSON.stringify({
        compilerOptions: {
            strict: true,
            rootDir: '/',
            ...compilerOptions,
    ...
    const { replacements } = migration instanceof TsurgeFunnelMigration
...
//# sourceMappingURL=run_single.js.map