 ...
 */
export function createNgtscProgram(tsHost, tsconfig, optionOverrides) {
    const ngtscProgram = new NgtscProgram(tsconfig.rootNames, {
        ...tsconfig.options,
...
//# sourceMappingURL=ngtsc_program.js.map