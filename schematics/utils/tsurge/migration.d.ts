 ...
 */
export type TsurgeMigration<UnitAnalysisMetadata, CombinedGlobalMetadata, Stats> = TsurgeComplexMigration<UnitAnalysisMetadata, CombinedGlobalMetadata, Stats> | TsurgeFunnelMigration<UnitAnalysisMetadata, CombinedGlobalMetadata, Stats>;
/**
 ...
 */
export declare abstract class TsurgeFunnelMigration<UnitAnalysisMetadata, CombinedGlobalMetadata, Stats = unknown> extends TsurgeBaseMigration<UnitAnalysisMetadata, CombinedGlobalMetadata, Stats> {
    /**
 ...
 */
export declare abstract class TsurgeComplexMigration<UnitAnalysisMetadata, CombinedGlobalMetadata, Stats = unknown> extends TsurgeBaseMigration<UnitAnalysisMetadata, CombinedGlobalMetadata, Stats> {
    /**
     ...
     */
    abstract migrate(globalMetadata: CombinedGlobalMetadata, info: ProgramInfo): Promise<MigrateResult>;
}
export {};
