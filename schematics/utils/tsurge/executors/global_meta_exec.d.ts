 ...
 */
export declare function executeGlobalMetaPhase<UnitData, GlobalData>(migration: TsurgeMigration<UnitData, GlobalData, unknown>, combinedUnitData: UnitData): Promise<Serializable<GlobalData>>;
