 ...
 */
export declare function executeMigratePhase<UnitData, GlobalData>(migration: TsurgeMigration<UnitData, GlobalData, unknown>, globalMetadata: GlobalData, tsconfigAbsolutePath: string): Promise<{
