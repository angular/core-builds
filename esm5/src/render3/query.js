        ...
        for (var i = 0; i < tQueryMatches.length; i += 2) {
            ...
            if (tNodeIdx > 0) {
                ...
                if (declarationLContainer[MOVED_VIEWS] !== null) {
                    try {
                        for (var _b = tslib_1.__values(declarationLContainer[MOVED_VIEWS]), _c = _b.next(); !_c.done; _c = _b.next()) {
