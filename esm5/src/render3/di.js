...
export var QUERY_READ_FROM_NODE = new ReadFromInjectorFn(function (injector, tNode, directiveIdx) {
    ngDevMode && assertNodeOfPossibleTypes(tNode, 0 /* Container */, 3 /* Element */, 4 /* ElementContainer */);
    if (directiveIdx > -1) {
