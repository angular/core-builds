    ...
    TestBedRender3.prototype._compileNgModule = function (moduleType) {
        ...
        declaredComponents.forEach(function (cmp) {
            var scope = _this._templateOverrides.has(cmp) ?
                ...
                transitiveScopesFor(_this._testModuleType) :
                transitiveScope;
