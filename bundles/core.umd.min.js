...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
function Z_(){return Sp}function W_(){return Vp}function K_(e){return e=e||function t(){return Tm&&"undefined"!=typeof $localize&&$localize.locale||jv}(),Tm&&Cy(e),e}var G_=[{provide:d_,useClass:d_,deps:[Qm,Em,ll,Oo,lp,ym]},{provide:wv,deps:[Qm],useFactory:J_},{provide:ym,useClass:ym,deps:[[new C,vm]]},{provide:Hm,useClass:Hm,deps:[]},_m,{provide:jp,useFactory:Z_,deps:[]},{provide:Ap,useFactory:W_,deps:[]},{provide:Om,useFactory:K_,deps:[[new w(Om),new C,new x]]}];function J_(e){var t=[];return e.onStable.subscribe((function(){for(;t.length;)t.pop()()})),function(e){t.push(e)}}var Y_,$_=a([fm({providers:G_}),s("design:paramtypes",[d_])],(function $_(e){}));
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
