 ...
 * found in the LICENSE file at https://angular.io/license
 */
function defineComponent(componentDefinition){var def={diPublic:null,n:componentDefinition.factory,tag:componentDefinition.tag||null,template:componentDefinition.template||null,r:componentDefinition.refresh||(componentDefinition.template?function(d,e){componentRefresh(d,e,componentDefinition.template)}:noop$1),h:componentDefinition.hostBindings||noop$1,inputs:invertObject(componentDefinition.inputs),outputs:invertObject(componentDefinition.outputs),methods:invertObject(componentDefinition.methods),rendererType:resolveRendererType2(componentDefinition.rendererType)||null,exportAs:componentDefinition.exportAs},feature=componentDefinition.features;return feature&&feature.forEach(function(fn){return fn(def)}),def}function noop$1(){}function invertObject(obj){if(null==obj)return EMPTY$1;var newObj={};for(var minifiedKey in obj)newObj[obj[minifiedKey]]=minifiedKey;return newObj}/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
