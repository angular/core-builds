...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
ps=e.SecurityContext||(e.SecurityContext={}))[ps.NONE=0]="NONE",ps[ps.HTML=1]="HTML",ps[ps.STYLE=2]="STYLE",ps[ps.SCRIPT=3]="SCRIPT",ps[ps.URL=4]="URL",ps[ps.RESOURCE_URL=5]="RESOURCE_URL";var gs,ys=function ys(){},ms=new(gs=function gs(e){this.full=e,this.major=e.split(".")[0],this.minor=e.split(".")[1],this.patch=e.split(".").slice(2).join(".")})("7.1.0+51.sha-419fa17"),_s=function(e){function t(){return null!==e&&e.apply(this,arguments)||this}return o(t,e),t.prototype.resolveComponentFactory=function(e){var t=he(e);return new Is(t)},t}(rs);
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
