...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var Le,Be=new(Le=function Le(e){this.full=e,this.major=e.split(".")[0],this.minor=e.split(".")[1],this.patch=e.split(".").slice(2).join(".")})("6.1.10+18.sha-eeebe62"),ze="ngDebugContext",Qe="ngOriginalError",Ue="ngErrorLogger";function Ze(e){return e[ze]}function qe(e){return e[Qe]}function Ke(e){for(var t=[],n=1;n<arguments.length;n++)t[n-1]=arguments[n];e.error.apply(e,f(t))}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
