...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function eg(e,t){var n,r=Mr()[Vn],o=e+er;r.firstTemplatePass?(n=function i(e,t){if(t)for(var n=t.length-1;n>=0;n--){var r=t[n];if(e===r.name)return r}throw new Error("The pipe '"+e+"' could not be found!")}(t,r.pipeRegistry),r.data[o]=n,n.onDestroy&&(r.destroyHooks||(r.destroyHooks=[])).push(o,n.onDestroy)):n=r.data[o];var a=n.factory(null);return tf(e,a),a}function tg(e,t,n){var r=rf(e);return ug(ag(e)?Zy(t,r.transform,n,r):r.transform(n))}function ng(e,t,n,r){var o=rf(e);return ug(ag(e)?qy(t,o.transform,n,r,o):o.transform(n,r))}function rg(e,t,n,r,o){var i=rf(e);return ug(ag(e)?Wy(t,i.transform,n,r,o,i):i.transform(n,r,o))}function og(e,t,n,r,o,i){var a=rf(e);return ug(ag(e)?Ky(t,a.transform,n,r,o,i,a):a.transform(n,r,o,i))}function ig(e,t,n){var r=rf(e);return ug(ag(e)?Xy(t,r.transform,n,r):r.transform.apply(r,n))}function ag(e){return Mr()[Vn].data[e+er].pure}function ug(e){if(Jl.isWrapped(e)){e=Jl.unwrap(e);var t=Mr();t[t[Qn]]=Ta}return e}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
