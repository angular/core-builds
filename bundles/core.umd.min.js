...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function ly(e,t){var n,r=Yt(),o=e+Tt;r.firstCreatePass?(n=function i(e,t){if(t)for(var n=t.length-1;n>=0;n--){var r=t[n];if(e===r.name)return r}throw new Error("The pipe '"+e+"' could not be found!")}(t,r.pipeRegistry),r.data[o]=n,n.onDestroy&&(r.destroyHooks||(r.destroyHooks=[])).push(o,n.onDestroy)):n=r.data[o];var a=(n.factory||(n.factory=lt(n.type)))();return Dl(r,Jt(),e,a),a}function cy(e,t,n){var r=Jt(),o=Lo(r,e);return yy(r,vy(r,e)?oy(r,an(),t,o.transform,n,o):o.transform(n))}function fy(e,t,n,r){var o=Jt(),i=Lo(o,e);return yy(o,vy(o,e)?iy(o,an(),t,i.transform,n,r,i):i.transform(n,r))}function dy(e,t,n,r,o){var i=Jt(),a=Lo(i,e);return yy(i,vy(i,e)?ay(i,an(),t,a.transform,n,r,o,a):a.transform(n,r,o))}function py(e,t,n,r,o,i){var a=Jt(),u=Lo(a,e);return yy(a,vy(a,e)?uy(a,an(),t,u.transform,n,r,o,i,u):u.transform(n,r,o,i))}function hy(e,t,n){var r=Jt(),o=Lo(r,e);return yy(r,vy(r,e)?sy(r,an(),t,o.transform,n,o):o.transform.apply(o,n))}function vy(e,t){return e[dt].data[t+Tt].pure}function yy(e,t){return $s.isWrapped(t)&&(t=$s.unwrap(t),e[un()]=yi),t}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
