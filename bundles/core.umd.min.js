 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var Re={},De=function Oe(e,t){for(var n in e)if(e[n]===t)return n;throw Error("Could not find renamed property on target object.")}({provide:String,useValue:Re},Re),Ae=[];function je(e,t){if(!t){var n=(l=new Y).parameters(e);return function(){return new(e.bind.apply(e,s([void 0],Te(n))))}}if(De in t){var r=t;return function(){return r.useValue}}if(t.useExisting){var o=t;return function(){return Pe(o.useExisting)}}if(t.useFactory){var i=t;return function(){return i.useFactory.apply(i,s(Te(i.deps||Ae)))}}if(t.useClass){var a=t,u=t.deps;if(!u){var l=new Y;u=l.parameters(e)}return function(){return new((e=a.useClass).bind.apply(e,s([void 0],Te(u))));var e}}var c=t.deps;return c||(l=new Y,c=l.parameters(e)),function(){return new(e.bind.apply(e,s([void 0],Te(c))))}}var Ve,Se=v("Injectable",void 0,void 0,void 0,function(e,t){t&&void 0!==t.providedIn&&void 0===e.ngInjectableDef&&(e.ngInjectableDef=l({providedIn:t.providedIn,factory:je(e,t)}))}),Me=v("NgModule",function(e){return e},void 0,void 0,function(e,t){var n=t&&t.imports||[];t&&t.exports&&(n=s(n,[t.exports])),e.ngInjectorDef=c({factory:je(e,{useClass:e}),providers:t&&t.providers,imports:n})});
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
var Fe,He=new(Fe=function Fe(e){this.full=e,this.major=e.split(".")[0],this.minor=e.split(".")[1],this.patch=e.split(".").slice(2).join(".")})("6.0.0-rc.5+89.sha-1a44a0b"),Le="ngDebugContext",Be="ngOriginalError",ze="ngErrorLogger";function Ue(e){return e[Le]}function Qe(e){return e[Be]}function Ze(e){for(var t=[],n=1;n<arguments.length;n++)t[n-1]=arguments[n];e.error.apply(e,s(t))}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
function ju(e,t){for(var n=e;n&&n!==t;){var r=n.pNextOrParent;if(r){for(;1!==r.type;){if(i=Mu(r))return i;r=r.pNextOrParent}n=r}else{for(var o=n.next;o;){var i;if(i=Mu(o))return i;o=o.next}var a=n.parent;if(n=null,a){var u=a.type;0!==u&&2!==u||(n=a)}}}return null}function Vu(e){var t=e.pNextOrParent;return t?1===t.type?null:t:e.next}function Su(e,t){for(var n=e,r=Vu(n);n&&!r;){if((n=n.pNextOrParent||n.parent)===t)return null;r=n&&Vu(n)}return r}function Mu(e){for(var t=e;t;){var n=null;if(3===t.type)return t.native;if(0===t.type){var r=t.dynamicLContainerNode?t.dynamicLContainerNode.data:t.data;n=r.views.length?r.views[0].child:null}else n=1===t.type?t.data.head:t.child;t=null===n?Su(t,e):n}return null}function Fu(e,t,n,r){var o=e.data.renderParent,i=o?o.native:null,a=t.child;if(i)for(;a;){var u=null,s=e.view.renderer;if(3===a.type)n?Ru(s)?s.insertBefore(i,a.native,r):i.insertBefore(a.native,r,!0):Ru(s)?s.removeChild(i,a.native):i.removeChild(a.native),u=a.next;else if(0===a.type){var l=a.data;l.renderParent=o,u=l.views.length?l.views[0].child:null}else u=1===a.type?a.data.head:a.child;a=null===u?Su(a,t):u}}function Hu(e,t,n){var r=e.data.views;if(n>0&&Bu(r[n-1],t),n<r.length?(Bu(t,r[n]),r.splice(n,0,t)):r.push(t),null!==e.data.renderParent){var o=ju(t,e);if(!o){var i=e.native;void 0===i&&(i=e.native=ju(e,null)),o=i}Fu(e,t,!0,o)}return t}function Lu(e,t){var n=e.data.views,r=n[t];return t>0&&Bu(n[t-1],r.next),n.splice(t,1),r.next=null,function o(e){if(!e.child)return Uu(e);for(var t=e.child;t;){var n=null;if(t.views&&t.views.length?n=t.views[0].data:t.child?n=t.child:t.next&&(Uu(t),n=t.next),null==n){for(;t&&!t.next&&t!==e;)Uu(t),t=zu(t,e);Uu(t||e),n=t&&t.next}t=n}}(r.data),Fu(e,r,!1),e.data.queries&&e.data.queries.removeView(t),r}function Bu(e,t){e.next=t,e.data.next=t?t.data:null}function zu(e,t){var n;return(n=e.node)&&2===n.type?n.parent.data:e.parent===t?null:e.parent}function Uu(e){!function t(e){var t=e.cleanup;if(null!=t){for(var n=0;n<t.length-1;n+=2)"string"==typeof t[n]?(t[n+1].removeEventListener(t[n],t[n+2],t[n+3]),n+=2):t[n].call(t[n+1]);e.cleanup=null}}(e),function n(e){var t,n=e.tView;null!=n&&null!=(t=n.destroyHooks)&&Nu(e.directives,t)}(e),function r(e){var t=e.tView&&e.tView.pipeDestroyHooks;t&&Nu(e.data,t)}(e)}function Qu(e,t){return 3===e.type&&(e.view!==t||null===e.data)}function Zu(e,t,n){if(null!==t&&Qu(e,n)){var r=n.renderer;return Ru(r)?r.appendChild(e.native,t):e.native.appendChild(t),!0}return!1}function qu(e,t,n){if(0!==e.type)Zu(t,e.native,n);else{var r=e.data;r.renderParent=t;for(var o=r.views,i=0;i<o.length;i++)Fu(e,o[i],!0,null)}e.dynamicLContainerNode&&(e.dynamicLContainerNode.data.renderParent=t)}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function Ku(e,t){for(var n,r,o,i,a,u=4,s=e.attrs,l=!1,c=0;c<t.length;c++){var d=t[c];if("number"!=typeof d){if(!l)if(4&u){if(u=2|1&u,""!==d&&d!==e.tagName){if(Wu(u))return!1;l=!0}}else{var f=Gu(8&u?"class":d,s);if(-1===f){if(Wu(u))return!1;l=!0;continue}var p=8&u?d:t[++c];if(""!==p){var h=s[f+1];if(8&u&&(o=(n=h).length,a=(i=n.indexOf(r=p))+r.length,-1===i||i>0&&" "!==n[i-1]||a<o&&" "!==n[a])||2&u&&p!==h){if(Wu(u))return!1;l=!0}}}}else{if(!l&&!Wu(u)&&!Wu(d))return!1;if(l&&Wu(d))continue;l=!1,u=d|1&u}}return Wu(u)||l}function Wu(e){return 0==(1&e)}function Gu(e,t){if(null===t)return-1;for(var n=0;n<t.length;n+=2)if(t[n]===e)return n;return-1}function Yu(e,t){for(var n=0;n<t.length;n++)if(Ku(e,t[n]))return!0;return!1}function $u(e,t,n){for(var r=function o(e){var t=e.attrs;if(null!=t){var n=t.indexOf(Tu);if(0==(1&n))return t[n+1]}return null}(e),i=0;i<t.length;i++)if(r===n[i]||null===r&&Yu(e,t[i]))return i+1;return 0}function Ju(e){throw new Error("Multiple components match node with tagname "+e.tagName)}function Xu(e,t,n,r){if(t){var o="ExpressionChangedAfterItHasBeenCheckedError: Expression has changed after it was checked. Previous value: '"+n+"'. Current value: '"+r+"'.";throw e&&(o+=" It seems like the view has been created after its parent and its children have been dirty checked. Has it been created in a change detection hook ?"),new Error(o)}}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var es,ts,ns,rs,os,is="__ngHostLNode__",as=Promise.resolve(null),us=[0,0],ss="__CIRCULAR__";function ls(){return ns}var cs,ds,fs,ps,hs,vs=null;function gs(){return ds}var ys=!1,ms=!0;function _s(e,t){var n=vs;return fs=e&&e.data,ps=e&&e.directives,os=e&&e.tView.data,ds=e&&1==(1&e.flags),ms=e&&e.tView.firstTemplatePass,hs=e&&e.cleanup,es=e&&e.renderer,e&&e.bindingIndex<0&&(e.bindingIndex=e.bindingStartIndex),null!=t&&(ns=t,rs=!0),vs=e,cs=e&&e.queries,n}function ws(e,t){t||(ys||Eu(ps,vs.tView.viewHooks,vs.tView.viewCheckHooks,ds),vs.flags&=-6),vs.lifecycleStage=1,vs.bindingIndex=-1,_s(e,null)}function bs(){var e=vs.tView;ys||Iu(vs,e,ds),function t(){for(var e=vs.child;null!==e;e=e.next)if(0!==e.dynamicViewCount&&e.views)for(var t=e,n=0;n<t.views.length;n++){var r=t.views[n];Ns(r,r.data.template,r.data.context,es)}}(),ys||Eu(ps,e.contentHooks,e.contentCheckHooks,ds),e.firstTemplatePass=ms=!1,Cs(e.hostBindings),function n(e){if(null!=e)for(var t=0;t<e.length;t+=2)zs(e[t],e[t+1])}(e.components)}function Cs(e){if(null!=e)for(var t=vs.tView.directives,n=0;n<e.length;n+=2){var r=e[n],o=t[r];o.hostBindings&&o.hostBindings(r,e[n+1])}}function xs(){if(!ys){var e=vs.tView;Iu(vs,e,ds),Eu(ps,e.contentHooks,e.contentCheckHooks,ds)}}function ks(e,t,n,r,o,i){return{parent:vs,id:e,flags:9|i,node:null,data:[],directives:null,tView:n,cleanup:null,renderer:t,child:null,tail:null,next:null,bindingStartIndex:-1,bindingIndex:-1,template:r,context:o,dynamicViewCount:0,lifecycleStage:1,queries:null,injector:vs&&vs.injector}}function Is(e,t,n,r,o,i){return{type:e,native:r,view:t,parent:n,child:null,next:null,nodeInjector:n?n.nodeInjector:null,data:o,queries:i,tNode:null,pNextOrParent:null,dynamicLContainerNode:null}}function Es(e,t,n,r){var o=rs?ns:ns&&ns.parent,i=(rs?cs:ns&&ns.queries)||o&&o.queries&&o.queries.child(),a=null!=r,u=Is(t,vs,o,n,a?r:null,i);return 2==(2&t)&&a&&(r.node=u),null!=e&&(fs[e]=u,e>=os.length?os[e]=null:u.tNode=os[e],rs?(cs=null,ns.view!==vs&&2!==ns.type||(ns.child=u)):ns&&(ns.next=u,ns.dynamicLContainerNode&&(ns.dynamicLContainerNode.next=u))),ns=u,rs=!0,u}function Ns(e,t,n,r,o,i){var a,u=rs,s=ns,l=2;try{rs=!0,ns=null,null==e&&(e=Es(null,2,null,ks(-1,r,As(t,o||null,i||null),t,n,2)),l=1),a=_s(e.data,e),t(l,n),2&l?bs():e.data.tView.firstTemplatePass=ms=!1}finally{ws(a,1==(1&l)),rs=u,ns=s}return e}function Ps(e){return 1&e.flags?3:2}function Ts(e,t,n,r,o){var i=ns;ms?(i.tNode=os[e]=Ms(t,n||null,o),function a(e,t,n){var r=n?{"":-1}:null,o=t.currentMatches=function i(e){var t=vs.tView.directiveRegistry,n=null;if(t)for(var r=0;r<t.length;r++){var o=t[r];Yu(e,o.selectors)&&(o.template&&(4096&e.flags&&Ju(e),e.flags=4096),o.diPublic&&o.diPublic(o),(n||(n=[])).push(o,null))}return n}(e);if(o)for(var a=0;a<o.length;a+=2){var u=o[a],s=a+1;Rs(u,s,o,t),Os(o[s],u,r)}r&&function l(e,t,n){if(t)for(var r=e.localNames=[],o=0;o<t.length;o+=2){var i=n[t[o+1]];if(null==i)throw new Error("Export of name '"+t[o+1]+"' not found!");r.push(t[o],i)}}(e,n,r)}(i.tNode,vs.tView,r||null)):function u(){var e=ns.tNode,t=4095&e.flags;if(t>0)for(var n=e.flags>>13,r=n+t,o=vs.tView.directives,i=n;i<r;i++){var a=o[i];Hs(i,a.factory(),a)}}(),function s(){var e=ns.tNode.localNames;if(e)for(var t=0;t<e.length;t+=2){var n=e[t+1];fs.push(-1===n?ns.native:ps[n])}}()}function Rs(e,t,n,r){if(null===n[t]){n[t]=ss;var o=e.factory();return(r.directives||(r.directives=[])).push(e),Hs(n[t]=r.directives.length-1,o,e)}return n[t]===ss&&function i(e){throw new Error("Cannot instantiate cyclic dependency! "+e)}(e.type),null}function Ds(e,t,n){e&&null!=e.changeDetectorRef&&e.changeDetectorRef._setComponentContext(n,t)}function Os(e,t,n){n&&(t.exportAs&&(n[t.exportAs]=e),t.template&&(n[""]=e))}function As(e,t,n){return e.ngPrivateData||(e.ngPrivateData=js(t,n))}function js(e,t){return{data:[],directives:null,firstTemplatePass:!0,initHooks:null,checkHooks:null,contentHooks:null,contentCheckHooks:null,viewHooks:null,viewCheckHooks:null,destroyHooks:null,pipeDestroyHooks:null,hostBindings:null,components:null,directiveRegistry:"function"==typeof e?e():e,pipeRegistry:"function"==typeof t?t():t,currentMatches:null}}function Vs(e,t){for(var n=Ru(es),r=0;r<t.length;r+=2){var o=t[r];if(o!==Tu){var i=t[r+1];n?es.setAttribute(e,o,i):e.setAttribute(o,i)}}}function Ss(e,t){ts=e;var n=e.createRenderer(null,null);return"string"==typeof t?Ru(n)?n.selectRootElement(t):n.querySelector(t):t}function Ms(e,t,n){return{flags:0,tagName:e,attrs:t,localNames:null,initialInputs:void 0,inputs:void 0,outputs:void 0,data:n}}function Fs(e,t){var n=4095&e,r=null;if(n>0)for(var o=e>>13,i=o+n,a=0===t,u=vs.tView.directives,s=o;s<i;s++){var l=u[s],c=a?l.inputs:l.outputs;for(var d in c)if(c.hasOwnProperty(d)){var f=c[d];(r=r||{}).hasOwnProperty(d)?r[d].push(s,f):r[d]=[s,f]}}return r}function Hs(e,t,n){var r=Ls(e,t,n),o=ns.tNode;return n.template&&function i(e,t,n){var r=As(n.template,n.directiveDefs,n.pipeDefs),o=Zs(vs,ks(-1,ts.createRenderer(ns.native,n.rendererType),r,null,null,n.onPush?4:2));ns.data=o,o.node=ns,Ds(ns.nodeInjector,t,o),ms&&function i(e){ms&&(vs.tView.components||(vs.tView.components=[])).push(e,fs.length-1)}(e)}(e,t,n),ms&&(
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
function a(e,t,n,r){t&&(r.initHooks||(r.initHooks=[])).push(e,t),n&&((r.initHooks||(r.initHooks=[])).push(e,n),(r.checkHooks||(r.checkHooks=[])).push(e,n))}(e,n.onInit,n.doCheck,vs.tView),n.hostBindings&&function u(e){(vs.tView.hostBindings||(vs.tView.hostBindings=[])).push(e,fs.length-1)}(e)),o&&o.attrs&&function s(e,t,n,r){var o=r.initialInputs;(void 0===o||e>=o.length)&&(o=function i(e,t,n){var r=n.initialInputs||(n.initialInputs=[]);r[e]=null;for(var o=n.attrs,i=0;i<o.length;i+=2){var a=t[o[i]];void 0!==a&&(r[e]||(r[e]=[])).push(a,o[i+1])}return r}(e,n,r));var a=o[e];if(a)for(var u=0;u<a.length;u+=2)t[a[u]]=a[u+1]}(e,r,n.inputs,o),r}function Ls(e,t,n){if(Object.defineProperty(t,is,{enumerable:!1,value:ns}),null==ps&&(vs.directives=ps=[]),ps[e]=t,ms){var r=ns.tNode.flags;0==(4095&r)?ns.tNode.flags=e<<13|4096&r|1:ns.tNode.flags++}else{var o=n.diPublic;o&&o(n)}return null!=n.attributes&&3==ns.type&&Vs(ns.native,n.attributes),t}function Bs(e,t,n){return{views:[],nextIndex:0,renderParent:Qu(e,t)?e:null,template:null==n?null:n,next:null,parent:t,dynamicViewCount:0,queries:null}}function zs(e,t){var n=fs[t],r=n.data;(function o(e){return 8==(8&e.flags)})(r)&&6&r.flags&&Gs(r,n,vs.tView.directives[e],al(ps[e]))}function Us(e,t,n){if(n){var r=e.data;r.tail?r.tail.pNextOrParent=t:r.head=t,r.tail=n,n.pNextOrParent=e}}function Qs(e){for(var t=e.node;2===t.type;)t=(e=e.parent).node;return t}function Zs(e,t){return e.tail?e.tail.next=t:e.child=t,e.tail=t,t}function qs(e){for(var t=e;null!=t.parent;)t.flags|=4,t=t.parent;t.flags|=4,function n(e){var t;e.clean==as&&(e.clean=new Promise(function(e){return t=e}),e.scheduler(function(){!function n(e){var t=Ks(e),n=t.context.component;!function r(e,t,n,o){var i=_s(t,e);try{ts.begin&&ts.begin(),o?(o(Ps(t),n),bs()):(xs(),Cs(us),zs(0,0))}finally{ts.end&&ts.end(),ws(i)}}(ul(n),t,n)}(e.component),t(null),e.clean=as}))}(t.context)}function Ks(e){for(var t=ul(e).view;t.parent;)t=t.parent;return t}function Ws(e){var t=ul(e);Gs(t.data,t,t.view.tView.directives[t.tNode.flags>>13],e)}function Gs(e,t,n,r){var o=_s(e,t),i=n.template;try{i(Ps(e),r),bs()}finally{ws(o)}}var Ys={};function $s(){vs.bindingIndex=vs.bindingStartIndex=fs.length}function Js(e,t){e>=os.length&&(os[e]=null),fs[e]=t}function Xs(e){return fs[e]}function el(){return fs[vs.bindingIndex++]}function tl(e){if(vs.bindingStartIndex<0)$s();else{if(!Ou(fs[vs.bindingIndex],e))return vs.bindingIndex++,!1;Xu(ds,ys,fs[vs.bindingIndex],e)}return fs[vs.bindingIndex++]=e,!0}function nl(e){return tl(e),e}function rl(e,t){var n=tl(e);return tl(t)||n}function ol(e,t,n,r){var o=rl(e,t);return rl(n,r)||o}function il(){return vs.tView}function al(e){return Array.isArray(e)?e[0]:e}function ul(e){return e[is]}var sl=as,ll=us,cl=function(){function e(e,t){this._view=e,this.context=t}return e.prototype._setComponentContext=function(e,t){this._view=e,this.context=t},e.prototype.destroy=function(){},e.prototype.onDestroy=function(e){},e.prototype.markForCheck=function(){qs(this._view)},e.prototype.detach=function(){this._view.flags&=-9},e.prototype.reattach=function(){this._view.flags|=8},e.prototype.detectChanges=function(){Ws(this.context)},e.prototype.checkNoChanges=function(){!function e(t){ys=!0;try{Ws(t)}finally{ys=!1}}(this.context)},e}(),dl=function(e){function t(t,n,r){var o=e.call(this,t.data,r)||this;return o._lViewNode=t,o}return o(t,e),t}(cl);function fl(e,t){return pl(new cl(e,t))}function pl(e){var t=null;return e.destroyed=!1,e.destroy=function(){t&&t.forEach(function(e){return e()}),this.destroyed=!0},e.onDestroy=function(e){return(t||(t=[])).push(e)},e}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
var hl="__NG_ELEMENT_ID__",vl=256,gl=0;function yl(){return ml(ls())}function ml(e){var t=e.nodeInjector,n=e.parent&&e.parent.nodeInjector;return t!=n?t:e.nodeInjector={parent:n,node:e,bf0:0,bf1:0,bf2:0,bf3:0,bf4:0,bf5:0,bf6:0,bf7:0,cbf0:null==n?0:n.cbf0|n.bf0,cbf1:null==n?0:n.cbf1|n.bf1,cbf2:null==n?0:n.cbf2|n.bf2,cbf3:null==n?0:n.cbf3|n.bf3,cbf4:null==n?0:n.cbf4|n.bf4,cbf5:null==n?0:n.cbf5|n.bf5,cbf6:null==n?0:n.cbf6|n.bf6,cbf7:null==n?0:n.cbf7|n.bf7,templateRef:null,viewContainerRef:null,elementRef:null,changeDetectorRef:null}}function _l(e){!function t(e,n){!function r(e,t){var n=t[hl];null==n&&(n=t[hl]=gl++);var r=n%vl,o=1<<r;r<128?r<64?r<32?e.bf0|=o:e.bf1|=o:r<96?e.bf2|=o:e.bf3|=o:r<192?r<160?e.bf4|=o:e.bf5|=o:r<224?e.bf6|=o:e.bf7|=o}(e,n.type)}(yl(),e)}function wl(e,t){if(e.changeDetectorRef)return e.changeDetectorRef;var n=e.node;return function r(e){return 4096==(4096&e.flags)}(n.tNode)?e.changeDetectorRef=fl(n.data,t):3===n.type?e.changeDetectorRef=function o(e){var t=function n(e){for(;2===e.type;)e=e.view.node;return e}(e),r=t.nodeInjector;return r&&r.changeDetectorRef||fl(t.data,t.view.directives[t.tNode.flags>>13])}(n.view.node):null}function bl(e,t,n){void 0===n&&(n=0);var r=function o(e){var t=e[hl];return"number"==typeof t?t%vl:null}(t);if(null===r){var i=Ne(ls().view.injector);try{return Pe(t,n)}finally{Ne(i)}}else for(var a=e;a&&(a=xl(a,r,n));){var u=a.node,s=u.tNode.flags,l=4095&s;if(0!==l)for(var c=s>>13,d=c+l,f=u.view.tView.directives,p=c;p<d;p++){var h=f[p];if(h.type===t&&h.diPublic)return al(u.view.directives[p])}var v=void 0;if(a===e&&(v=Cl(u,t)))return v;a=2&n||1&n&&!kl(a)?null:a.parent}if(8&n)return null;throw new Error("Injector: NOT_FOUND ["+Au(t)+"]")}function Cl(e,t){var n=e.view.tView.currentMatches;if(n)for(var r=0;r<n.length;r+=2){var o=n[r];if(o.type===t)return Rs(o,r+1,n,e.view.tView)}return null}function xl(e,t,n){for(var r=1<<t,o=4&n?e.parent:e;o;){if(((t<128?t<64?t<32?o.bf0:o.bf1:t<96?o.bf2:o.bf3:t<192?t<160?o.bf4:o.bf5:t<224?o.bf6:o.bf7)&r)===r)return o;if(2&n||1&n&&!kl(o))return null;o=(t<128?t<64?t<32?o.cbf0:o.cbf1:t<96?o.cbf2:o.cbf3:t<192?t<160?o.cbf4:o.cbf5:t<224?o.cbf6:o.cbf7)&r?o.parent:null}return null}function kl(e){return!!e.parent&&e.parent.node.view===e.node.view}var Il=function Il(e){this.read=e},El=function zn(e){this.nativeElement=e};function Nl(e){if(!e.viewContainerRef){var t=e.node,n=Bs(t.parent,t.view),r=Is(0,t.view,t.parent,void 0,n,null);t.dynamicLContainerNode=r,Zs(t.view,n),e.viewContainerRef=new Pl(r)}return e.viewContainerRef}var Pl=function(){function e(e){this._lContainerNode=e,this._viewRefs=[]}return e.prototype.clear=function(){for(var e=this._lContainerNode.data;e.views.length;)this.remove(0)},e.prototype.get=function(e){return this._viewRefs[e]||null},Object.defineProperty(e.prototype,"length",{get:function(){return this._lContainerNode.data.views.length},enumerable:!0,configurable:!0}),e.prototype.createEmbeddedView=function(e,t,n){var r=e.createEmbeddedView(t||{});return this.insert(r,n),r},e.prototype.createComponent=function(e,t,n,r,o){throw function i(){return new Error("NotImplemented")}()},e.prototype.insert=function(e,t){var n=e._lViewNode,r=this._adjustIndex(t);return Hu(this._lContainerNode,n,r),this._lContainerNode.native=void 0,this._viewRefs.splice(r,0,e),n.parent=this._lContainerNode,null!==n.data.template&&(this._lContainerNode.data.dynamicViewCount++,null!==this._lContainerNode.parent&&null!==this._lContainerNode.parent.data&&this._lContainerNode.parent.data.dynamicViewCount++),e},e.prototype.move=function(e,t){var n=this.indexOf(e);return this.detach(n),this.insert(e,this._adjustIndex(t)),e},e.prototype.indexOf=function(e){return this._viewRefs.indexOf(e)},e.prototype.remove=function(e){this.detach(e)},e.prototype.detach=function(e){var t=this._adjustIndex(e,-1);return Lu(this._lContainerNode,t),this._viewRefs.splice(t,1)[0]||null},e.prototype._adjustIndex=function(e,t){return void 0===t&&(t=0),null==e?this._lContainerNode.data.views.length+t:e},e}();function Tl(e){var t=e.node.data,n=e.node.view.tView;return e.templateRef||(e.templateRef=new Rl(function r(e){return e.elementRef||(e.elementRef=new El(0===e.node.type?null:e.node.native))}(e),t.template,function o(){return es}(),n.directiveRegistry,n.pipeRegistry))}var Rl=function(){function e(e,t,n,r,o){this._renderer=n,this._directives=r,this._pipes=o,this.elementRef=e,this._template=t}return e.prototype.createEmbeddedView=function(e){var t=Ns(null,this._template,e,this._renderer,this._directives,this._pipes);return pl(new dl(t,this._template,e))},e}();
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function Dl(t){var n=t.type,r=t.pipes,o=t.directives,i={type:n,diPublic:null,factory:t.factory,template:t.template||null,hostBindings:t.hostBindings||null,attributes:t.attributes||null,inputs:Sl(t.inputs),outputs:Sl(t.outputs),rendererType:Ao(t.rendererType)||null,exportAs:t.exportAs,onInit:n.prototype.ngOnInit||null,doCheck:n.prototype.ngDoCheck||null,afterContentInit:n.prototype.ngAfterContentInit||null,afterContentChecked:n.prototype.ngAfterContentChecked||null,afterViewInit:n.prototype.ngAfterViewInit||null,afterViewChecked:n.prototype.ngAfterViewChecked||null,onDestroy:n.prototype.ngOnDestroy||null,onPush:t.changeDetection===e.ChangeDetectionStrategy.OnPush,directiveDefs:o?function(){return("function"==typeof o?o():o).map(Ol)}:null,pipeDefs:r?function(){return("function"==typeof r?r():r).map(Al)}:null,selectors:t.selectors},a=t.features;return a&&a.forEach(function(e){return e(i)}),i}function Ol(e){return e.ngComponentDef||e.ngDirectiveDef}function Al(e){return e.ngPipeDef}var jl="__ngOnChanges_",Vl={};function Sl(e){if(null==e)return Vl;var t={};for(var n in e)t[e[n]]=n;return t}var Ml=Dl;function Fl(e,t,n){return tl(t)?nl(n?e.call(n,t):e(t)):el()}function Hl(e,t,n,r){return rl(t,n)?nl(r?e.call(r,t,n):e(t,n)):el()}function Ll(e,t,n,r,o){var i=rl(t,n);return tl(r)||i?nl(o?e.call(o,t,n,r):e(t,n,r)):el()}function Bl(e,t,n,r,o,i){return ol(t,n,r,o)?nl(i?e.call(i,t,n,r,o):e(t,n,r,o)):el()}function zl(e,t,n){for(var r=!1,o=0;o<t.length;o++)tl(t[o])&&(r=!0);return r?nl(e.apply(n,t)):el()}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function Ul(e){return il().data[e].pure}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var Ql=function(){function e(e){this.shallow=null,this.deep=null,this.deep=null==e?null:e}return e.prototype.track=function(e,t,n,r){n?this.deep=Yl(this.deep,e,t,null!=r?r:null):this.shallow=Yl(this.shallow,e,t,null!=r?r:null)},e.prototype.child=function(){return null===this.deep?null:null===this.shallow?this:new e(this.deep)},e.prototype.container=function(){for(var t=null,n=this.deep;n;){var r=[];n.values.push(r);var o={next:null,list:n.list,predicate:n.predicate,values:r};o.next=t,t=o,n=n.next}return t?new e(t):null},e.prototype.enterView=function(t){for(var n=null,r=this.deep;r;){var o=[];r.values.splice(t,0,o);var i={next:null,list:r.list,predicate:r.predicate,values:o};i.next=n,n=i,r=r.next}return n?new e(n):null},e.prototype.addNode=function(e){Wl(this.shallow,e),Wl(this.deep,e)},e.prototype.removeView=function(e){for(var t=this.deep;t;)t.values.splice(e,1)[0].length&&t.list.setDirty(),t=t.next},e}();function Zl(e,t){var n=e.localNames;if(n)for(var r=0;r<n.length;r+=2)if(n[r]===t)return n[r+1];return null}function ql(e,t){for(var n=e.view.tView.directives,r=e.tNode.flags,o=r>>13,i=o+(4095&r),a=o;a<i;a++){var u=n[a];if(u.type===t&&u.diPublic)return a}return null}function Kl(e,t,n,r){if(n instanceof Il)return n.read(e,t,r);var o=ql(t,n);return null!==o?t.view.directives[o]:null}function Wl(e,t){for(var n=ml(t);e;){var r=e.predicate,o=r.type;if(o)null!==(u=ql(t,o))&&null!==(s=Kl(n,t,r.read||o,u))&&Gl(e,s);else for(var i=r.selector,a=0;a<i.length;a++){var u,s;null!==(u=Zl(t.tNode,i[a]))&&null!==(s=Kl(n,t,r.read,u))&&Gl(e,s)}e=e.next}}function Gl(e,t){e.values.push(t),e.list.setDirty()}function Yl(e,t,n,r){return{next:e,list:t,predicate:function o(e,t){var n=Array.isArray(e);return{type:n?null:e,selector:n?e:null,read:t}}(n,r),values:t._valuesTree}}var $l=function(){function e(){this.dirty=!0,this.changes=new cn,this._values=[],this._valuesTree=[]}return Object.defineProperty(e.prototype,"length",{get:function(){return this._values.length},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"first",{get:function(){var e=this._values;return e.length?e[0]:null},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"last",{get:function(){var e=this._values;return e.length?e[e.length-1]:null},enumerable:!0,configurable:!0}),e.prototype.map=function(e){return this._values.map(e)},e.prototype.filter=function(e){return this._values.filter(e)},e.prototype.find=function(e){return this._values.find(e)},e.prototype.reduce=function(e,t){return this._values.reduce(e,t)},e.prototype.forEach=function(e){this._values.forEach(e)},e.prototype.some=function(e){return this._values.some(e)},e.prototype.toArray=function(){return this._values.slice(0)},e.prototype[U()]=function(){return this._values[U()]()},e.prototype.toString=function(){return this._values.toString()},e.prototype.reset=function(e){this._values=function t(e){for(var t=[],n=0;n<e.length;){var r=e[n];Array.isArray(r)?r.length>0?(e=r.concat(e.slice(n+1)),n=0):n++:(t.push(r),n++)}return t}(e),this.dirty=!1},e.prototype.notifyOnChanges=function(){this.changes.emit(this)},e.prototype.setDirty=function(){this.dirty=!0},e.prototype.destroy=function(){this.changes.complete(),this.changes.unsubscribe()},e}(),Jl="__SANITIZER_TRUSTED_BRAND__";function Xl(e,t){var n=new String(e);return n[Jl]=t,n}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */e.ɵangular_packages_core_core_j=Vr,e.ɵangular_packages_core_core_k=Sr,e.ɵangular_packages_core_core_l=Mr,e.ɵangular_packages_core_core_f=Nt,e.ɵangular_packages_core_core_g=Rr,e.ɵangular_packages_core_core_h=hr,e.ɵangular_packages_core_core_i=Cr,e.ɵangular_packages_core_core_c=dt,e.ɵangular_packages_core_core_d=et,e.ɵangular_packages_core_core_e=it,e.ɵangular_packages_core_core_m=rn,e.ɵangular_packages_core_core_o=Xt,e.ɵangular_packages_core_core_n=Jt,e.ɵangular_packages_core_core_r=nn,e.ɵangular_packages_core_core_p=en,e.ɵangular_packages_core_core_q=tn,e.ɵangular_packages_core_core_v=wl,e.ɵangular_packages_core_core_x=Nl,e.ɵangular_packages_core_core_w=bl,e.ɵangular_packages_core_core_u=yl,e.ɵangular_packages_core_core_y=Tl,e.ɵangular_packages_core_core_bb=tl,e.ɵangular_packages_core_core_bd=rl,e.ɵangular_packages_core_core_be=ol,e.ɵangular_packages_core_core_bc=nl,e.ɵangular_packages_core_core_ba=el,e.ɵangular_packages_core_core_z=gs,e.ɵangular_packages_core_core_a=y,e.ɵangular_packages_core_core_b=m,e.ɵangular_packages_core_core_s=qi,e.ɵangular_packages_core_core_t=Co,e.createPlatform=Nn,e.assertPlatform=Tn,e.destroyPlatform=function ec(){yn&&!yn.destroyed&&yn.destroy()},e.getPlatform=Rn,e.PlatformRef=Dn,e.ApplicationRef=An,e.enableProdMode=function tc(){if(xn)throw new Error("Cannot enable prod mode after platform setup.");Cn=!1},e.isDevMode=In,e.createPlatformFactory=Pn,e.NgProbeToken=En,e.APP_ID=Et,e.PACKAGE_ROOT_URL=At,e.PLATFORM_INITIALIZER=Rt,e.PLATFORM_ID=Dt,e.APP_BOOTSTRAP_LISTENER=Ot,e.APP_INITIALIZER=kt,e.ApplicationInitStatus=It,e.DebugElement=rr,e.DebugNode=nr,e.asNativeElements=function nc(e){return e.map(function(e){return e.nativeElement})},e.getDebugNode=ur,e.Testability=_n,e.TestabilityRegistry=wn,e.setTestabilityGetter=function rc(e){bn=e},e.TRANSLATIONS=Ar,e.TRANSLATIONS_FORMAT=jr,e.LOCALE_ID=Or,e.ApplicationModule=Fr,e.wtfCreateScope=an,e.wtfLeave=un,e.wtfStartTimeRange=sn,e.wtfEndTimeRange=ln,e.Type=V,e.EventEmitter=cn,e.ErrorHandler=qe,e.Sanitizer=ho,e.ANALYZE_FOR_ENTRY_COMPONENTS=C,e.Attribute=x,e.ContentChild=I,e.ContentChildren=k,e.Query=b,e.ViewChild=N,e.ViewChildren=E,e.Component=T,e.Directive=P,e.HostBinding=A,e.HostListener=j,e.Input=D,e.Output=O,e.Pipe=R,e.CUSTOM_ELEMENTS_SCHEMA={name:"custom-elements"},e.NO_ERRORS_SCHEMA={name:"no-errors-schema"},e.NgModule=Me,e.Version=Fe,e.VERSION=He,e.defineInjectable=l,e.defineInjector=c,e.forwardRef=X,e.resolveForwardRef=ee,e.Injectable=Se,e.inject=Pe,e.INJECTOR=le,e.Injector=de,e.ReflectiveInjector=ct,e.createInjector=function oc(e,t){return void 0===t&&(t=null),t=t||yt(),new mt(e,t)},e.ResolvedReflectiveFactory=rt,e.ReflectiveKey=$e,e.InjectionToken=d,e.Inject=te,e.Optional=ne,e.Self=re,e.SkipSelf=oe,e.Host=ie,e.NgZone=dn,e.RenderComponentType=Sn,e.Renderer=Fn,e.Renderer2=Bn,e.RendererFactory2=Ln,e.RootRenderer=Hn,e.COMPILER_OPTIONS=Ft,e.Compiler=Mt,e.CompilerFactory=Ht,e.ModuleWithComponentFactories=Vt,e.ComponentFactory=Bt,e.ComponentRef=Lt,e.ComponentFactoryResolver=Kt,e.ElementRef=zn,e.NgModuleFactory=$t,e.NgModuleRef=Yt,e.NgModuleFactoryLoader=Un,e.getModuleFactory=function ic(e){var t=Qn.get(e);if(!t)throw new Error("No module with ID "+e+" loaded");return t}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */,e.QueryList=Zn,e.SystemJsNgModuleLoader=Wn,e.SystemJsNgModuleLoaderConfig=qn,e.TemplateRef=$n,e.ViewContainerRef=Jn,e.EmbeddedViewRef=er,e.ViewRef=Xn,e.ChangeDetectorRef=Yn,e.DefaultIterableDiffer=gr,e.IterableDiffers=Ir,e.KeyValueDiffers=Er,e.SimpleChange=dr,e.WrappedValue=cr,e.platformCore=Dr,e.ɵALLOW_MULTIPLE_PLATFORMS=kn,e.ɵAPP_ID_RANDOM_PROVIDER=Pt,e.ɵdefaultIterableDiffers=Tr,e.ɵdevModeEqual=lr,e.ɵisListLikeIterable=fr,e.ɵisDefaultChangeDetectionStrategy=function ac(t){return null==t||t===e.ChangeDetectionStrategy.Default},e.ɵConsole=jt,e.ɵinject=Pe,e.ɵsetCurrentInjector=Ne,e.ɵAPP_ROOT=ft,e.ɵComponentFactory=Bt,e.ɵCodegenComponentFactoryResolver=Wt,e.ɵReflectionCapabilities=Y,e.ɵRenderDebugInfo=Mn,e.ɵ_sanitizeHtml=uo,e.ɵ_sanitizeStyle=po,e.ɵ_sanitizeUrl=zr,e.ɵglobal=L,e.ɵlooseIdentical=Z,e.ɵstringify=q,e.ɵmakeDecorator=v,e.ɵisObservable=function uc(e){return!!e&&"function"==typeof e.subscribe},e.ɵisPromise=xt,e.ɵclearOverrides=function sc(){return Sa(),xo.clearOverrides()},e.ɵoverrideComponentView=function lc(e,t){return Sa(),xo.overrideComponentView(e,t)},e.ɵoverrideProvider=
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
function cc(e){return Sa(),xo.overrideProvider(e)},e.ɵNOT_FOUND_CHECK_ONLY_ELEMENT_INJECTOR=ea,e.ɵdefineComponent=Dl,e.ɵdefineDirective=Ml,e.ɵdefinePipe=function dc(e){return{name:e.name,n:e.factory,pure:!1!==e.pure,onDestroy:e.type.prototype.ngOnDestroy||null}}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */,e.ɵdetectChanges=Ws,e.ɵrenderComponent=function fc(e,t){void 0===t&&(t={});var n,r=t.rendererFactory||Du,o=e.ngComponentDef;o.type!=e&&(o.type=e);var i=o.selectors[0][0],a=Ss(r,t.host||i),u={component:null,scheduler:t.scheduler||requestAnimationFrame.bind(window),clean:sl},s=ks(-1,r.createRenderer(a,o.rendererType),js(null,null),null,u,o.onPush?4:2);s.injector=t.injector||null;var l,c=_s(s,null);try{r.begin&&r.begin(),l=function d(e,t,n){!function r(){rs=!1,ns=null}();var o=Es(0,3,t,ks(-1,es,As(n.template,n.directiveDefs,n.pipeDefs),null,null,n.onPush?4:2));return ms&&(o.tNode=Ms(e,null,null),o.tNode.flags=4096,n.diPublic&&n.diPublic(n),vs.tView.directives=[n]),o}(i,a,o),n=u.component=Ls(0,o.factory(),o),Ds(l.nodeInjector,n,l.data),t.hostFeatures&&t.hostFeatures.forEach(function(e){return e(n,o)}),xs(),Cs(ll),Gs(l.data,l,o,n)}finally{ws(c),r.end&&r.end()}return n},e.ɵdirectiveInject=function pc(e,t){return void 0===t&&(t=0),bl(yl(),e,t)},e.ɵinjectTemplateRef=function hc(){return Tl(yl())},e.ɵinjectViewContainerRef=function vc(){return Nl(yl())},e.ɵinjectChangeDetectorRef=function gc(){return wl(yl(),null)},e.ɵinjectAttribute=function yc(e){var t=ls().tNode.attrs;if(t)for(var n=0;n<t.length;n+=2)if(t[n]==e)return t[n+1]},e.ɵPublicFeature=function mc(e){e.diPublic=_l},e.ɵNgOnChangesFeature=function _c(e){return function(n){var r=n.inputs,o=n.type.prototype;Object.defineProperty(o,jl,{value:void 0,writable:!0});var i=function(t){var n=r[t],i=e&&e[n]||t,a=jl+n;Object.defineProperty(o,a,{value:void 0,writable:!0});var u=Object.getOwnPropertyDescriptor(o,n);Object.defineProperty(o,n,{get:function(){return u&&u.get?u.get.call(this):this[a]},set:function(e){var t=this[jl],n=void 0===t;null==t&&(t=this[jl]={}),t[i]=new dr(this[a],e,n),u&&u.set?u.set.call(this,e):this[a]=e}})};for(var a in r)i(a);null!=n.onInit&&(n.onInit=t(n.onInit)),n.doCheck=t(n.doCheck)};function t(e){return function(){var t=this[jl];null!=t&&(this.ngOnChanges(t),this[jl]=null),e&&e.apply(this)}}},e.ɵmarkDirty=function wc(e){qs(ul(e).view)},e.ɵNC=Ys,e.ɵC=function bc(e,t,n,r,o){var i=Bs(rs?ns:ns.parent,vs,t),a=Es(e,0,void 0,i);Zs(vs,a.data),Ts(e,n||null,r,o,[]),rs=!1;var u=a.queries;u&&(u.addNode(a),i.queries=u.container())},e.ɵE=function Cc(e,t,n,r){var o=es.createElement(t),i=Es(e,3,o,null);return n&&Vs(o,n),Zu(i.parent,o,vs),Ts(e,t,n,r,null),o},e.ɵL=function xc(e,t,n){void 0===n&&(n=!1);var r=ns,o=r.native,i=hs||(hs=vs.cleanup=[]);if(Ru(es)){var a=function u(e,t){return function(n){return qs(e),t(n)}}(vs,t),s=es.listen(o,e,a);i.push(s,null)}else a=function l(e,t){return function n(r){qs(e),!1===t(r)&&(r.preventDefault(),r.returnValue=!1)}}(vs,t),o.addEventListener(e,a,n),i.push(e,o,a,n);var c=r.tNode;void 0===c.outputs&&(c.outputs=Fs(r.tNode.flags,1));var d,f=c.outputs;f&&(d=f[e])&&function p(e,t){for(var n=0;n<e.length;n+=2){var r=ps[e[n]][e[n+1]].subscribe(t);hs.push(r.unsubscribe,r)}}(d,t)},e.ɵT=function kc(e,t){var n=function r(e,t){return Ru(t)?t.createText(Au(e)):t.createTextNode(Au(e))}(t,es),o=Es(e,3,n);rs=!1,Zu(o.parent,n,vs)},e.ɵV=function Ic(e){var t=rs?ns:ns.parent,n=t.data,r=function o(e,t,n){for(var r=e.data.views,o=t;o<r.length;o++){var i=r[o].data.id;if(i===n)return r[o];if(!(i<n))break;Lu(e,o)}return null}(t,n.nextIndex,e);if(r)ns=r,rs=!0,_s(r.data,r);else{var i=ks(e,es,function a(e,t){var n=t.tNode.data;if(e>=n.length||null==n[e]){var r=vs.tView;n[e]=js(r.directiveRegistry,r.pipeRegistry)}return n[e]}(e,t),null,null,2);n.queries&&(i.queries=n.queries.enterView(n.nextIndex)),_s(i,r=Es(null,2,null,i))}return Ps(r.data)},e.ɵQ=function Ec(e,t,n,r){var o=new $l;return function i(e){return cs||(cs=new e)}(Ql).track(o,t,n,r),null!=e&&Js(e,o),o},e.ɵd=function Nc(e){return ps[e]},e.ɵP=function Pc(e,t,n,r){void 0===n&&(n=0);var o=Es(e,1,null,{head:null,tail:null});null==o.tNode&&(o.tNode=Ms(null,r||null,null)),rs=!1;for(var i=o.parent,a=Qs(vs).data.data[t][n],u=0;u<a.length;u++)if(1===(l=a[u]).type){var s=l.data;Us(o,s.head,s.tail)}else Us(o,l,l);if(Qu(i,vs))for(var l=o.data.head,c=o.data.tail;l;)qu(l,i,vs),l=l===c?null:l.pNextOrParent},e.ɵb=function Tc(e){if(vs.bindingStartIndex<0)return $s(),fs[vs.bindingIndex++]=e;var t=e!==Ys&&Ou(fs[vs.bindingIndex],e);return t&&(Xu(ds,ys,fs[vs.bindingIndex],e),fs[vs.bindingIndex]=e),vs.bindingIndex++,t?e:Ys},e.ɵi1=function Rc(e,t,n){return tl(t)?e+Au(t)+n:Ys},e.ɵi2=function Dc(e,t,n,r,o){return rl(t,r)?e+Au(t)+n+Au(r)+o:Ys},e.ɵi3=function Oc(e,t,n,r,o,i,a){var u=rl(t,r);return(u=tl(i)||u)?e+Au(t)+n+Au(r)+o+Au(i)+a:Ys},e.ɵi4=function Ac(e,t,n,r,o,i,a,u,s){return ol(t,r,i,u)?e+Au(t)+n+Au(r)+o+Au(i)+a+Au(u)+s:Ys},e.ɵi5=function jc(e,t,n,r,o,i,a,u,s,l,c){var d=ol(t,r,i,u);return(d=tl(l)||d)?e+Au(t)+n+Au(r)+o+Au(i)+a+Au(u)+s+Au(l)+c:Ys},e.ɵi6=function Vc(e,t,n,r,o,i,a,u,s,l,c,d,f){var p=ol(t,r,i,u);return(p=rl(l,d)||p)?e+Au(t)+n+Au(r)+o+Au(i)+a+Au(u)+s+Au(l)+c+Au(d)+f:Ys},e.ɵi7=function Sc(e,t,n,r,o,i,a,u,s,l,c,d,f,p,h){var v=ol(t,r,i,u);return v=rl(l,d)||v,(v=tl(p)||v)?e+Au(t)+n+Au(r)+o+Au(i)+a+Au(u)+s+Au(l)+c+Au(d)+f+Au(p)+h:Ys},e.ɵi8=function Mc(e,t,n,r,o,i,a,u,s,l,c,d,f,p,h,v,g){var y=ol(t,r,i,u);return(y=ol(l,d,p,v)||y)?e+Au(t)+n+Au(r)+o+Au(i)+a+Au(u)+s+Au(l)+c+Au(d)+f+Au(p)+h+Au(v)+g:Ys},e.ɵiV=function Fc(e){for(var t=!1,n=1;n<e.length;n+=2)tl(e[n])&&(t=!0);if(!t)return Ys;var r=e[0];for(n=1;n<e.length;n+=2)r+=Au(e[n])+e[n+1];return r},e.ɵpb1=function Hc(e,t){var n=Xs(e);return Ul(e)?Fl(n.transform,t,n):n.transform(t)},e.ɵpb2=function Lc(e,t,n){var r=Xs(e);return Ul(e)?Hl(r.transform,t,n,r):r.transform(t,n)},e.ɵpb3=function Bc(e,t,n,r){var o=Xs(e);return Ul(e)?Ll(o.transform.bind(o),t,n,r):o.transform(t,n,r)},e.ɵpb4=function zc(e,t,n,r,o){var i=Xs(e);return Ul(e)?Bl(i.transform,t,n,r,o,i):i.transform(t,n,r,o)},e.ɵpbV=function Uc(e,t){var n=Xs(e);return Ul(e)?zl(n.transform,t,n):n.transform.apply(n,t)},e.ɵf0=function Qc(e,t){return gs()?nl(t?e.call(t):e()):el()},e.ɵf1=Fl,e.ɵf2=Hl,e.ɵf3=Ll,e.ɵf4=Bl,e.ɵf5=function Zc(e,t,n,r,o,i,a){var u=ol(t,n,r,o);return tl(i)||u?nl(a?e.call(a,t,n,r,o,i):e(t,n,r,o,i)):el()},e.ɵf6=function qc(e,t,n,r,o,i,a,u){var s=ol(t,n,r,o);return rl(i,a)||s?nl(u?e.call(u,t,n,r,o,i,a):e(t,n,r,o,i,a)):el()},e.ɵf7=function Kc(e,t,n,r,o,i,a,u,s){var l=ol(t,n,r,o);return l=rl(i,a)||l,tl(u)||l?nl(s?e.call(s,t,n,r,o,i,a,u):e(t,n,r,o,i,a,u)):el()},e.ɵf8=function Wc(e,t,n,r,o,i,a,u,s,l){var c=ol(t,n,r,o);return ol(i,a,u,s)||c?nl(l?e.call(l,t,n,r,o,i,a,u,s):e(t,n,r,o,i,a,u,s)):el()},e.ɵfV=zl,e.ɵcR=function Gc(e){rs=!0,(ns=fs[e]).data.nextIndex=0,ys||Iu(vs,vs.tView,ds)},e.ɵcr=function Yc(){rs?rs=!1:ns=ns.parent;var e=ns;e.native=void 0;for(var t=e.data.nextIndex;t<e.data.views.length;)Lu(e,t)},e.ɵqR=function $c(e){return!!e.dirty&&(e.reset(e._valuesTree),e.notifyOnChanges(),!0)}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */,e.ɵe=function Jc(){rs?rs=!1:ns=ns.parent;var e=ns.queries;e&&e.addNode(ns),function t(e,n){var r=n.tView;if(!0===r.firstTemplatePass)for(var o=e>>13,i=o+(4095&e),a=o;a<i;a++){var u=r.directives[a];Cu(u,r,a),xu(u,r,a),ku(u,r,a)}}(ns.tNode.flags,vs)},e.ɵp=function Xc(e,t,n,r){if(n!==Ys){var o=fs[e],i=o.tNode;i&&void 0===i.inputs&&(i.inputs=Fs(o.tNode.flags,0));var a,u=i&&i.inputs;if(u&&(a=u[t]))!function s(e,t){for(var n=0;n<e.length;n+=2)ps[e[n]][e[n+1]]=t}(a,n),function l(e){!e.data||2&e.data.flags||(e.data.flags|=4)}(o);else{n=null!=r?r(n):n;var c=o.native;Ru(es)?es.setProperty(c,t,n):c.setProperty?c.setProperty(t,n):c[t]=n}}},e.ɵpD=function ed(e,t,n){for(var r=t?t.length+1:1,o=new Array(r),i=0;i<r;i++)o[i]=[];for(var a=Qs(vs).child;null!==a;)t&&a.tNode?o[$u(a.tNode,t,n)].push(a):o[0].push(a),a=a.next;fs[e]=o},e.ɵa=function td(e,t,n,r){if(n!==Ys){var o=fs[e];if(null==n)Ru(es)?es.removeAttribute(o.native,t):o.native.removeAttribute(t);else{var i=null==r?Au(n):r(n);Ru(es)?es.setAttribute(o.native,t,i):o.native.setAttribute(t,i)}}},e.ɵs=function nd(e,t){if(t!==Ys){var n=fs[e];if(Ru(es))es.setProperty(n.native,"style",t);else for(var r=n.native.style,o=0,i=Object.keys(t);o<i.length;o++){var a=i[o],u=t[a];null==u?r.removeProperty(a):r.setProperty(a,u)}}},e.ɵsn=function rd(e,t,n,r){if(n!==Ys){var o=fs[e];if(null==n)Ru(es)?es.removeStyle(o.native,t,Pu.DashCase):o.native.style.removeProperty(t);else{var i="function"==typeof r?r(n):Au(n);"string"==typeof r&&(i+=r),Ru(es)?es.setStyle(o.native,t,i,Pu.DashCase):o.native.style.setProperty(t,i)}}},e.ɵk=function od(e,t){if(t!==Ys){var n=fs[e];Ru(es)?es.setProperty(n.native,"className",t):n.native.className=Au(t)}},e.ɵkn=function id(e,t,n){if(n!==Ys){var r=fs[e];n?Ru(es)?es.addClass(r.native,t):r.native.classList.add(t):Ru(es)?es.removeClass(r.native,t):r.native.classList.remove(t)}},e.ɵt=function ad(e,t){var n=fs[e];t!==Ys&&(Ru(es)?es.setValue(n.native,Au(t)):n.native.textContent=Au(t))},e.ɵv=function ud(){bs(),rs=!1;var e=ns=vs.node,t=ns.parent;if(t){var n=t.data;ds&&(function r(e,t){if(null!=e)for(var n=t.child;n;){if(1===n.type)for(var r=n.data.head,o=n.data.tail;r;)r.dynamicLContainerNode&&(r.dynamicLContainerNode.data.renderParent=e),r=r===o?null:r.pNextOrParent;n=n.next}}(n.renderParent,e),Hu(t,e,n.nextIndex)),n.nextIndex++}ws(vs.parent)},e.ɵst=Js,e.ɵld=Xs,e.ɵPp=function sd(e,t){var n,r=il();r.firstTemplatePass?(n=function o(e,t){if(t)for(var n=0;n<t.length;n++){var r=t[n];if(e===r.name)return r}throw new Error("Pipe with name '"+e+"' not found!")}(t,r.pipeRegistry),r.data[e]=n,n.onDestroy&&(r.pipeDestroyHooks||(r.pipeDestroyHooks=[])).push(e,n.onDestroy)):n=r.data[e];var i=n.n();return Js(e,i),i},e.ɵwhenRendered=function ld(e){return function t(e){return Ks(e).context}(e).clean},e.ɵbypassSanitizationTrustHtml=function cd(e){return Xl(e,"Html")},e.ɵbypassSanitizationTrustStyle=function dd(e){return Xl(e,"Style")},e.ɵbypassSanitizationTrustScript=function fd(e){return Xl(e,"Script")},e.ɵbypassSanitizationTrustUrl=function pd(e){return Xl(e,"Url")},e.ɵbypassSanitizationTrustResourceUrl=function hd(e){return Xl(e,"ResourceUrl")},e.ɵsanitizeHtml=function vd(e){return e instanceof String&&"Html"===e[Jl]?e.toString():uo(document,Au(e))},e.ɵsanitizeStyle=function gd(e){return e instanceof String&&"Style"===e[Jl]?e.toString():po(Au(e))},e.ɵsanitizeUrl=function yd(e){return e instanceof String&&"Url"===e[Jl]?e.toString():zr(Au(e))},e.ɵsanitizeResourceUrl=function md(e){if(e instanceof String&&"ResourceUrl"===e[Jl])return e.toString();throw new Error("unsafe value used in a resource URL context (see http://g.co/ng/security#xss)")},e.ɵregisterModuleFactory=function _d(e,t){var n=Qn.get(e);if(n)throw new Error("Duplicate module registered for "+e+" - "+n.moduleType.name+" vs "+t.moduleType.name);Qn.set(e,t)},e.ɵEMPTY_ARRAY=[],e.ɵEMPTY_MAP={},e.ɵand=
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
