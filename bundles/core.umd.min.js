 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var Re={},De=function Oe(e,t){for(var n in e)if(e[n]===t)return n;throw Error("Could not find renamed property on target object.")}({provide:String,useValue:Re},Re),Ae=[];function je(e,t){if(!t){var n=(l=new G).parameters(e);return function(){return new(e.bind.apply(e,u([void 0],Te(n))))}}if(De in t){var r=t;return function(){return r.useValue}}if(t.useExisting){var o=t;return function(){return Pe(o.useExisting)}}if(t.useFactory){var i=t;return function(){return i.useFactory.apply(i,u(Te(i.deps||Ae)))}}if(t.useClass){var a=t,s=t.deps;if(!s){var l=new G;s=l.parameters(e)}return function(){return new((e=a.useClass).bind.apply(e,u([void 0],Te(s))));var e}}var c=t.deps;return c||(l=new G,c=l.parameters(e)),function(){return new(e.bind.apply(e,u([void 0],Te(c))))}}var Ve,Se=v("Injectable",void 0,void 0,void 0,function(e,t){return function n(e,t){t&&void 0!==t.providedIn&&void 0===e.ngInjectableDef&&(e.ngInjectableDef=l({providedIn:t.providedIn,factory:je(e,t)}))}(e,t)}),Me=v("NgModule",function(e){return e},void 0,void 0,function(e,t){return function n(e,t){var n=t&&t.imports||[];t&&t.exports&&(n=u(n,[t.exports])),e.ngInjectorDef=c({factory:je(e,{useClass:e}),providers:t&&t.providers,imports:n})}(e,t)});
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
var Fe,He=new(Fe=function Fe(e){this.full=e,this.major=e.split(".")[0],this.minor=e.split(".")[1],this.patch=e.split(".").slice(2).join(".")})("6.0.0-rc.5+216.sha-13cb75d"),Le="ngDebugContext",Be="ngOriginalError",ze="ngErrorLogger";function Ue(e){return e[Le]}function Qe(e){return e[Be]}function Ze(e){for(var t=[],n=1;n<arguments.length;n++)t[n-1]=arguments[n];e.error.apply(e,u(t))}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
function js(e,t){for(var n=e;n&&n!==t;){var r=n.pNextOrParent;if(r){for(;1!==r.type;){if(i=Fs(r))return i;r=r.pNextOrParent}n=r}else{for(var o=Vs(n);o;){var i;if(i=Fs(o))return i;o=Vs(o)}var a=n.parent;if(n=null,a){var s=a.type;0!==s&&2!==s||(n=a)}}}return null}function Vs(e){if(2===e.type){var t=e.data;return t.next?t.next.node:null}return e.tNode.next?e.view.data[e.tNode.next.index]:null}function Ss(e){var t=e.pNextOrParent;return t?1===t.type?null:t:Vs(e)}function Ms(e,t){for(var n=e,r=Ss(n);n&&!r;){if((n=n.pNextOrParent||n.parent)===t)return null;r=n&&Ss(n)}return r}function Fs(e){for(var t=e;t;){var n=null;if(3===t.type)return t.native;if(0===t.type){var r=t.dynamicLContainerNode?t.dynamicLContainerNode.data:t.data;n=r.views.length?r.views[0].child:null}else n=1===t.type?t.data.head:t.child;t=null===n?Ms(t,e):n}return null}function Hs(e,t,n,r){var o=e.data.renderParent,i=o?o.native:null,a=t.child;if(i)for(;a;){var s=null,u=e.view.renderer;if(3===a.type)n?Rs(u)?u.insertBefore(i,a.native,r):i.insertBefore(a.native,r,!0):Rs(u)?u.removeChild(i,a.native):i.removeChild(a.native),s=Vs(a);else if(0===a.type){var l=a.data;l.renderParent=o,s=l.views.length?l.views[0].child:null}else s=1===a.type?a.data.head:a.child;a=null===s?Ms(a,t):s}}function Ls(e,t,n){var r=e.data.views;if(n>0&&(r[n-1].data.next=t.data),n<r.length?(t.data.next=r[n].data,r.splice(n,0,t)):(r.push(t),t.data.next=null),null!==e.data.renderParent){var o=js(t,e);if(!o){var i=e.native;void 0===i&&(i=e.native=js(e,null)),o=i}Hs(e,t,!0,o)}return t}function Bs(e,t){var n=e.data.views,r=n[t];return t>0&&(n[t-1].data.next=r.data.next),n.splice(t,1),function o(e){if(!e.child)return Us(e);for(var t=e.child;t;){var n=null;if(t.views&&t.views.length?n=t.views[0].data:t.child?n=t.child:t.next&&(Us(t),n=t.next),null==n){for(;t&&!t.next&&t!==e;)Us(t),t=zs(t,e);Us(t||e),n=t&&t.next}t=n}}(r.data),Hs(e,r,!1),e.data.queries&&e.data.queries.removeView(t),r}function zs(e,t){var n;return(n=e.node)&&2===n.type?n.parent.data:e.parent===t?null:e.parent}function Us(e){!function t(e){var t=e.cleanup;if(null!=t){for(var n=0;n<t.length-1;n+=2)"string"==typeof t[n]?(t[n+1].removeEventListener(t[n],t[n+2],t[n+3]),n+=2):t[n].call(t[n+1]);e.cleanup=null}}(e),function n(e){var t,n=e.tView;null!=n&&null!=(t=n.destroyHooks)&&Ns(e.directives,t)}(e),function r(e){var t=e.tView&&e.tView.pipeDestroyHooks;t&&Ns(e.data,t)}(e)}function Qs(e,t){return 3===e.type&&(e.view!==t||null===e.data)}function Zs(e,t,n){if(null!==t&&Qs(e,n)){var r=n.renderer;return Rs(r)?r.appendChild(e.native,t):e.native.appendChild(t),!0}return!1}function qs(e,t,n){if(0!==e.type)Zs(t,e.native,n);else{var r=e.data;r.renderParent=t;for(var o=r.views,i=0;i<o.length;i++)Hs(e,o[i],!0,null)}e.dynamicLContainerNode&&(e.dynamicLContainerNode.data.renderParent=t)}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function Ks(e,t){for(var n,r,o,i,a,s=4,u=e.attrs,l=!1,c=0;c<t.length;c++){var d=t[c];if("number"!=typeof d){if(!l)if(4&s){if(s=2|1&s,""!==d&&d!==e.tagName){if(Ws(s))return!1;l=!0}}else{var f=Ys(8&s?"class":d,u);if(-1===f){if(Ws(s))return!1;l=!0;continue}var p=8&s?d:t[++c];if(""!==p){var h=u[f+1];if(8&s&&(o=(n=h).length,a=(i=n.indexOf(r=p))+r.length,-1===i||i>0&&" "!==n[i-1]||a<o&&" "!==n[a])||2&s&&p!==h){if(Ws(s))return!1;l=!0}}}}else{if(!l&&!Ws(s)&&!Ws(d))return!1;if(l&&Ws(d))continue;l=!1,s=d|1&s}}return Ws(s)||l}function Ws(e){return 0==(1&e)}function Ys(e,t){if(null===t)return-1;for(var n=0;n<t.length;n+=2)if(t[n]===e)return n;return-1}function Gs(e,t){for(var n=0;n<t.length;n++)if(Ks(e,t[n]))return!0;return!1}function $s(e,t,n){for(var r=function o(e){var t=e.attrs;if(null!=t){var n=t.indexOf(Ts);if(0==(1&n))return t[n+1]}return null}(e),i=0;i<t.length;i++)if(r===n[i]||null===r&&Gs(e,t[i]))return i+1;return 0}function Js(e){throw new Error("Multiple components match node with tagname "+e.tagName)}function Xs(e,t,n,r){if(t){var o="ExpressionChangedAfterItHasBeenCheckedError: Expression has changed after it was checked. Previous value: '"+n+"'. Current value: '"+r+"'.";throw e&&(o+=" It seems like the view has been created after its parent and its children have been dirty checked. Has it been created in a change detection hook ?"),new Error(o)}}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var eu,tu,nu,ru,ou,iu="__ngHostLNode__",au=Promise.resolve(null),su=[0,0],uu="__CIRCULAR__";function lu(){return gu&&gu.sanitizer}function cu(){return nu}var du,fu,pu,hu,vu,gu=null;function yu(){return fu}var mu=!1,_u=!0;function wu(e,t){var n=gu;return pu=e&&e.data,hu=e&&e.directives,ou=e&&e.tView.data,fu=e&&1==(1&e.flags),_u=e&&e.tView.firstTemplatePass,vu=e&&e.cleanup,eu=e&&e.renderer,e&&e.bindingIndex<0&&(e.bindingIndex=e.bindingStartIndex),null!=t&&(nu=t,ru=!0),gu=e,du=e&&e.queries,n}function bu(e,t){t||(mu||Es(hu,gu.tView.viewHooks,gu.tView.viewCheckHooks,fu),gu.flags&=-6),gu.lifecycleStage=1,gu.bindingIndex=-1,wu(e,null)}function Cu(){var e=gu.tView;mu||Is(gu,e,fu),function t(){for(var e=gu.child;null!==e;e=e.next)if(0!==e.dynamicViewCount&&e.views)for(var t=e,n=0;n<t.views.length;n++){var r=t.views[n],o=r.data;Pu(r,o.tView,o.template,o.context,eu)}}(),mu||Es(hu,e.contentHooks,e.contentCheckHooks,fu),e.firstTemplatePass=_u=!1,xu(e.hostBindings),function n(e){if(null!=e)for(var t=0;t<e.length;t+=2)zu(e[t],e[t+1])}(e.components)}function xu(e){if(null!=e)for(var t=gu.tView.directives,n=0;n<e.length;n+=2){var r=e[n],o=t[r];o.hostBindings&&o.hostBindings(r,e[n+1])}}function ku(){if(!mu){var e=gu.tView;Is(gu,e,fu),Es(hu,e.contentHooks,e.contentCheckHooks,fu)}}function Iu(e,t,n,r,o,i,a){return{parent:gu,id:e,flags:9|i,node:null,data:[],directives:null,tView:n,cleanup:null,renderer:t,child:null,tail:null,next:null,bindingStartIndex:-1,bindingIndex:-1,template:r,context:o,dynamicViewCount:0,lifecycleStage:1,queries:null,injector:gu&&gu.injector,sanitizer:a||null}}function Eu(e,t,n,r,o,i){return{type:e,native:r,view:t,parent:n,child:null,nodeInjector:n?n.nodeInjector:null,data:o,queries:i,tNode:null,pNextOrParent:null,dynamicLContainerNode:null}}function Nu(e,t,n,r,o,i){var a=ru?nu:nu&&nu.parent,s=(ru?du:nu&&nu.queries)||a&&a.queries&&a.queries.child(),u=null!=i,l=Eu(t,gu,a,n,u?i:null,s);if(2==(2&t)&&u&&(i.node=l),null!=e){if(pu[e]=l,e>=ou.length){var c=ou[e]=function d(e,t,n,r){return{index:e,flags:0,tagName:t,attrs:n,localNames:null,initialInputs:void 0,inputs:void 0,outputs:void 0,tViews:r,next:null}}(e,r,o,null);!ru&&nu&&(nu.tNode.next=c)}l.tNode=ou[e],ru&&(du=null,nu.view!==gu&&2!==nu.type||(nu.child=l))}return nu=l,ru=!0,l}function Pu(e,t,n,r,o,i,a){var s,u=ru,l=nu,c=2;try{ru=!0,nu=null,null==e&&(e=Nu(null,2,null,null,null,Iu(-1,o,t,n,r,2,lu())),c=1),s=wu(e.data,e),n(c,r),2&c?Cu():e.data.tView.firstTemplatePass=_u=!1}finally{bu(s,1==(1&c)),ru=u,nu=l}return e}function Tu(e){return 1&e.flags?3:2}function Ru(e,t,n,r,o){_u?function i(e,t,n){var r=n?{"":-1}:null,o=t.currentMatches=function i(e){var t=gu.tView.directiveRegistry,n=null;if(t)for(var r=0;r<t.length;r++){var o=t[r];Gs(e,o.selectors)&&(o.template&&(4096&e.flags&&Js(e),e.flags=4096),o.diPublic&&o.diPublic(o),(n||(n=[])).push(o,null))}return n}(e);if(o)for(var a=0;a<o.length;a+=2){var s=o[a],u=a+1;Du(s,u,o,t),Au(o[u],s,r)}r&&function l(e,t,n){if(t)for(var r=e.localNames=[],o=0;o<t.length;o+=2){var i=n[t[o+1]];if(null==i)throw new Error("Export of name '"+t[o+1]+"' not found!");r.push(t[o],i)}}(e,n,r)}(nu.tNode,gu.tView,r||null):function a(){var e=nu.tNode,t=4095&e.flags;if(t>0)for(var n=e.flags>>13,r=n+t,o=gu.tView.directives,i=n;i<r;i++){var a=o[i];Hu(i,a.factory(),a)}}(),function s(){var e=nu.tNode.localNames;if(e)for(var t=0;t<e.length;t+=2){var n=e[t+1];pu.push(-1===n?nu.native:hu[n])}}()}function Du(e,t,n,r){if(null===n[t]){n[t]=uu;var o=e.factory();return(r.directives||(r.directives=[])).push(e),Hu(n[t]=r.directives.length-1,o,e)}return n[t]===uu&&function i(e){throw new Error("Cannot instantiate cyclic dependency! "+e)}(e.type),null}function Ou(e,t,n){e&&null!=e.changeDetectorRef&&e.changeDetectorRef._setComponentContext(n,t)}function Au(e,t,n){n&&(t.exportAs&&(n[t.exportAs]=e),t.template&&(n[""]=e))}function ju(e,t,n){return e.ngPrivateData||(e.ngPrivateData=Vu(t,n))}function Vu(e,t){return{data:[],directives:null,firstTemplatePass:!0,initHooks:null,checkHooks:null,contentHooks:null,contentCheckHooks:null,viewHooks:null,viewCheckHooks:null,destroyHooks:null,pipeDestroyHooks:null,hostBindings:null,components:null,directiveRegistry:"function"==typeof e?e():e,pipeRegistry:"function"==typeof t?t():t,currentMatches:null}}function Su(e,t){for(var n=Rs(eu),r=0;r<t.length;r+=2){var o=t[r];if(o!==Ts){var i=t[r+1];n?eu.setAttribute(e,o,i):e.setAttribute(o,i)}}}function Mu(e,t){tu=e;var n=e.createRenderer(null,null);return"string"==typeof t?Rs(n)?n.selectRootElement(t):n.querySelector(t):t}function Fu(e,t){var n=4095&e,r=null;if(n>0)for(var o=e>>13,i=o+n,a=0===t,s=gu.tView.directives,u=o;u<i;u++){var l=s[u],c=a?l.inputs:l.outputs;for(var d in c)if(c.hasOwnProperty(d)){var f=c[d];(r=r||{}).hasOwnProperty(d)?r[d].push(u,f):r[d]=[u,f]}}return r}function Hu(e,t,n){var r=Lu(e,t,n),o=nu.tNode;return n.template&&function i(e,t,n){var r=ju(n.template,n.directiveDefs,n.pipeDefs),o=Zu(gu,Iu(-1,tu.createRenderer(nu.native,n.rendererType),r,null,null,n.onPush?4:2,lu()));nu.data=o,o.node=nu,Ou(nu.nodeInjector,t,o),_u&&function i(e){_u&&(gu.tView.components||(gu.tView.components=[])).push(e,pu.length-1)}(e)}(e,t,n),_u&&(
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
function a(e,t,n,r){t&&(r.initHooks||(r.initHooks=[])).push(e,t),n&&((r.initHooks||(r.initHooks=[])).push(e,n),(r.checkHooks||(r.checkHooks=[])).push(e,n))}(e,n.onInit,n.doCheck,gu.tView),n.hostBindings&&function s(e){(gu.tView.hostBindings||(gu.tView.hostBindings=[])).push(e,pu.length-1)}(e)),o&&o.attrs&&function u(e,t,n,r){var o=r.initialInputs;(void 0===o||e>=o.length)&&(o=function i(e,t,n){var r=n.initialInputs||(n.initialInputs=[]);r[e]=null;for(var o=n.attrs,i=0;i<o.length;i+=2){var a=t[o[i]];void 0!==a&&(r[e]||(r[e]=[])).push(a,o[i+1])}return r}(e,n,r));var a=o[e];if(a)for(var s=0;s<a.length;s+=2)t[a[s]]=a[s+1]}(e,r,n.inputs,o),r}function Lu(e,t,n){if(Object.defineProperty(t,iu,{enumerable:!1,value:nu}),null==hu&&(gu.directives=hu=[]),hu[e]=t,_u){var r=nu.tNode.flags;0==(4095&r)?nu.tNode.flags=e<<13|4096&r|1:nu.tNode.flags++}else{var o=n.diPublic;o&&o(n)}return null!=n.attributes&&3==nu.type&&Su(nu.native,n.attributes),t}function Bu(e,t,n){return{views:[],nextIndex:0,renderParent:Qs(e,t)?e:null,template:null==n?null:n,next:null,parent:t,dynamicViewCount:0,queries:null}}function zu(e,t){var n=pu[t],r=n.data;(function o(e){return 8==(8&e.flags)})(r)&&6&r.flags&&Yu(r,n,gu.tView.directives[e],al(hu[e]))}function Uu(e,t,n){if(n){var r=e.data;r.tail?r.tail.pNextOrParent=t:r.head=t,r.tail=n,n.pNextOrParent=e}}function Qu(e){for(var t=e.node;2===t.type;)t=(e=e.parent).node;return t}function Zu(e,t){return e.tail?e.tail.next=t:e.child=t,e.tail=t,t}function qu(e){for(var t=e;null!=t.parent;)t.flags|=4,t=t.parent;t.flags|=4,function n(e){var t;e.clean==au&&(e.clean=new Promise(function(e){return t=e}),e.scheduler(function(){!function n(e){var t=Ku(e),n=t.context.component;!function r(e,t,n,o){var i=wu(t,e);try{tu.begin&&tu.begin(),o?(o(Tu(t),n),Cu()):(ku(),xu(su),zu(0,0))}finally{tu.end&&tu.end(),bu(i)}}(sl(n),t,n)}(e.component),t(null),e.clean=au}))}(t.context)}function Ku(e){for(var t=sl(e).view;t.parent;)t=t.parent;return t}function Wu(e){var t=sl(e);Yu(t.data,t,t.view.tView.directives[t.tNode.flags>>13],e)}function Yu(e,t,n,r){var o=wu(e,t),i=n.template;try{i(Tu(e),r),Cu()}finally{bu(o)}}var Gu={};function $u(){gu.bindingIndex=gu.bindingStartIndex=pu.length}function Ju(e,t){e>=ou.length&&(ou[e]=null),pu[e]=t}function Xu(e){return pu[e]}function el(){return pu[gu.bindingIndex++]}function tl(e){if(gu.bindingStartIndex<0)$u();else{if(!Os(pu[gu.bindingIndex],e))return gu.bindingIndex++,!1;Xs(fu,mu,pu[gu.bindingIndex],e)}return pu[gu.bindingIndex++]=e,!0}function nl(e){return tl(e),e}function rl(e,t){var n=tl(e);return tl(t)||n}function ol(e,t,n,r){var o=rl(e,t);return rl(n,r)||o}function il(){return gu.tView}function al(e){return Array.isArray(e)?e[0]:e}function sl(e){return e[iu]}var ul=au,ll=su,cl=function(){function e(e,t){this._view=e,this.context=t}return e.prototype._setComponentContext=function(e,t){this._view=e,this.context=t},e.prototype.destroy=function(){},e.prototype.onDestroy=function(e){},e.prototype.markForCheck=function(){qu(this._view)},e.prototype.detach=function(){this._view.flags&=-9},e.prototype.reattach=function(){this._view.flags|=8},e.prototype.detectChanges=function(){Wu(this.context)},e.prototype.checkNoChanges=function(){!function e(t){mu=!0;try{Wu(t)}finally{mu=!1}}(this.context)},e}(),dl=function(e){function t(t,n,r){var o=e.call(this,t.data,r)||this;return o._lViewNode=t,o}return o(t,e),t}(cl);function fl(e,t){return pl(new cl(e,t))}function pl(e){var t=null;return e.destroyed=!1,e.destroy=function(){t&&t.forEach(function(e){return e()}),this.destroyed=!0},e.onDestroy=function(e){return(t||(t=[])).push(e)},e}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */,e.ɵdetectChanges=Wu,e.ɵrenderComponent=function fc(e,t){void 0===t&&(t={});var n,r=t.rendererFactory||Ds,o=t.sanitizer||null,i=e.ngComponentDef;i.type!=e&&(i.type=e);var a=Mu(r,t.host||i.selectors[0][0]),s={component:null,scheduler:t.scheduler||requestAnimationFrame.bind(window),clean:ul},u=Iu(-1,r.createRenderer(a,i.rendererType),Vu(null,null),null,s,i.onPush?4:2);u.injector=t.injector||null;var l,c=wu(u,null);try{r.begin&&r.begin(),l=function d(e,t,n,r){!function o(){ru=!1,nu=null}();var i=Nu(0,3,t,null,null,Iu(-1,eu,ju(n.template,n.directiveDefs,n.pipeDefs),null,null,n.onPush?4:2,r));return _u&&(i.tNode.flags=4096,n.diPublic&&n.diPublic(n),gu.tView.directives=[n]),i}(0,a,i,o),n=s.component=Lu(0,i.factory(),i),Ou(l.nodeInjector,n,l.data),t.hostFeatures&&t.hostFeatures.forEach(function(e){return e(n,i)}),ku(),xu(ll),Yu(l.data,l,i,n)}finally{bu(c),r.end&&r.end()}return n},e.ɵdirectiveInject=function pc(e,t){return void 0===t&&(t=0),bl(yl(),e,t)},e.ɵinjectTemplateRef=function hc(){return Tl(yl())},e.ɵinjectViewContainerRef=function vc(){return Nl(yl())},e.ɵinjectChangeDetectorRef=function gc(){return wl(yl(),null)},e.ɵinjectAttribute=function yc(e){var t=cu().tNode.attrs;if(t)for(var n=0;n<t.length;n+=2)if(t[n]==e)return t[n+1]},e.ɵPublicFeature=function mc(e){e.diPublic=_l},e.ɵNgOnChangesFeature=function _c(e){return function(n){var r=n.inputs,o=n.type.prototype;Object.defineProperty(o,jl,{value:void 0,writable:!0});var i=function(t){var n=r[t],i=e&&e[n]||t,a=jl+n;Object.defineProperty(o,a,{value:void 0,writable:!0});var s=Object.getOwnPropertyDescriptor(o,n);Object.defineProperty(o,n,{get:function(){return s&&s.get?s.get.call(this):this[a]},set:function(e){var t=this[jl],n=void 0===t;null==t&&(t=this[jl]={}),t[i]=new dr(this[a],e,n),s&&s.set?s.set.call(this,e):this[a]=e}})};for(var a in r)i(a);null!=n.onInit&&(n.onInit=t(n.onInit)),n.doCheck=t(n.doCheck)};function t(e){return function(){var t=this[jl];null!=t&&(this.ngOnChanges(t),this[jl]=null),e&&e.apply(this)}}},e.ɵmarkDirty=function wc(e){qu(sl(e).view)},e.ɵNC=Gu,e.ɵC=function bc(e,t,n,r,o){var i=Bu(ru?nu:nu.parent,gu,t),a=Nu(e,0,void 0,n||null,r||null,i);_u&&null==t&&(a.tNode.tViews=[]),Zu(gu,a.data),Ru(0,0,0,o),ru=!1;var s=a.queries;s&&(s.addNode(a),i.queries=s.container())},e.ɵE=function Cc(e,t,n,r){var o=eu.createElement(t),i=Nu(e,3,o,t,n||null,null);return n&&Su(o,n),Zs(i.parent,o,gu),Ru(0,0,0,r),o},e.ɵL=function xc(e,t,n){void 0===n&&(n=!1);var r=nu,o=r.native,i=vu||(vu=gu.cleanup=[]);if(Rs(eu)){var a=function s(e,t){return function(n){return qu(e),t(n)}}(gu,t),u=eu.listen(o,e,a);i.push(u,null)}else a=function l(e,t){return function n(r){qu(e),!1===t(r)&&(r.preventDefault(),r.returnValue=!1)}}(gu,t),o.addEventListener(e,a,n),i.push(e,o,a,n);var c=r.tNode;void 0===c.outputs&&(c.outputs=Fu(r.tNode.flags,1));var d,f=c.outputs;f&&(d=f[e])&&function p(e,t){for(var n=0;n<e.length;n+=2){var r=hu[e[n]][e[n+1]].subscribe(t);vu.push(r.unsubscribe,r)}}(d,t)},e.ɵT=function kc(e,t){var n=function r(e,t){return Rs(t)?t.createText(As(e)):t.createTextNode(As(e))}(t,eu),o=Nu(e,3,n,null,null);ru=!1,Zs(o.parent,n,gu)},e.ɵV=function Ic(e){var t=ru?nu:nu.parent,n=t.data,r=function o(e,t,n){for(var r=e.data.views,o=t;o<r.length;o++){var i=r[o].data.id;if(i===n)return r[o];if(!(i<n))break;Bs(e,o)}return null}(t,n.nextIndex,e);if(r)nu=r,ru=!0,wu(r.data,r);else{var i=Iu(e,eu,function a(e,t){var n=t.tNode.tViews;if(e>=n.length||null==n[e]){var r=gu.tView;n[e]=Vu(r.directiveRegistry,r.pipeRegistry)}return n[e]}(e,t),null,null,2,lu());n.queries&&(i.queries=n.queries.enterView(n.nextIndex)),wu(i,r=Nu(null,2,null,null,null,i))}return Tu(r.data)},e.ɵQ=function Ec(e,t,n,r){var o=new $l;return function i(e){return du||(du=new e)}(Ql).track(o,t,n,r),null!=e&&Ju(e,o),o},e.ɵd=function Nc(e){return hu[e]},e.ɵP=function Pc(e,t,n,r){void 0===n&&(n=0);var o=Nu(e,1,null,null,r||null,{head:null,tail:null});ru=!1;for(var i=o.parent,a=Qu(gu).data.data[t][n],s=0;s<a.length;s++)if(1===(l=a[s]).type){var u=l.data;Uu(o,u.head,u.tail)}else Uu(o,l,l);if(Qs(i,gu))for(var l=o.data.head,c=o.data.tail;l;)qs(l,i,gu),l=l===c?null:l.pNextOrParent},e.ɵb=function Tc(e){if(gu.bindingStartIndex<0)return $u(),pu[gu.bindingIndex++]=e;var t=e!==Gu&&Os(pu[gu.bindingIndex],e);return t&&(Xs(fu,mu,pu[gu.bindingIndex],e),pu[gu.bindingIndex]=e),gu.bindingIndex++,t?e:Gu},e.ɵi1=function Rc(e,t,n){return tl(t)?e+As(t)+n:Gu},e.ɵi2=function Dc(e,t,n,r,o){return rl(t,r)?e+As(t)+n+As(r)+o:Gu},e.ɵi3=function Oc(e,t,n,r,o,i,a){var s=rl(t,r);return(s=tl(i)||s)?e+As(t)+n+As(r)+o+As(i)+a:Gu},e.ɵi4=function Ac(e,t,n,r,o,i,a,s,u){return ol(t,r,i,s)?e+As(t)+n+As(r)+o+As(i)+a+As(s)+u:Gu},e.ɵi5=function jc(e,t,n,r,o,i,a,s,u,l,c){var d=ol(t,r,i,s);return(d=tl(l)||d)?e+As(t)+n+As(r)+o+As(i)+a+As(s)+u+As(l)+c:Gu},e.ɵi6=function Vc(e,t,n,r,o,i,a,s,u,l,c,d,f){var p=ol(t,r,i,s);return(p=rl(l,d)||p)?e+As(t)+n+As(r)+o+As(i)+a+As(s)+u+As(l)+c+As(d)+f:Gu},e.ɵi7=function Sc(e,t,n,r,o,i,a,s,u,l,c,d,f,p,h){var v=ol(t,r,i,s);return v=rl(l,d)||v,(v=tl(p)||v)?e+As(t)+n+As(r)+o+As(i)+a+As(s)+u+As(l)+c+As(d)+f+As(p)+h:Gu},e.ɵi8=function Mc(e,t,n,r,o,i,a,s,u,l,c,d,f,p,h,v,g){var y=ol(t,r,i,s);return(y=ol(l,d,p,v)||y)?e+As(t)+n+As(r)+o+As(i)+a+As(s)+u+As(l)+c+As(d)+f+As(p)+h+As(v)+g:Gu},e.ɵiV=function Fc(e){for(var t=!1,n=1;n<e.length;n+=2)tl(e[n])&&(t=!0);if(!t)return Gu;var r=e[0];for(n=1;n<e.length;n+=2)r+=As(e[n])+e[n+1];return r},e.ɵpb1=function Hc(e,t){var n=Xu(e);return Ul(e)?Fl(n.transform,t,n):n.transform(t)},e.ɵpb2=function Lc(e,t,n){var r=Xu(e);return Ul(e)?Hl(r.transform,t,n,r):r.transform(t,n)},e.ɵpb3=function Bc(e,t,n,r){var o=Xu(e);return Ul(e)?Ll(o.transform,t,n,r,o):o.transform(t,n,r)},e.ɵpb4=function zc(e,t,n,r,o){var i=Xu(e);return Ul(e)?Bl(i.transform,t,n,r,o,i):i.transform(t,n,r,o)},e.ɵpbV=function Uc(e,t){var n=Xu(e);return Ul(e)?zl(n.transform,t,n):n.transform.apply(n,t)},e.ɵf0=function Qc(e,t){return yu()?nl(t?e.call(t):e()):el()},e.ɵf1=Fl,e.ɵf2=Hl,e.ɵf3=Ll,e.ɵf4=Bl,e.ɵf5=function Zc(e,t,n,r,o,i,a){var s=ol(t,n,r,o);return tl(i)||s?nl(a?e.call(a,t,n,r,o,i):e(t,n,r,o,i)):el()},e.ɵf6=function qc(e,t,n,r,o,i,a,s){var u=ol(t,n,r,o);return rl(i,a)||u?nl(s?e.call(s,t,n,r,o,i,a):e(t,n,r,o,i,a)):el()},e.ɵf7=function Kc(e,t,n,r,o,i,a,s,u){var l=ol(t,n,r,o);return l=rl(i,a)||l,tl(s)||l?nl(u?e.call(u,t,n,r,o,i,a,s):e(t,n,r,o,i,a,s)):el()},e.ɵf8=function Wc(e,t,n,r,o,i,a,s,u,l){var c=ol(t,n,r,o);return ol(i,a,s,u)||c?nl(l?e.call(l,t,n,r,o,i,a,s,u):e(t,n,r,o,i,a,s,u)):el()},e.ɵfV=zl,e.ɵcR=function Yc(e){ru=!0,(nu=pu[e]).data.nextIndex=0,mu||Is(gu,gu.tView,fu)},e.ɵcr=function Gc(){ru?ru=!1:nu=nu.parent;var e=nu;e.native=void 0;for(var t=e.data.nextIndex;t<e.data.views.length;)Bs(e,t)},e.ɵqR=function $c(e){return!!e.dirty&&(e.reset(e._valuesTree),e.notifyOnChanges(),!0)}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */,e.ɵe=function Jc(){ru?ru=!1:nu=nu.parent;var e=nu.queries;e&&e.addNode(nu),function t(e,n){var r=n.tView;if(!0===r.firstTemplatePass)for(var o=e>>13,i=o+(4095&e),a=o;a<i;a++){var s=r.directives[a];Cs(s,r,a),xs(s,r,a),ks(s,r,a)}}(nu.tNode.flags,gu)},e.ɵp=function Xc(e,t,n,r){if(n!==Gu){var o=pu[e],i=o.tNode;i&&void 0===i.inputs&&(i.inputs=Fu(o.tNode.flags,0));var a,s=i&&i.inputs;if(s&&(a=s[t]))!function u(e,t){for(var n=0;n<e.length;n+=2)hu[e[n]][e[n+1]]=t}(a,n),function l(e){!e.data||2&e.data.flags||(e.data.flags|=4)}(o);else{n=null!=r?r(n):n;var c=o.native;Rs(eu)?eu.setProperty(c,t,n):c.setProperty?c.setProperty(t,n):c[t]=n}}},e.ɵpD=function ed(e,t,n){for(var r=t?t.length+1:1,o=new Array(r),i=0;i<r;i++)o[i]=[];for(var a=Qu(gu).child;null!==a;)t&&a.tNode?o[$s(a.tNode,t,n)].push(a):o[0].push(a),a=Vs(a);pu[e]=o},e.ɵa=function td(e,t,n,r){if(n!==Gu){var o=pu[e];if(null==n)Rs(eu)?eu.removeAttribute(o.native,t):o.native.removeAttribute(t);else{var i=null==r?As(n):r(n);Rs(eu)?eu.setAttribute(o.native,t,i):o.native.setAttribute(t,i)}}},e.ɵs=function nd(e,t){if(t!==Gu){var n=pu[e];if(Rs(eu))eu.setProperty(n.native,"style",t);else for(var r=n.native.style,o=0,i=Object.keys(t);o<i.length;o++){var a=i[o],s=t[a];null==s?r.removeProperty(a):r.setProperty(a,s)}}},e.ɵsn=function rd(e,t,n,r){if(n!==Gu){var o=pu[e];if(null==n)Rs(eu)?eu.removeStyle(o.native,t,Ps.DashCase):o.native.style.removeProperty(t);else{var i="function"==typeof r?r(n):As(n);"string"==typeof r&&(i+=r),Rs(eu)?eu.setStyle(o.native,t,i,Ps.DashCase):o.native.style.setProperty(t,i)}}},e.ɵk=function od(e,t){if(t!==Gu){var n=pu[e];Rs(eu)?eu.setProperty(n.native,"className",t):n.native.className=As(t)}},e.ɵkn=function id(e,t,n){if(n!==Gu){var r=pu[e];n?Rs(eu)?eu.addClass(r.native,t):r.native.classList.add(t):Rs(eu)?eu.removeClass(r.native,t):r.native.classList.remove(t)}},e.ɵt=function ad(e,t){var n=pu[e];t!==Gu&&(Rs(eu)?eu.setValue(n.native,As(t)):n.native.textContent=As(t))},e.ɵv=function sd(){Cu(),ru=!1;var e=nu=gu.node,t=nu.parent;if(t){var n=t.data;fu&&(function r(e,t){if(null!=e)for(var n=t.child;n;){if(1===n.type)for(var r=n.data.head,o=n.data.tail;r;)r.dynamicLContainerNode&&(r.dynamicLContainerNode.data.renderParent=e),r=r===o?null:r.pNextOrParent;n=Vs(n)}}(n.renderParent,e),Ls(t,e,n.nextIndex)),n.nextIndex++}bu(gu.parent)},e.ɵst=Ju,e.ɵld=Xu,e.ɵPp=function ud(e,t){var n,r=il();r.firstTemplatePass?(n=function o(e,t){if(t)for(var n=0;n<t.length;n++){var r=t[n];if(e===r.name)return r}throw new Error("Pipe with name '"+e+"' not found!")}(t,r.pipeRegistry),r.data[e]=n,n.onDestroy&&(r.pipeDestroyHooks||(r.pipeDestroyHooks=[])).push(e,n.onDestroy)):n=r.data[e];var i=n.n();return Ju(e,i),i},e.ɵwhenRendered=function ld(e){return function t(e){return Ku(e).context}(e).clean},e.ɵbypassSanitizationTrustHtml=function cd(e){return Xl(e,"Html")},e.ɵbypassSanitizationTrustStyle=function dd(e){return Xl(e,"Style")},e.ɵbypassSanitizationTrustScript=function fd(e){return Xl(e,"Script")},e.ɵbypassSanitizationTrustUrl=function pd(e){return Xl(e,"Url")},e.ɵbypassSanitizationTrustResourceUrl=function hd(e){return Xl(e,"ResourceUrl")},e.ɵsanitizeHtml=function vd(t){var n=lu();return n?n.sanitize(e.SecurityContext.HTML,t)||"":t instanceof String&&"Html"===t[Jl]?t.toString():so(document,As(t))},e.ɵsanitizeStyle=function gd(t){var n=lu();return n?n.sanitize(e.SecurityContext.STYLE,t)||"":t instanceof String&&"Style"===t[Jl]?t.toString():po(As(t))},e.ɵsanitizeUrl=function yd(t){var n=lu();return n?n.sanitize(e.SecurityContext.URL,t)||"":t instanceof String&&"Url"===t[Jl]?t.toString():zr(As(t))},e.ɵsanitizeResourceUrl=function md(t){var n=lu();if(n)return n.sanitize(e.SecurityContext.RESOURCE_URL,t)||"";if(t instanceof String&&"ResourceUrl"===t[Jl])return t.toString();throw new Error("unsafe value used in a resource URL context (see http://g.co/ng/security#xss)")},e.ɵregisterModuleFactory=function _d(e,t){var n=Qn.get(e);if(n)throw new Error("Duplicate module registered for "+e+" - "+n.moduleType.name+" vs "+t.moduleType.name);Qn.set(e,t)},e.ɵEMPTY_ARRAY=[],e.ɵEMPTY_MAP={},e.ɵand=
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
