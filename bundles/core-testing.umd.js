    ...
    ***************************************************************************** */
    ...
    var R3TestBedCompiler = /** @class */ (function () {
        ...
        R3TestBedCompiler.prototype.overrideProvider = function (token, provider) {
            ...
            var injectableDef = typeof token !== 'string' ? i0.ɵgetInjectableDef(token) : null;
            var providedIn = injectableDef === null ? null : i0.resolveForwardRef(injectableDef.providedIn);
        ...
        R3TestBedCompiler.prototype.compileTypesSync = function () {
            ...
            this.pendingComponents.forEach(function (declaration) {
                ...
                _this.maybeStoreNgDef(i0.ɵNG_COMP_DEF, declaration);
        ...
        R3TestBedCompiler.prototype.applyTransitiveScopes = function () {
            ...
            if (this.overriddenModules.size > 0) {
                ...
                if (affectedModules.size > 0) {
                    affectedModules.forEach(function (moduleType) {
                        _this.storeFieldOfDefOnType(moduleType, i0.ɵNG_MOD_DEF, 'transitiveCompileScopes');
                        moduleType[i0.ɵNG_MOD_DEF].transitiveCompileScopes = null;
                    });
                }
            }
            ...
            this.componentToModuleScope.forEach(function (moduleType, componentType) {
                ...
                _this.storeFieldOfDefOnType(componentType, i0.ɵNG_COMP_DEF, 'directiveDefs');
                _this.storeFieldOfDefOnType(componentType, i0.ɵNG_COMP_DEF, 'pipeDefs');
                // `tView` that is stored on component def contains information about directives and pipes
                // that are in the scope of this component. Patching component scope will cause `tView` to be
                // changed. Store original `tView` before patching scope, so the `tView` (including scope
                // information) is restored back to its previous/original state before running next test.
                _this.storeFieldOfDefOnType(componentType, i0.ɵNG_COMP_DEF, 'tView');
                i0.ɵpatchComponentDefWithScope(componentType.ɵcmp, moduleScope);
            });
            this.componentToModuleScope.clear();
        };
        R3TestBedCompiler.prototype.applyProviderOverrides = function () {
            ...
            var maybeApplyOverrides = function (field) { return function (type) {
                var resolver = field === i0.ɵNG_COMP_DEF ? _this.resolvers.component : _this.resolvers.directive;
        ...
        R3TestBedCompiler.prototype.applyProviderOverridesToModule = function (moduleType) {
            ...
            var injectorDef = moduleType[i0.ɵNG_INJ_DEF];
            if (this.providerOverridesByToken.size > 0) {
                ...
                if (this.hasProviderOverrides(providers)) {
                    this.maybeStoreNgDef(i0.ɵNG_INJ_DEF, moduleType);
                    this.storeFieldOfDefOnType(moduleType, i0.ɵNG_INJ_DEF, 'providers');
                    injectorDef.providers = this.getOverriddenProviders(providers);
                }
                // Apply provider overrides to imported modules recursively
                var moduleDef = moduleType[i0.ɵNG_MOD_DEF];
        ...
        R3TestBedCompiler.prototype.patchComponentsWithExistingStyles = function () {
            this.existingComponentStyles.forEach(function (styles, type) { return type[i0.ɵNG_COMP_DEF].styles = styles; });
        ...
        R3TestBedCompiler.prototype.recompileNgModule = function (ngModule, metadata) {
            ...
            this.maybeStoreNgDef(i0.ɵNG_MOD_DEF, ngModule);
            this.maybeStoreNgDef(i0.ɵNG_INJ_DEF, ngModule);
        ...
        R3TestBedCompiler.prototype.queueType = function (type, moduleType) {
            ...
            if (component) {
                ...
                if (isComponentDefPendingResolution(type) || !type.hasOwnProperty(i0.ɵNG_COMP_DEF)) {
                ...
                try {
                    for (var arr_3 = __values(arr), arr_3_1 = arr_3.next(); !arr_3_1.done; arr_3_1 = arr_3.next()) {
                        ...
                        if (Array.isArray(value)) {
                            ...
                            var moduleDef = value[i0.ɵNG_MOD_DEF];
        ...
        R3TestBedCompiler.prototype.compileTestModule = function () {
            ...
            i0.ɵcompileNgModuleDefs(RootScopeModule, {
    ...
    var TestBedRender3 = /** @class */ (function () {
        ...
        TestBedRender3.prototype.createComponent = function (type) {
            ...
            if (!componentDef) {
                throw new Error("It looks like '" + i0.ɵstringify(type) + "' has not been IVY compiled - it has no '\u0275cmp' field");
            }
            ...
            var ngZone = noNgZone ? null : this.inject(i0.NgZone, null);
    ...
    var TestBedViewEngine = /** @class */ (function () {
        ...
        TestBedViewEngine.prototype._createCompilerAndModule = function () {
            ...
            providers.push({ provide: i0.ɵINJECTOR_SCOPE, useValue: this._isRoot ? 'root' : null });
