...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function compileNgModule(moduleType, resolvers) {
        ...
        i0.ɵcompileNgModuleDefs(moduleType, ngModule);
        ...
        declarations.forEach(function (declaration) {
            ...
            if (component) {
                i0.ɵcompileComponent(declaration, component);
                compiledComponents.push(declaration);
                return;
            }
            var directive = resolvers.directive.resolve(declaration);
            if (directive) {
                i0.ɵcompileDirective(declaration, directive);
                return;
            }
    ...
    exports.TestBedViewEngine = TestBedViewEngine;
    ...
    exports.TestBedRender3 = TestBedRender3;
    exports._getTestBedRender3 = _getTestBedRender3;
