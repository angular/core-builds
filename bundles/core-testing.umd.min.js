...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */(r)});t.push(c)}),j(),Promise.all(t).then(function(){})}var S=new Map,F=new Set;function R(e){return F.has(e)}function j(){var e=S;return S=new Map,e}function I(e){return"string"==typeof e?e:e.text()}var A=0,k=function(){function e(){this._references=new Map}return e.prototype.overrideMetadata=function(e,r,n){var o={};if(r&&function i(e){var t=[];Object.keys(e).forEach(function(e){e.startsWith("_")||t.push(e)});for(var r=e;r=Object.getPrototypeOf(r);)Object.keys(r).forEach(function(e){var n=Object.getOwnPropertyDescriptor(r,e);!e.startsWith("_")&&n&&"get"in n&&t.push(e)});return t}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
