...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.ComponentFixture=s,e.ComponentFixtureAutoDetect=$,e.ComponentFixtureNoNgZone=ee,e.InjectSetupWrapper=ve,e.TestBed=pe,e.TestComponentRenderer=X,e.__core_private_testing_placeholder__="",e.async=function ye(e){return i(e)},e.discardPeriodicTasks=function ge(){if(m)return m.discardPeriodicTasks();!function e(){h().pendingPeriodicTimers.length=0}()},e.fakeAsync=function _e(e){return m?m.fakeAsync(e):function t(e){return function(){for(var t=[],r=0;r<arguments.length;r++)t[r]=arguments[r];var n=l.assertPresent();if(d)throw new Error("fakeAsync() calls can not be nested");d=!0;try{if(!a){if(n.getDelegate()instanceof c)throw new Error("fakeAsync() calls can not be nested");a=new c}var o=void 0,i=n.getDelegate();n.setDelegate(a),a.lockDatePatch();try{o=e.apply(this,t),f()}finally{n.setDelegate(i)}if(a.pendingPeriodicTimers.length>0)throw new Error(a.pendingPeriodicTimers.length+" periodic timer(s) still in the queue.");if(a.pendingTimers.length>0)throw new Error(a.pendingTimers.length+" timer(s) still in the queue.");return o}finally{d=!1,p()}}}(e)},e.flush=function Me(e){return m?m.flush(e):function t(e){return h().flush(e)}(e)},e.flushMicrotasks=function Oe(){return m?m.flushMicrotasks():f()},e.getTestBed=de,e.inject=fe,e.resetFakeAsyncZone=y,e.tick=function be(e,t){return void 0===e&&(e=0),void 0===t&&(t={processNewMacroTasksSynchronously:!0}),m?m.tick(e,t):function r(e,t){void 0===e&&(e=0),void 0===t&&(t={processNewMacroTasksSynchronously:!0}),h().tick(e,null,t)}(e,t)},e.waitForAsync=i,e.withModule=function Te(e,t){return t?function(){var r=de();return e&&r.configureTestingModule(e),t.apply(this)}:new ve((function(){return e}))}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
