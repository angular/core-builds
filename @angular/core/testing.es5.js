        ...
        value: function _captureStyles() {
            ...
            if (this.hasStarted()) {
                ...
                this.keyframes.forEach(function (kf) {
                    ...
                    var newStyles = {};
                    Object.keys(styles).forEach(function (prop) {
                        captures[prop] = _this13._finished ? styles[prop] : AUTO_STYLE;
                    });
                });
            }
...
export { async, ComponentFixture, resetFakeAsyncZone, fakeAsync, tick, discardPeriodicTasks, flushMicrotasks, TestComponentRenderer, ComponentFixtureAutoDetect, ComponentFixtureNoNgZone, TestBed, getTestBed, _inject as inject, InjectSetupWrapper, withModule, __core_private_testing_placeholder__, MockAnimationPlayer as ɵMockAnimationPlayer, TestingCompiler as ɵTestingCompiler, TestingCompilerFactory as ɵTestingCompilerFactory };
