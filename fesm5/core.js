        ...
        get: function () {
            if (ngInjectorDef === null) {
                var meta = {
                    ...
                    providers: new WrappedNodeExpr(ngModule.providers || EMPTY_ARRAY$4),
