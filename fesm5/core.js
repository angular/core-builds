 ...
 * @param cb
 */
function applyReflow(element, cb) {
...
function applyTransition(element, value) {
    value ? element.style.setProperty('transition', value) :
        element.style.removeProperty('transition');
}
function readStyle(element, prop) {
...
function applyClassChanges(element, classes, revert, store) {
...
function applyStyleChanges(element, styles, backupStyles, revert, preComputedStyles, store) {
...
var CssTransitionAnimator = /** @class */ (function () {
    ...
    CssTransitionAnimator.prototype.addEffect = function (effect) {
        ...
        this._pendingInstructions.push({
            ...
            classes: classes ? __assign({}, classes) : null,
...
function invokeStylingAnimation(element, classes, styles, timing) {
