...
export class R3TestBedCompiler {
    ...
    compileTestModule() {
        ...
        /** @nocollapse */ R3ErrorHandlerModule.ngModuleDef = i0.ɵɵdefineNgModule({ type: R3ErrorHandlerModule });
        /** @nocollapse */ R3ErrorHandlerModule.ngInjectorDef = i0.ɵɵdefineInjector({ factory: function R3ErrorHandlerModule_Factory(t) { return new (t || R3ErrorHandlerModule)(); }, providers: [{ provide: ErrorHandler, useClass: R3TestErrorHandler }] });
