...
/** @nocollapse */ PlatformRef.ngInjectableDef = i0.ΔdefineInjectable({ token: PlatformRef, factory: function PlatformRef_Factory(t) { return new (t || PlatformRef)(i0.Δinject(i1.Injector)); }, providedIn: null });
...
/** @nocollapse */ ApplicationRef.ngInjectableDef = i0.ΔdefineInjectable({ token: ApplicationRef, factory: function ApplicationRef_Factory(t) { return new (t || ApplicationRef)(i0.Δinject(i2.NgZone), i0.Δinject(i3.Console), i0.Δinject(i1.Injector), i0.Δinject(i4.ErrorHandler), i0.Δinject(i5.ComponentFactoryResolver), i0.Δinject(i6.ApplicationInitStatus)); }, providedIn: null });
