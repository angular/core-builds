...
/** @nocollapse */ PlatformRef.ngInjectableDef = i0.defineInjectable({ token: PlatformRef, factory: function PlatformRef_Factory(t) { return new (t || PlatformRef)(i0.inject(i1.Injector)); }, providedIn: null });
...
/** @nocollapse */ ApplicationRef.ngInjectableDef = i0.defineInjectable({ token: ApplicationRef, factory: function ApplicationRef_Factory(t) { return new (t || ApplicationRef)(i0.inject(i2.NgZone), i0.inject(i3.Console), i0.inject(i1.Injector), i0.inject(i4.ErrorHandler), i0.inject(i5.ComponentFactoryResolver), i0.inject(i6.ApplicationInitStatus)); }, providedIn: null });
