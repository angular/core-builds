...
export function renderTemplate(hostNode, template, context, providedRendererFactory, host, directives, pipes, sanitizer) {
    if (host == null) {
        ...
        const /** @type {?} */ tView = getOrCreateTView(template, directives || null, pipes || null, null);
