...
function add(query, tNode) {
    ...
    /** @type {?} */
    const nodeInjector = getOrCreateNodeInjectorForNode(/** @type {?} */ (currentNode), tNode);
    while (query) {
        /** @type {?} */
