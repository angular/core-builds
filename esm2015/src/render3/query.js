        ...
        if (type) {
            ...
            for (let i = 0; i < selector.length; i++) {
                ...
                if (directiveIdx !== null) {
                    ...
                    /** @type {?} */
                    const result = readFromNodeInjector(nodeInjector, tNode, currentView, /** @type {?} */ ((predicate.read)), directiveIdx);
                    if (result !== null) {
                        addMatch(query, result);
                    }
                }
