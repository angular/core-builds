...
export function updateStylingMap(context, classes, styles) {
    ...
    if (typeof classes == 'string') {
        const cachedClassString = context[6 /* CachedCssClassString */];
