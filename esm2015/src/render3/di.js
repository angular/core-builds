...
class ViewContainerRef extends viewEngine_ViewContainerRef {
    ...
    insert(viewRef, index) {
        ...
        const beforeNode = adjustedIdx + 1 < views.length ?
            (/** @type {?} */ ((getChildLNode(views[adjustedIdx + 1][HOST_NODE])))).native :
