...
/** @type {?} */
export const QUERY_READ_TEMPLATE_REF = /** @type {?} */ ((/** @type {?} */ (new ReadFromInjectorFn((tNode, view) => { return createTemplateRef(tNode, view); }))));
/** @type {?} */
export const QUERY_READ_CONTAINER_REF = /** @type {?} */ ((/** @type {?} */ (new ReadFromInjectorFn((tNode, view) => createContainerRef(/** @type {?} */ (tNode), view)))));
/** @type {?} */
export const QUERY_READ_ELEMENT_REF = /** @type {?} */ ((/** @type {?} */ (new ReadFromInjectorFn((tNode, view) => createElementRef(tNode, view)))));
/** @type {?} */
...
export function createContainerRef(hostTNode, hostView) {
    ...
    return new ViewContainerRef(lContainer, /** @type {?} */ (hostTNode.dynamicContainerNode), hostTNode, hostView);
}
...
export function createTemplateRef(hostTNode, hostView) {
    ...
    return new TemplateRef(hostView, createElementRef(hostTNode, hostView), /** @type {?} */ (hostTNode.tViews), getRenderer(), /** @type {?} */ ((hostNode.data))[QUERIES]);
}
/**
 * @template T
 * @param {?} type
