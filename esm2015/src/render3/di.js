...
export const QUERY_READ_TEMPLATE_REF = new ReadFromInjectorFn((tNode, view) => { return createTemplateRef(tNode, view); });
export const QUERY_READ_CONTAINER_REF = new ReadFromInjectorFn((tNode, view) => createContainerRef(tNode, view));
export const QUERY_READ_ELEMENT_REF = new ReadFromInjectorFn((tNode, view) => createElementRef(tNode, view));
