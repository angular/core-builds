...
function renderEmbeddedTemplate(viewNode, template, context, renderer) {
    ...
    try {
        ...
        let /** @type {?} */ cm = false;
        if (viewNode == null) {
            const /** @type {?} */ view = createLView(-1, renderer, { data: [] }, template, context);
