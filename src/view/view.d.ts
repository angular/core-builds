...
export declare function viewDef(flags: ViewFlags, nodes: NodeDef[], updateDirectives?: ViewUpdateFn, updateRenderer?: ViewUpdateFn, handleEvent?: ViewHandleEventFn, compId?: string, encapsulation?: ViewEncapsulation, styles?: string[]): ViewDefinition;
