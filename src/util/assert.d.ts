...
export declare function assertNumberInRange(actual: any, minInclusive: number, maxInclusive: number): void;
...
export declare function assertGreaterThanOrEqual<T>(actual: T, expected: T, msg: string): void;
