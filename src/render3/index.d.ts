...
export { ComponentDefInternal, ComponentTemplate, ComponentType, DirectiveDefInternal, DirectiveDefFlags, DirectiveType, NgOnChangesFeature, PublicFeature, PipeDef, LifecycleHooksFeature, defineComponent, defineDirective, defineNgModule, definePipe, getHostElement, getRenderedText, renderComponent, whenRendered };
