...
export { ΔBaseDef, ComponentDef, ΔComponentDefWithMeta, ComponentTemplate, ComponentType, DirectiveDef, DirectiveDefFlags, ΔDirectiveDefWithMeta, DirectiveType, ΔNgOnChangesFeature, ΔInheritDefinitionFeature, ΔProvidersFeature, PipeDef, ΔPipeDefWithMeta, LifecycleHooksFeature, ΔdefineComponent, ΔdefineDirective, ΔdefineNgModule, ΔdefineBase, ΔdefinePipe, getHostElement, getComponent, getDirectives, getRenderedText, renderComponent, ΔsetComponentScope, ΔsetNgModuleScope, whenRendered, };
