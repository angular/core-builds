...
export interface ApplyStylingFn {
    (renderer: Renderer3 | ProceduralRenderer3 | null, element: RElement, prop: string, value: string | null, bindingIndex: number): void;
}
/**
 ...
 */
export declare type StylingBindingData = LView | (string | number | boolean)[];
