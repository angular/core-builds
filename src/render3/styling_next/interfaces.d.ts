 ...
 * `TStylingContext`.
 */
export declare const enum TStylingConfig {
    /**
 ...
 */
export declare const enum TStylingContextIndex {
    ConfigPosition = 0,
 ...
 */
export declare const enum TStylingContextPropConfigFlags {
    Default = 0,
...
export interface ApplyStylingFn {
    (renderer: Renderer3 | ProceduralRenderer3 | null, element: RElement, prop: string, value: any, bindingIndex?: number | null): void;
}
/**
 ...
 */
export declare type LStylingData = LView | (string | number | boolean | null)[];
/**
 ...
 */
export declare const enum StylingMapArrayIndex {
...
export interface SyncStylingMapsFn {
    (context: TStylingContext, renderer: Renderer3 | ProceduralRenderer3 | null, element: RElement, data: LStylingData, sourceIndex: number, applyStylingFn: ApplyStylingFn, sanitizer: StyleSanitizeFn | null, mode: StylingMapsSyncMode, targetProp?: string | null, defaultValue?: boolean | string | null): boolean;
}
/**
 * Used to direct how map-based values are applied/traversed when styling is flushed.
 */
export declare const enum StylingMapsSyncMode {
