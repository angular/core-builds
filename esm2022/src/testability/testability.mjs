...
export class Testability {
    ...
    static { this.ɵfac = function Testability_Factory(ɵt) { return new (ɵt || Testability)(i0.ɵɵinject(i1.NgZone), i0.ɵɵinject(TestabilityRegistry), i0.ɵɵinject(TESTABILITY_GETTER)); }; }
